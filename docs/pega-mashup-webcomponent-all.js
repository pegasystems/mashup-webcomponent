...
`,me=(t,e,a,i,n,s,o,r,l,c)=>{const d=R`${st()}<span class='count-badge'>${n}</span>`;if(void 0===e.caseID&&a.content)return R`
  ...
  </table>`:null)(a.childCases,r)}`;if(""===t||void 0===e.caseID)return"";const h=e.caseID.split(" ")[1];return R`
  <div class="flex layout-content-inline_middle main-header">
...
`:null},va=(t,e,a,i,n)=>{if(void 0===t)return null;if(Array.isArray(t)&&1===t.length&&"View"===t[0].type&&(t=t[0]),!t.config||!t.config.template)return R`${t.map(((t,s)=>{const o=`${e}-${s}`;if("Region"===t.type)return va(t.children,`${e}-0`,!0,i,n);if("reference"===t.type&&"view"===t.config.type){let e="";if(t.config.context&&(e=t.config.context),t.config.inheritedProps&&1===t.config.inheritedProps.length&&"label"===t.config.inheritedProps[0].prop){const s=i18n.t(t.config.inheritedProps[0].value);let r=i.data.uiResources.resources.views[t.config.name];if(r){if(Array.isArray(r)&&1===r.length&&"View"===r[0].type&&(r=r[0]),"fieldGroup"===r.config.multiRecordDisplayAs)return va(r,o,a,i,""===n?e.substring(1):n+e);const t="SimpleTable"===r.config.template||"ListView"===r.config.template?"field-table":"field-subview";return R`<div class='flex content-item field-item ${t}'><h4>${s}</h4>${va(r,o,a,i,""===n?e.substring(1):n+e)}</div>`}}return va(i.data.uiResources.resources.views[t.config.name],o,a,i,n&&""!==n?n+e:e.substring(1))}return Ye(t,o,a,i,n)}))}`;if("SimpleTable"===t.config.template){if("fieldGroup"===t.config.multiRecordDisplayAs){const n=t.config.referenceList.replace("@P .","").replace("@USER .",""),s=gt(i.data.data.caseInfo.content,n);if(!s)return null;const o=t.config.heading.replace("@L ","");return R`${s.map(((s,r)=>R`<div><h4>${`${o} ${r}`}</h4>
  ...
  </table> `:null)(a.assignments,r)}`}if(""===t||void 0===e.caseID)return"";const h=e.caseID.split(" ")[1];return R`
  <div class="flex layout-content-inline_middle main-header">
