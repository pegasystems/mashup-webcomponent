...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
class{handleAttributeExpressions(t,e,a,i){const n=e[0];if("."===n){return new I(t,e.slice(1),a).parts}if("@"===n)return[new N(t,e.slice(1),i.eventContext)];if("?"===n)return[new _(t,e.slice(1),a)];return new S(t,e,a).parts}handleTextExpression(t){return new k(t)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.0");const O=(t,...e)=>new x(t,e,"html",P)
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
</svg>`,It=(t,e,a)=>{if(void 0===t||void 0===t.control||void 0===t.control.type)return null;if(t.customAttributes&&"none"===t.customAttributes.display)return null;if(!0===a||!0===t.readOnly||"pxHidden"===t.control.type)return St(t,e,"field-text",At(t,e));switch(t.control.type){case"pxPhone":case"pxTextInput":return St(t,e,"field-textinput",Tt(t,e));case"pxInteger":case"pxNumber":return St(t,e,"field-numberinput",Et(t,e));case"pxCurrency":return St(t,e,"field-currencyinput",zt(t,e));case"pxEmail":return St(t,e,"field-emailinput",Rt(t,e));case"pxTextArea":return St(t,e,"field-textarea",Mt(t,e));case"pxRadioButtons":return St(t,e,"field-radiogroup",Vt(t,e));case"pxCheckbox":return St(t,e,"field-checkbox",Ht(t,e));case"pxDropdown":return St(t,e,"field-dropdown",Wt(t,e));case"pxDisplayText":return St(t,e,"field-text",At(t,e));case"pxIcon":return St(t,e,"field-icon",Lt(t,e));case"pxLink":case"pxURL":return St(t,e,"field-url",Pt(t,e));case"pxIconDeleteItem":return St(t,e,"field-button",qt(t,e));case"pxButton":return St(t,e,"field-button",Ot(t,e));case"pxDateTime":return"TimeOfDay"===t.type?St(t,e,"field-time",jt(t,e)):"Date"===t.type?St(t,e,"field-date",Ft(t,e)):St(t,e,"field-datetime",Ut(t,e));case"pxAutoComplete":return St(t,e,"field-combobox",Bt(t,e));case"pxSlider":return St(t,e,"field-slider",Nt(t,e));default:return null}},At=(t,e)=>{if("pxDate"===t.control.type){let a=lt(t.value);if(a)if(t.control&&2===t.control.modes.length){let e={};switch(t.control.modes[1].dateFormat){case"DateTime-Short-YYYY":case"Date-DayMonthYear-Custom":case"Date-Mediun":e={year:"numeric",month:"short",day:"numeric"};break;case"Date-Short":e={year:"numeric",month:"numeric",day:"numeric"};break;case"Date-Long":e={year:"numeric",month:"long",day:"numeric"};break;case"Date-Full":e={weekday:"long",year:"numeric",month:"long",day:"numeric"};break;default:e={}}a=new Intl.DateTimeFormat([],e).format(a)}else a=(new Intl.DateTimeFormat).format(a);else a=t.value;return O`
...
`,Ot=(t,e)=>{const a=xt(t,"click");return"deleteRow"===a?qt(t,e):O`
  ...
  >${kt()}</button>
`,Ut=(t,e)=>{let a=t.value;if(""!==a){let e=lt(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${e.getFullYear()}-${ot(e.getMonth()+1)}-${ot(e.getDate())}T${ot(e.getHours())}:${ot(e.getMinutes())}`):8===t.value.length&&(a=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}T00:00`)}return O`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="datetime-local"
    ...
    data-action-click="${st(xt(t,"click"))}"
    />
  `},Ft=(t,e)=>{let a=t.value;if(""!==a){let e=lt(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${e.getFullYear()}-${ot(e.getMonth()+1)}-${ot(e.getDate())}`):8===t.value.length&&(a=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}`)}return O`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="date"
    ...
    data-action-click="${st(xt(t,"click"))}"
    />
  `},jt=(t,e)=>{let a=t.value;if(""!==a){let e=lt(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${ot(e.getHours())}-${ot(e.getMinutes())}-${ot(e.getSeconds())}`):8===t.value.length&&(a=`${t.value.substring(9,10)}:${t.value.substring(10,11)}:${t.value.substring(11,12)}`)}return O`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="time"
      ...
      data-action-click="${st(xt(t,"click"))}"
    />
  `},Vt=(t,e)=>{let a;return t.control&&t.control.modes&&t.control.modes[0].options?a=t.control.modes[0].options:"True-False"===t.type&&(a=[{value:"true"},{value:"false"}]),void 0===a?null:O`
...
`,Wt=(t,e)=>t.control&&t.control.modes[0]&&t.control.modes[0].options?O`<select
      data-ref="${t.reference}"
      id=${st(e)}
      ?required="${!0===t.required}"
      data-action-change="${st(xt(t,"change"))}"
  ...
  `},Zt=t=>""!==t.title?O`
    ...
    `:null,Jt=(t,e)=>{let a=t.fieldListID;if(void 0!==t.reference&&(a=t.reference),"."===a.charAt(0)&&(a=a.substring(1)),t.newRow&&!0!==e){const e=[];return pt(t.newRow,e),O`
...
`,Kt=(t,e,a,i,n)=>{const s=document.createElement("div");s.setAttribute("role","alertdialog"),s.setAttribute("aria-modal","true"),s.setAttribute("aria-labelledby",t),s.setAttribute("aria-describedby",""),s.setAttribute("class","mashup-modal");const r=document.createElement("div");s.appendChild(r);const o=()=>{document.body.removeEventListener("click",l),s&&(s.previousElementSibling&&(s.previousElementSibling.removeAttribute("aria-hidden"),s.previousElementSibling.focus()),s.remove()),n&&n()},l=t=>{if(t){let e=t.target;if(e.download)return;if(t.path&&t.path.length>0?e=t.path[0]:t.originalTarget&&(e=t.originalTarget),e){const t=e.closest("button");if((null===t||"close"!==t.getAttribute("data-action-id"))&&!e.classList.contains("mashup-modal")&&null!==e.closest(".mashup-modal"))return}o()}};return O`
  <div class='modalcontent'>
    <button type="button" @click="${t=>{t.preventDefault(),t.stopPropagation();const e=t.target.closest(".modalcontent");null===e?o():1===e.children.length?(e.firstElementChild.setAttribute("aria-hidden","true"),s.style.opacity=0,e.appendChild(s),i(r),document.body.addEventListener("click",l),s.offsetHeight,s.style=""):o()}}" class="pzhc pzbutton ${a}" title="${t}">${e}</button>
  </div>`},Qt=(t,e,a,i)=>Kt(t,e,a,(t=>{L(te(t,[]),t),i(t)})),te=(t,e,a,i,n)=>{let s=0;const r=t=>{if(void 0===t||"string"==typeof t&&""===t)return;if("URL"===e[s].category)return void window.open(t);let a=e[s].fileName;void 0===a&&(a=e[s].name);const i=window.document.createElement("a");if("Correspondence"===e[s].category){a=`${e[s].name}.html`;const n=`<html><head><title>${e[s].name}</title></head><body>${t}</body></html>`,r=new Blob([n],{type:"text"});i.href=window.URL.createObjectURL(r)}else{const e=function(t){const e=window.atob(t),a=e.length,i=new Uint8Array(a);for(let t=0;t<a;t++){const a=e.charCodeAt(t);i[t]=a}return i}(t),a=new Blob([e],{type:"octet/stream"});i.href=window.URL.createObjectURL(a)}i.download=a,document.body.appendChild(i),i.click(),document.body.removeChild(i)},o=t=>{t.stopPropagation();const a=t.target;s=a.getAttribute("data-id"),i.fetchData.call(i,"attachment",{id:e[s].ID,target:r})},l=a=>{a.preventDefault(),a.stopPropagation();const n=a.target.closest("button");s=n.getAttribute("data-id"),i.sendData.call(i,"deleteattachment",{id:e[s].ID,target:t})},c=r=>{r.stopPropagation();const o=r.target.closest("button");s=parseInt(o.getAttribute("data-id"),10),n.splice(s,1),L(te(t,e,a,i,n),t)},d=t=>{t.stopPropagation(),t.preventDefault();const e=t.target;if(s=e.getAttribute("data-id"),"INPUT"===e.tagName){const t=e.getAttribute("data-prop-id");n[s][t]=e.value}else"SELECT"===e.tagName&&(n[s].category=e.value)},h=t=>{t.preventDefault();const e=t.target,a=t.relatedTarget,i=null===e?null:e.closest(".attach-files"),n=null===a?null:a.closest(".attach-files");if("dragenter"===t.type||"dragover"===t.type?null!=i&&i.classList.add("drop-file-hover"):"dragleave"!==t.type&&"drop"!==t.type||null===n&&null!==i&&i.classList.remove("drop-file-hover"),"drop"===t.type){const a=t.dataTransfer.files;p(e,a)}},u=s=>{s.stopPropagation(),s.preventDefault();for(let s=0;s<n.length;s++){const r=n[s];delete r.editing,r.loading=!0,"URL"===r.type?(e.unshift(r),i.sendData.call(i,"attachments",{id:a,actionid:[r],target:t})):(e.unshift({name:r.displayName,extension:r.extension,loading:!0}),i.sendData.call(i,"uploadattachment",{actionid:r,target:t}))}L(te(t,e,a,i),t)},p=(n,s)=>{const r=[];for(let t=0;t<s.length;t++){const e=s[t];let a=e.name.lastIndexOf(".");-1===a&&(a=e.name.length),e.displayName=e.name.substring(0,a),e.extension=e.name.substring(a+1),e.editing=!0,e.category="File",r.push(e)}L(te(t,e,a,i,r),t)},g=t=>{t.stopPropagation();let e=t.target;if("BUTTON"===e.tagName)return e=t.target.parentNode.parentNode.firstElementChild,void e.click();p(e,e.files)},m=n=>{n.stopPropagation();L(te(t,e,a,i,[{type:"URL",category:"URL",name:"",url:"",editing:!0}]),t)},f=n=>{n.stopPropagation(),L(te(t,e,a,i),t)},b=(t,e)=>{let a=new Date(e.createTime);return a=a.toLocaleDateString(void 0,{year:"numeric",month:"numeric",day:"numeric"}),O`
    ...
    </div>`},y=(t,e)=>e.loading?O`${b(t,e)}${Xt()}`:e.editing?"URL"===e.type?O`
    ...
    `))}
      ...
      <button type='button' data-id="${t}" @click="${c}" class='pzhc pzbutton Simple' title='Delete'>${kt()}</button>`:O`${b(t,e)}
    <button type='button' data-id="${t}" @click="${l}" class='pzhc pzbutton Simple' title='Delete'>${kt()}</button>`,v=t=>{if(!a)return Xt();const e=[];if(void 0!==t){const a=Object.entries(t);for(const t of a){let a=t[1].extension;void 0===a&&(a=t[1].type),"URL"===t[1].type&&t[1].editing?e.push(O`<div class='flex layout-content-stacked content-items-maxwidth'>
              ${y(t[0],t[1])}
  ...
  <path d="M22.1632813,6.753125 C22.1632813,6.753125 22.1632813,6.753125 22.1632813,6.753125 C22.1632813,6.753125 15.8414062,0.43125 15.8414062,0.43125 C15.6023437,0.14375 15.21875,0 14.7875,0 C14.7875,0 14.7875,0 14.7875,0 C14.7875,0 3.48515625,0 3.48515625,0 C3.05390625,0 2.71875,0.14375 2.43125,0.43125 C2.14375,0.71875 2,1.05390625 2,1.48515625 C2,1.48515625 2,1.48515625 2,1.48515625 C2,1.48515625 2,23.0367188 2,23.0367188 C2,23.4679688 2.14375,23.803125 2.43125,24.090625 C2.71875,24.378125 3.05390625,24.521875 3.48515625,24.521875 C3.48515625,24.521875 3.48515625,24.521875 3.48515625,24.521875 C3.48515625,24.521875 21.109375,24.521875 21.109375,24.521875 C21.540625,24.521875 21.8757812,24.378125 22.1632813,24.090625 C22.4507812,23.803125 22.5945312,23.4679688 22.5945312,23.0367188 C22.5945312,23.0367188 22.5945312,23.0367188 22.5945312,23.0367188 C22.5945312,23.0367188 22.5945312,7.80703125 22.5945312,7.80703125 C22.5945312,7.37578125 22.4507812,7.040625 22.1632813,6.753125 Z M15.6976563,1.6765625 C15.6976563,1.6765625 20.8703125,6.84921875 20.8703125,6.84921875 C20.8703125,6.84921875 16.225,6.84921875 16.225,6.84921875 C15.8898438,6.84921875 15.7460938,6.70546875 15.7460938,6.3703125 C15.7460938,6.3703125 15.7460938,6.3703125 15.7460938,6.3703125 C15.7460938,6.3703125 15.6984375,1.6765625 15.6984375,1.6765625 L15.6976563,1.6765625 Z M21.6367188,7.8546875 C21.6367188,7.8546875 21.6367188,23.0367188 21.6367188,23.0367188 C21.6367188,23.371875 21.4453125,23.515625 21.1101563,23.515625 C21.1101563,23.515625 21.1101563,23.515625 21.1101563,23.515625 C21.1101563,23.515625 3.4859375,23.515625 3.4859375,23.515625 C3.15078125,23.515625 2.959375,23.371875 2.959375,23.0367188 C2.959375,23.0367188 2.959375,23.0367188 2.959375,23.0367188 C2.959375,23.0367188 2.959375,1.48515625 2.959375,1.48515625 C2.959375,1.15 3.15078125,0.95859375 3.4859375,0.95859375 C3.4859375,0.95859375 3.4859375,0.95859375 3.4859375,0.95859375 C3.4859375,0.95859375 14.740625,0.95859375 14.740625,0.95859375 C14.740625,0.95859375 14.740625,6.3703125 14.740625,6.3703125 C14.740625,6.8015625 14.884375,7.13671875 15.171875,7.42421875 C15.459375,7.71171875 15.7945313,7.85546875 16.2257813,7.85546875 C16.2257813,7.85546875 16.2257813,7.85546875 16.2257813,7.85546875 C16.2257813,7.85546875 21.6375,7.85546875 21.6375,7.85546875 L21.6367188,7.8546875 Z"/>
    ...
    <div class="flex layout-content-inline_middle main-header">
      ...
      <div class="flex layout-content-inline_middle margin-l-auto">
        ...
        class="pzhc pzbutton Simple" title="Close">${Dt()}</button>
      </div>
    </div>
...
`,ae=(t,e,a,i)=>O`
  ${t.map(((t,n)=>{const s=`${e}-${n}`;if(t.layout){""!==t.layout.groupFormat.trim()&&"CENTER"!==t.layout.groupFormat||(t.layout.groupFormat="default");const e=t.layout.groupFormat.replace(/ /g,"_").toLowerCase(),n=`flex content layout-content-${e} content-${e}`;if(t.layout.view&&t.layout.view.groups)return O`
          <div class="${n}">${ae(t.layout.view.groups,s,a,i)}</div>
        ...
        ${e}<div class="${n}">${ae(t.layout.groups,s,a,i)}</div>
  ...
  ${Jt(t.layout,a)}
`)(t,0,a):ie(t,s,a):null}if(t.field){if(t.field.control&&"pxAttachContent"===t.field.control.type)return Qt("Upload file","Upload file","",i.displayAttachments);if(t.field.control.actionSets[0]&&t.field.control.actionSets[0].actions[0]&&"localAction"===t.field.control.actionSets[0].actions[0].action){const e=i.actionID;return((t,e,a)=>{const i=t.control.actionSets[0].actions[0].actionProcess.localAction,n=t.control.actionSets[0].actions[0].actionProcess.target,s=t.control.modes[1].controlFormat?t.control.modes[1].controlFormat:"";if("modalDialog"===n){const n=a=>{L(ee(t.control.label,Xt()),a),e(i,a)};return Kt(i,t.control.label,s,n,a)}return O`<div><button type="button" @click="${()=>{e(i)}}" class="pzhc pzbutton ${s}">${t.control.label}</button></<div>`})(t.field,i.displayLocalAction,(()=>{i.reloadAssignment(e)}))}return It(t.field,s,a)}return t.view&&t.view.groups?"pyAttachFieldOptional"===t.view.viewID&&"Embed-Attach-File"===t.view.appliesTo?Qt("Upload file","Upload file","",i.displayAttachments):ae(t.view.groups,s,a,i):null}))}
`,ie=(t,e,a)=>O`
  ${Zt(t.layout)}
  <div class="rdl">
    ${ne(t.layout.rows,e,a)}
  </div>
  ${Jt(t.layout,a)}
`,ne=(t,e,a)=>O`
  ${t.map(((t,i)=>{const n=`${e}-row${i}`;return t.groups?O`
      ...
      `:null}))}
`,se=(t,e,a,i)=>{if(null==i)return null;let n;const s=`${Math.random().toString(36).substr(2,9)}`,r=document.createElement("ul");r.setAttribute("id",`menu-overlay-${s}`),r.setAttribute("role","menu"),r.setAttribute("aria-labelledby",`menubutton-${s}`),r.setAttribute("tabindex","-1");const o=()=>{document.body.removeEventListener("click",c),document.body.removeEventListener("keydown",l),r&&(r.previousElementSibling&&(r.previousElementSibling.setAttribute("aria-expanded","false"),r.previousElementSibling.focus()),r.remove())},l=t=>{38===t.keyCode?(n=n.previousElementSibling,null===n&&(n=r.lastElementChild),n.focus()):40===t.keyCode?(n=n.nextElementSibling,null===n&&(n=r.firstElementChild),n.focus()):27===t.keyCode||9===t.keyCode?o():13===t.keyCode&&(i(t),o())},c=t=>{if(t){let e=t.target;if(t.path&&t.path.length>0?e=t.path[0]:t.originalTarget&&(e=t.originalTarget),e&&e.nextElementSibling===r)return;e.parentNode===r&&i(t),o()}},d=t=>{if("keydown"===t.type&&40!==t.keyCode)return;if(t.preventDefault(),"blur"===t.type)return void c(t);const e=t.target;"BUTTON"!==e.tagName?(i(t),o()):null===e.nextElementSibling?(t.target.parentNode.appendChild(r),e.setAttribute("aria-expanded","true"),L(a(),r),n=e.nextElementSibling.firstElementChild,n.focus(),document.body.addEventListener("click",c),document.body.addEventListener("keydown",l)):o()};return O`
  ...
  `},re=(t,e,a,i,n,s,r,o,l)=>{const c=O`${_t()}<span class='count-badge'>${n}</span>`;if(void 0===e.caseID&&a.content)return O`
    <div class="flex layout-content-inline_middle main-header">
      <h2>${a.content.pyLabel} (${a.content.pyID})</h2>
      ${""!==i?O`<span class='badge-bg-info centered'><span class='badge_text'>${i}</span></span>`:""}
      <div class="flex layout-content-inline_middle margin-l-auto">
        ${l?Qt("Attachments",c,"Simple",l):""}
        ${a.actions&&a.actions.length>0?O`
          ${se("Actions","Start a new action",s,r)}`:""}
      </div>
    </div>
    ${((t,e)=>t&&0!==t.length?O`
  <h3>
 ...
 <h3>${t}</h3>`},oe=(t,e,a,i,n)=>O`
  <div class="flex layout-content-stacked">${ae(t,e,!1,n)}</div>
  ${((t,e)=>O`
  <div class="action-button-area">
...
`)(a,i)}
`,le=(t,e,a,i)=>O`
  <div class="flex layout-content-stacked">${ae(t,e,!0,i)}</div>
  ${(t=>null===t?null:O`
  <div class="action-button-area">
...
`,he=t=>t.errorDetails?O`
  ...
  `))}
  </ul>`,ue=(t,e)=>{const a=[],i=Object.entries(e.actions);for(const e of i)e[1].name!==t&&a.push(O`
...
${t.pxResults.map((t=>O`
    <option>
      ${t.pyUserName}
    </option>`))}`;function ge(t,e,a,i){a&&Object.defineProperty(t,e,{enumerable:a.enumerable,configurable:a.configurable,writable:a.writable,value:a.initializer?a.initializer.call(i):void 0})}function me(t,e,a,i,n){var s={};return Object.keys(i).forEach((function(t){s[t]=i[t]})),s.enumerable=!!s.enumerable,s.configurable=!!s.configurable,("value"in s||s.initializer)&&(s.writable=!0),s=a.slice().reverse().reduce((function(a,i){return i(t,e,a)||a}),s),n&&void 0!==s.initializer&&(s.value=s.initializer?s.initializer.call(n):void 0,s.initializer=void 0),void 0===s.initializer&&(Object.defineProperty(t,e,s),s=null),s}var fe,be,ye,ve,$e,xe,we,Ce,Se,De,ke,_e,Ie,Ae,Te,Ne,Ee,ze,Re,Me,Le,Pe,Oe,qe,Ue,Fe,je,Ve,He,We,Be,Ze,Je,Ye,Ge;let Xe=(fe=K({type:String}),be=K({type:String}),ye=K({type:String}),ve=K({type:String}),$e=K({type:String}),xe=K({type:String}),we=K({type:String}),Ce=K({type:String}),Se=K({type:String}),De=K({type:String}),ke=K({type:String}),_e=K({type:String}),Ie=K({type:String}),Ae=K({type:Object}),Te=K({type:String}),Ne=K({type:String}),Ee=K({type:String}),Re=me((ze=class extends it{constructor(){super(),ge(this,"url",Re,this),ge(this,"caseID",Me,this),ge(this,"username",Le,this),ge(this,"password",Pe,this),ge(this,"title",Oe,this),ge(this,"bShowCreate",qe,this),ge(this,"bShowCancel",Ue,this),ge(this,"bShowAttachments",Fe,this),ge(this,"bShowSave",je,this),ge(this,"authentication",Ve,this),ge(this,"token",He,this),ge(this,"clientid",We,this),ge(this,"clientsecret",Be,this),ge(this,"initialContent",Ze,this),ge(this,"action",Je,this),ge(this,"casetype",Ye,this),ge(this,"portalName",Ge,this),this.cases=[],this.dataPages={},this.name="",this.etag="",this.casepyStatusWork="",this.casedata={},this.data={},this.numAttachments=0,this.attachmentcategories=[],this.assignmentID="",this.actionID="",this.content={},this.errorMsg="",this.validationMsg="",this.bShowConfirm=!1,this.bShowNew=!1}}).prototype,"url",[fe],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),Me=me(ze.prototype,"caseID",[be],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),Le=me(ze.prototype,"username",[ye],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),Pe=me(ze.prototype,"password",[ve],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),Oe=me(ze.prototype,"title",[$e],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return"My worklist"}}),qe=me(ze.prototype,"bShowCreate",[xe],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return"true"}}),Ue=me(ze.prototype,"bShowCancel",[we],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return"true"}}),Fe=me(ze.prototype,"bShowAttachments",[Ce],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return"false"}}),je=me(ze.prototype,"bShowSave",[Se],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return"true"}}),Ve=me(ze.prototype,"authentication",[De],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),He=me(ze.prototype,"token",[ke],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),We=me(ze.prototype,"clientid",[_e],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),Be=me(ze.prototype,"clientsecret",[Ie],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),Ze=me(ze.prototype,"initialContent",[Ae],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),Je=me(ze.prototype,"action",[Te],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),Ye=me(ze.prototype,"casetype",[Ne],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),Ge=me(ze.prototype,"portalName",[Ee],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),ze);class Ke extends Xe{clearLoadingIndicator(){const t=this.getRenderRoot().querySelector("#case-data");t&&null!==t.querySelector(".loading")&&L(null,t)}sendExternalEvent(t){this.dispatchEvent(new CustomEvent("message",{detail:{type:t}}))}genErrorMessage(t){this.clearLoadingIndicator(),t.message&&-1!==t.message.indexOf("JSON.parse")?console.error("Error:",t):t.message&&-1!==t.message.indexOf("Unexpected token")?(this.errorMsg="Error 404: Resource not found",this.requestUpdate(),console.error(this.errorMsg)):(t.status?""!==t.statusText?this.errorMsg=`Error ${t.status}: ${t.statusText}`:401===t.status?this.errorMsg="Error 401: Authentication error":500===t.status?this.errorMsg="Error 500: Internal server error":this.errorMsg=`Error ${t.status}`:t.name&&t.message?this.errorMsg=`Error ${t.name}: ${t.message}`:this.errorMsg="string"==typeof t?t:"Critical error",this.requestUpdate(),console.error("Error:",t))}fetchData(t,e){const{id:a,actionid:i,target:n,element:s}=e||{};let r="";""!==this.authentication&&"basic"!==this.authentication||(r=`Basic ${btoa(`${this.username}:${this.password}`)}`),""!==this.token&&(r=`Bearer ${this.token}`);const o={method:"GET",headers:{"Content-Type":"application/json;charset=UTF-8",Authorization:r},mode:"cors"};let l=`${this.url}/api/v1/`;switch(t){case"worklist":l+="assignments";break;case"casetypes":l+="casetypes";break;case"newwork":l+=`casetypes/${a}`;break;case"assignment":l+=`assignments/${a}`;break;case"case":l+=`cases/${a}`;break;case"data":l+=`data/${a}`;break;case"page":l+=`cases/${a}/pages/${i}`;break;case"view":l+=`cases/${a}/views/${i}`;break;case"assignmentaction":l+=`assignments/${a}/actions/${i}`;break;case"caseaction":l+=`cases/${a}/actions/${i}`;break;case"attachment":l+=`attachments/${a}`;break;case"attachments":l+=`cases/${a}/attachments`;break;case"attachmentcategories":l+=`cases/${a}/attachment_categories`}fetch(l,o).then((e=>{if("case"===t)this.etag=e.headers.get("etag"),n&&(n.disabled=!1,n.textContent="Save");else if("attachment"===t)return e.text();return e.ok||404===e.status?e.json():Promise.reject(e)})).then((e=>{try{if(e.errors&&e.errors.length>0)return this.errorMsg=`Error ${e.errors[0].ID}: ${e.errors[0].message}`,this.clearLoadingIndicator(),this.requestUpdate(),void console.error("Error:",e);const r=this.getRenderRoot().querySelector("#case-data");switch(t){case"casetypes":this.casetypes={};for(const t in e.caseTypes){const a=e.caseTypes[t];"workList"===this.action&&""!==this.casetype&&this.casetype!==a.ID||(this.casetypes[a.ID]={canCreate:a.CanCreate,name:a.name,requiresFieldsToCreate:!1})}"createNewWork"===this.action&&this.createCase();break;case"worklist":this.cases=e.assignments,this.requestUpdate();break;case"assignment":this.data=e,this.caseID=e.caseID,this.fetchData("case",{id:this.caseID}),e.actions.length>0&&e.actions[0].ID?(this.actionID=e.actions[0].ID,this.fetchData("assignmentaction",{id:a,actionid:this.actionID})):this.fetchData("view",{id:this.caseID,actionid:"pyCaseInformation"});break;case"case":this.casedata=e,this.numAttachments=0,""===this.name&&(this.name=this.casedata.content.pyLabel),this.casepyStatusWork=this.casedata.content.pyStatusWork,this.requestUpdate(),""===this.assignmentID&&this.fetchData("view",{id:this.caseID,actionid:"pyCaseInformation"}),"true"===this.bShowAttachments&&this.fetchData("attachments",{id:this.caseID});break;case"data":if(this.dataPages[a]=e,!s.nextElementSibling){console.error("Error: case data are not present when retrieving the data");break}L(pe(e),s.nextElementSibling);break;case"caseaction":if(!r){console.error("Error: case data are not present when retrieving the assignmentaction");break}L(ce(e.view.groups,"Obj","true"===this.bShowCancel?this.actionAreaCancel:null,this.actionAreaSave,this),r),r.focus();break;case"assignmentaction":if(!r){console.error("Error: case data are not present when retrieving the assignmentaction");break}n?(this.actionID=i,L(ee(e.name,oe(e.view.groups,"Obj",this.actionAreaCancel,null,this)),n),n.focus()):(this.name=e.name,this.requestUpdate(),L(oe(e.view.groups,"Obj","true"===this.bShowCancel?this.actionAreaCancel:null,"true"===this.bShowSave?this.actionAreaSave:null,this),r),r.focus());break;case"page":if(!r){console.error("Error: case data are not present when retrieving the page");break}L(oe(e.groups,"Obj",this),r),r.focus();break;case"view":if(!r){console.error("Error: case data are not present when retrieving the page");break}this.content={},"pyCaseInformation"===i?(this.name=e.name,L(le(e.groups,"Obj","true"===this.bShowCancel?this.actionAreaCancel:null,this),r)):(this.name=e.name,L(oe(e.groups,"Obj",this),r)),r.focus();break;case"newwork":if(this.content={},!r){console.error("Error: case data are not present when retrieving the newwork");break}L(de(e.creation_page.groups[0].layout.groups,"Obj","true"===this.bShowCancel?this.actionAreaCancel:null),r),r.focus();const t=this.getRenderRoot().querySelector("#case-data");t&&((t,e)=>{for(const a in t.elements){const i=t.elements[a];if("INPUT"===i.tagName||"TEXTAREA"===i.tagName||"SELECT"===i.tagName){const t=i.getAttribute("data-ref");if(null!==t&&"pyID"!==t&&e[t]){const a=e[t];"object"==typeof a?("radio"===i.type?i.value===a.value&&(i.checked=!0):"checkbox"===i.type?!0!==a.value&&"true"!==a.value||(i.checked=!0):a.value&&(i.value=a.value),a.disabled&&(i.disabled=!0)):"string"==typeof a?"radio"===i.type?i.value===a&&(i.checked=!0):"checkbox"===i.type?"true"===a&&(i.checked=!0):i.value=a:"boolean"==typeof a&&"checkbox"===i.type&&!0===a&&(i.checked=!0)}}}})(t,this.initialContent);break;case"attachments":let o=e.attachments;o||(o=[]),this.numAttachments=o.length,n&&L(te(n,o,this.caseID,this),n),this.requestUpdate();break;case"attachmentcategories":this.attachmentcategories=e.attachment_categories;break;case"attachment":n(e)}}catch(t){this.errorMsg=`Error: ${t}`,this.requestUpdate(),console.error("Error:",t)}})).catch((t=>{this.genErrorMessage(t)}))}sendData(t,e,a){const{id:i,actionid:n,target:s,refreshFor:r}=e;let o="";""!==this.authentication&&"basic"!==this.authentication||(o=`Basic ${btoa(`${this.username}:${this.password}`)}`),""!==this.token&&(o=`Bearer ${this.token}`);const l={"Content-Type":"application/json;charset=UTF-8",Authorization:o},c={method:"POST",headers:l,mode:"cors"};let d=`${this.url}/api/v1/`;switch(this.validationMsg="",t){case"authenticate":"oauth2password"===this.authentication?c.body=`grant_type=password&client_id=${this.clientid}&client_secret=${this.clientsecret}&username=${this.username}&password=${this.password}`:"oauth2clientcredentials"===this.authentication&&(c.body=`grant_type=client_credentials&client_id=${this.clientid}&client_secret=${this.clientsecret}`),c.headers["Content-Type"]="application/x-www-form-urlencoded",d=`${this.url}/PRRestService/oauth2/v1/token`;break;case"newwork":d+="cases",c.body=JSON.stringify({content:this.content,caseTypeID:i});break;case"submitassignment":c.body=JSON.stringify({content:this.content}),d+=`assignments/${i}?actionID=${n}`;break;case"savecase":d+=`cases/${i}`,n&&""!==n&&(d+=`?actionID=${n}`),c.headers["If-Match"]=this.etag,c.method="PUT",c.body=JSON.stringify({content:this.content});break;case"refreshnew":d+=`casetypes/${i}/refresh`,r&&""!==r&&(d+=`?refreshFor=${r}`),c.headers["If-Match"]=this.etag,c.method="PUT",c.body=JSON.stringify({content:this.content});break;case"refreshassignment":d+=`assignments/${i}/actions/${n}/refresh`,r&&""!==r&&(d+=`?refreshFor=${r}`),c.headers["If-Match"]=this.etag,c.method="PUT",c.body=JSON.stringify({content:this.content});break;case"refreshcase":d+=`cases/${i}/actions/${n}/refresh`,r&&""!==r&&(d+=`?refreshFor=${r}`),c.headers["If-Match"]=this.etag,c.method="PUT",c.body=JSON.stringify({content:this.content});break;case"uploadattachment":d+="attachments/upload",delete l["Content-Type"];const t=new FormData;t.append("File",n,n.name),c.body=t;break;case"attachments":d+=`cases/${i}/attachments`,c.body=JSON.stringify({attachments:n});break;case"deleteattachment":d+=`attachments/${i}`,c.method="DELETE"}fetch(d,c).then((e=>"deleteattachment"===t||"attachments"===t?e.text():200===e.status||201===e.status||e.status>=400&&e.status<500?e.json():e.ok?Promise.resolve("ok"):Promise.reject(e))).then((e=>{if(e.errors&&e.errors.length>0){if(e.errors[0].ValidationMessages)if(s&&"modalcontent"===s.id)$t(s,e.errors[0].ValidationMessages),L(he(e),s.previousElementSibling);else{const t=this.getRenderRoot().querySelector("#case-data");$t(t,e.errors[0].ValidationMessages),this.validationMsg=he(e)}else this.errorMsg=`Error ${e.errors[0].ID}: ${e.errors[0].message}`;this.clearLoadingIndicator(),s&&"BUTTON"===s.tagName&&(s.disabled=!1,s.textContent="Save")}else if(e.access_token)this.token=e.access_token;else{const i=this.getRenderRoot().querySelector("#case-data");if("refreshcase"===t||"refreshassignment"===t||"refreshnew"===t){if(!i)return void console.error("Error: case data are not present");L("refreshnew"===t?de(e.creation_page.groups[0].layout.groups,"Obj","true"===this.bShowCancel?this.actionAreaCancel:null,this):oe(e.view.groups,"Obj",this.actionAreaCancel,"true"===this.bShowSave?this.actionAreaSave:null,this),i)}else if("savecase"===t){if(this.sendExternalEvent(t),this.fetchData("case",{id:this.caseID,target:s}),a)return void a();""!==this.assignmentID&&this.fetchData("assignment",{id:this.assignmentID})}else if("deleteattachment"===t||"attachments"===t)this.fetchData("attachments",{id:this.caseID,target:s});else if("uploadattachment"===t){let t=n.name.lastIndexOf(".");-1===t&&(t=n.name.length);const a=n.name.substring(t+1),i=[{type:"File",category:n.category,fileType:a,name:n.displayName,ID:e.ID}];return void this.sendData("attachments",{id:this.caseID,actionid:i,target:s})}e.ID&&(this.caseID=e.ID),e.nextAssignmentID?(i&&(L(Xt(),i),this.requestUpdate()),this.bShowNew=!1,this.assignmentID=e.nextAssignmentID,this.sendExternalEvent(t),this.fetchData("assignment",{id:this.assignmentID})):e.nextPageID&&(i&&(L(Xt(),i),this.requestUpdate()),this.sendExternalEvent(t),"Confirm"===e.nextPageID||"Review"===e.nextPageID?(this.bShowConfirm=!0,this.fetchData("view",{id:this.caseID,actionid:"pyCaseInformation"}),this.fetchData("case",{id:this.caseID})):this.fetchData("page",{id:this.caseID,actionid:e.nextPageID}))}this.requestUpdate()})).catch((t=>{this.genErrorMessage(t)}))}}const Qe=(t,e,a,i)=>O`
  <div class="flex layout-content-inline_middle main-header">
    <h2>${t} (${e})</h2>
  ...
  <div class="flex layout-content-inline_middle main-header">
    ...
    <div class="flex layout-content-inline_middle margin-l-auto">
      ...
      ${se("Create","Create a new case",a,n)}
    </div>
  </div>
  ${e.length>0?O`
        <table>
...
`;G("pega-mashup")(class extends aa{createRenderRoot(){return this.attachShadow({mode:"open"})}getRenderRoot(){return this.shadowRoot}render(){return O`
      ${ia()} ${this.displayContent()}
    `}}),G("pega-mashup-light")(class extends aa{createRenderRoot(){return this}getRenderRoot(){return this}render(){return O`
      ${this.displayContent()}
    `}});const na=(t,e,a,i)=>void 0===e?O`
      ${i}
    `:O`
  ...
  `,sa=(t,e,a)=>{let i=t.value;if("Date"===e)if(i=lt(t.value),i){const t={year:"numeric",month:"short",day:"numeric"};i=new Intl.DateTimeFormat([],t).format(i)}else i=t.value;else if("DateTime"===e)if(i=lt(t.value),i){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};i=new Intl.DateTimeFormat([],t).format(i)}else i=t.value;else if("Time"===e)if(i=lt(t.value),i){const t={hour:"numeric",minute:"numeric"};i=new Intl.DateTimeFormat([],t).format(i)}else i=t.value;return O`
...
`,ha=(t,e)=>O`
  ...
  />
`,ua=(t,e)=>{let a=[{value:"true"},{value:"false"}];return t.options&&(a=t.options),O`
    ${a.map(((a,i)=>{const n=`rb-${e}-${i}`;return O`
        <div>
          <input
            data-ref="${t.reference}"
  ...
  ?required="${"true"===t.required}">
    ...
    <input
      ...
      value="${a}"
    />
  `},ma=(t,e)=>{let a=t.value;if(""!==a){let e=lt(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${e.getFullYear()}-${ot(e.getMonth()+1)}-${ot(e.getDate())}`):8===t.value.length&&(a=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}`)}return O`
    <input
      data-ref="${t.reference}"
      ?required="${"true"===t.required}"
      type="date"
      ...
      value="${a}"
    />
  `},fa=(t,e)=>{let a=t.value;if(""!==a){let e=lt(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${ot(e.getHours())}-${ot(e.getMinutes())}-${ot(e.getSeconds())}`):8===t.value.length&&(a=`${t.value.substring(9,10)}:${t.value.substring(10,11)}:${t.value.substring(11,12)}`)}return O`
    <input
      data-ref="${t.reference}"
      ?required="${"true"===t.required}"
      type="time"
      ...
      value="${a}"
    />
  `},ba=(t,e,a,i,n)=>{if(void 0===t)return null;if(!t.config||!t.config.template)return O`${t.map(((t,s)=>{const r=`${e}-${s}`;if("reference"===t.type&&"view"===t.config.type){let e="";return t.config.context&&(e=t.config.context),ba(i.data.uiResources.resources.views[t.config.name],r,a,i,""===n?e.substring(1):n+e)}return((t,e,a,i,n)=>{const s=t.config.value.replace("@P .","");if(t.config.reference=void 0===n||""===n?s:`${n}.${s}`,t.config.value=ht(i.casedata.content,t.config.reference),t.config.datasource&&0===t.config.datasource.indexOf("@ASSOCIATED")){const e=i.data.context_data?i.data.context_data.content:i.data.uiResources.context_data.caseInfo.content,a=""===n?e:ht(e,n);a&&(t.config.options=a.summary_of_associated_lists__[s])}if(t.config.options||(t.config.options=[]),t.config.value?t.config.value=`${t.config.value}`:t.config.value="",!0===a||"true"===t.config.readOnly)return na(t.config,e,"field-text",sa(t.config,t.type,e));switch(t.type){case"Decimal":case"TextInput":return na(t.config,e,"field-textinput",ra(t.config,e));case"Email":return na(t.config,e,"field-emailinput",ca(t.config,e));case"Integer":return na(t.config,e,"field-numberinput",oa(t.config,e));case"Currency":return na(t.config,e,"field-currencyinput",la(t.config,e));case"RadioButtons":return na(t.config,e,"field-radiogroup",ua(t.config,e));case"TextArea":return na(t.config,e,"field-textarea",da(t.config,e));case"Checkbox":return na(t.config,e,"field-checkbox",ha(t.config,e));case"Dropdown":return na(t.config,e,"field-dropdown",pa(t.config,e));case"DateTime":return na(t.config,e,"field-datetime",ga(t.config,e));case"Date":return na(t.config,e,"field-date",ma(t.config,e));case"Time":return na(t.config,e,"field-time",fa(t.config,e));default:return null}})(t,r,a,i,n)}))}`;switch("TwoColumn"===t.config.template&&1===t.children.length&&(t.config.template="OneColumn"),t.config.template){case"TwoColumn":return O`
          <div class="flex layout-content-inline_grid_double">
            <div class="flex layout-content-stacked">${ba(t.children[0].children,`${e}-0`,a,i,n)}</div>
            <div class="flex layout-content-stacked">${ba(t.children[1].children,`${e}-1`,a,i,n)}</div>
          </div>
        `;case"OneColumn":return O`
          <div class="flex layout-content-stacked">
            ${ba(t.children[0].children,`${e}-0`,a,i,n)}
          </div>
        `;case"Details":return O`
          <div class="flex layout-content-stacked_with_labels_left">
            ${ba(t.children[0].children,`${e}-0`,a,i,n)}
          </div>
        `;default:return null}},ya=(t,e,a,i,n,s,r,o,l)=>{const c=O`${_t()}<span class='count-badge'>${n}</span>`;if(void 0===e.caseID&&a.content){const t=a.content.pyID.split(" ")[1];return O`
    <div class="flex layout-content-inline_middle main-header">
