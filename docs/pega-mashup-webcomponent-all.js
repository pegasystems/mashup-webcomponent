...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */;function E(t){let e=M.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},M.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const i=t.strings.join(a);return s=e.keyString.get(i),void 0===s&&(s=new o(t,t.getTemplateElement()),e.keyString.set(i,s)),e.stringsArray.set(t.strings,s),s}const M=new Map,N=new WeakMap,L=(t,a,s)=>{let i=N.get(a);void 0===i&&(e(a,a.firstChild),N.set(a,i=new S(Object.assign({templateFactory:E},s))),i.appendInto(a)),i.setValue(t),i.commit()};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
`,xs=(t,e)=>{const a=cs(t,"click");return"deleteRow"===a?_s(t,e):B`
  ...
  >${ns()}</button>
`,Cs=(t,e)=>{let a=t.value;if(""!==a){let e=qa(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${e.getFullYear()}-${Ha(e.getMonth()+1)}-${Ha(e.getDate())}T${Ha(e.getHours())}:${Ha(e.getMinutes())}`):8===t.value.length&&(a=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}T00:00`)}return B`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="datetime-local"
    ...
    data-action-click="${at(cs(t,"click"))}"
    />
  `},ks=(t,e)=>{let a=t.value;if(""!==a){let e=qa(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${e.getFullYear()}-${Ha(e.getMonth()+1)}-${Ha(e.getDate())}`):8===t.value.length&&(a=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}`)}return B`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="date"
    ...
    data-action-click="${at(cs(t,"click"))}"
    />
  `},Ss=(t,e)=>{let a=t.value;if(""!==a){let e=qa(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${Ha(e.getHours())}-${Ha(e.getMinutes())}-${Ha(e.getSeconds())}`):8===t.value.length&&(a=`${t.value.substring(9,10)}:${t.value.substring(10,11)}:${t.value.substring(11,12)}`)}return B`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="time"
...
`,As=(t,e)=>t.control&&t.control.modes[0]&&t.control.modes[0].options?B`<select
  ...
  `},zs=t=>""!==t.title?B`
    ...
    `:null,Rs=(t,e)=>{let a=t.fieldListID;if(void 0!==t.reference&&(a=t.reference),"."===a.charAt(0)&&(a=a.substring(1)),t.newRow&&!0!==e){const e=[];return Za(t.newRow,e),B`
      <div class="table-action-area">
        ${"add-row"===t.testID?B`<button type="button" class="pzhc pzbutton Simple" data-newrow="${at(e.join())}"
...
`,qs=(t,e,a,s)=>B`
  ${t.map(((t,i)=>{const n=`${e}-${i}`;if(t.layout){""!==t.layout.groupFormat.trim()&&"CENTER"!==t.layout.groupFormat||(t.layout.groupFormat="default");const e=t.layout.groupFormat.replace(/ /g,"_").toLowerCase(),i=`flex content layout-content-${e} content-${e}`;if(t.layout.view&&t.layout.view.groups)return B`
          <div class="${i}">${qs(t.layout.view.groups,n,a,s)}</div>
        ...
        ${e}<div class="${i}">${qs(t.layout.groups,n,a,s)}</div>
        `}return t.layout.rows?t.layout.header?((t,e,a)=>B`
  ${zs(t.layout)}
  <table>
    <thead>
      <tr>
        ${Es(t.layout.header.groups)}
      </tr>
    </thead>
    <tbody>
      ${Ms(t.layout.rows)}
...
`,js=(t,e,a,s,i,n,o,r,c)=>{const l=B`${os()}<span class='count-badge'>${i}</span>`;if(void 0===e.caseID&&a.content)return B`
 ...
 <h3>${t}</h3>`},Vs=(t,e,a,s,i)=>B`
  <div class="flex layout-content-stacked">${qs(t,e,!1,i)}</div>
  ${((t,e)=>B`
  <div class="action-button-area">
...
`)(a,s)}
`,Ws=(t,e,a,s)=>B`
  <div class="flex layout-content-stacked">${qs(t,e,!0,s)}</div>
  ${(t=>null===t?null:B`
  <div class="action-button-area">
...
`)(a,s)}
`,Js=(t,e,a,s)=>B`
  <div class="flex layout-content-stacked">${qs(t,e,!1,s)}</div>
  ${(t=>B`
  <div class="action-button-area">
    ${null!==t?B`<button type="button" class="pzhc pzbutton" @click="${t}">Cancel</button>`:""}
...
`;customElements.define("pega-mashup",class extends si{createRenderRoot(){return this.attachShadow({mode:"open"})}getRenderRoot(){return this.shadowRoot}render(){return B`
    ...
    ${e.values.map((t=>B` <option value=${t.value}>${t.name}</option>`))}
        ...
        `))}
    `}}customElements.define("rich-text-editor",ri);const ci=(t,e)=>{if(t.helperText&&""!==t.helperText)return`${e}-info`},li=t=>{if(t.placeholder&&""!==t.placeholder)return t.displayplaceholder},di=(t,e,a,s)=>void 0===e||""===e?B`
      ${s}
    `:B`
  ...
  `,hi=(t,e,a,s,i)=>{if(!1===t.config.visibility)return null;let n=!1;if(t.config.displayvalue="",t.config.displaylabel=i18n.t(t.config.label),t.config.displayplaceholder=i18n.t(t.config.placeholder),t.config.displayhelperText=i18n.t(t.config.helperText),t.config.displaycaption=i18n.t(t.config.caption),t.config.value){let e=t.config.value.replace("@P .","");if(t.config.reference=void 0===i||""===i?e:`${i}.${e}`,t.config.displayvalue=Va(s.casedata.content,t.config.reference),"string"==typeof t.config.datasource&&0===t.config.datasource.indexOf("@ASSOCIATED")){e=t.config.datasource.replace("@ASSOCIATED .","");let a="";s.data.context_data?a=s.data.context_data.content:s.data.uiResources.context_data&&s.data.uiResources.context_data.caseInfo&&s.data.uiResources.context_data.caseInfo.content&&(a=s.data.uiResources.context_data.caseInfo.content);const n=""===i?a:Va(a,i);if(n&&(t.config.options=n.summary_of_associated_lists__[e]),void 0===t.config.options&&(a=s.data.uiResources.resources.fields[e],a&&a.datasource))if(a.datasource.records)t.config.options=a.datasource.records;else if(a.datasource.name&&s.data.data.shared[a.datasource.name]){const e=s.data.data.shared[a.datasource.name];if(Object.keys(e).length>0){const s=Object.keys(e)[0];if(e[s].pxResults){const i=a.datasource.propertyForValue.replace("@P .",""),n=a.datasource.propertyForDisplayText.replace("@P .","");t.config.options=[];for(const a in e[s].pxResults){const o=e[s].pxResults[a];t.config.options[a]={key:o[i],value:o[n]}}}}}}else if("object"==typeof t.config.datasource&&t.config.datasource.source&&0===t.config.datasource.source.indexOf("@DATASOURCE")){const e=t.config.datasource.source.replace("@DATASOURCE ","").replace(".pxResults","");if(s.data.data[e]&&s.data.data[e].pxResults)t.config.options=s.data.data[e].pxResults;else if(s.data.uiResources.context_data&&s.data.uiResources.context_data.caseInfo&&s.data.uiResources.context_data.caseInfo.content){const a=s.data.uiResources.context_data.caseInfo.content;if(a[i]&&a[i].summary_of_lists__[e]&&a[i].summary_of_lists__[e].pxResults){const n=a[i].summary_of_lists__[e].pxResults.replace(".pxResults","");if(s.data.data[n]&&s.data.data[n].pxResults){t.config.options=[];const e=t.config.datasource.fields.key.replace("@P .",""),a=t.config.datasource.fields.text.replace("@P .","");for(const i in s.data.data[n].pxResults){const o=s.data.data[n].pxResults[i];t.config.options[i]={key:o[e],value:o[a]}}}}}}t.config.options||(t.config.options=[]),t.config.displayvalue?"object"!=typeof t.config.displayvalue&&(t.config.displayvalue=`${t.config.displayvalue}`):t.config.displayvalue="",s.data.uiResources&&s.data.uiResources.resources&&s.data.uiResources.resources.fields&&s.data.uiResources.resources.fields[e]&&s.data.uiResources.resources.fields[e].isDeclarativeTarget&&(n=!0,s.isDeclarativeTarget=!0)}if(!0===a)return di(t.config,e,"field-text",ui(t.config,t.type,e));"string"!=typeof t.config.visibility&&"string"!=typeof t.config.readOnly&&"string"!=typeof t.config.disabled&&"string"!=typeof t.config.required||(s.refreshOnChange=!0);const o=s.data.data.caseInfo.content;if("string"==typeof t.config.visibility&&"true"!==t.config.visibility){if(!Qa(t.config.visibility,o))return null}else if(!1===t.config.visibility||"false"===t.config.visibility)return null;switch(t.config.readonlystate=!1,"string"==typeof t.config.readOnly&&"false"!==t.config.readOnly?t.config.readonlystate=Qa(t.config.readOnly,o):(!0===t.config.readOnly||"true"===t.config.readOnly||n)&&(t.config.readonlystate=!0),t.config.requiredstate=!1,"string"==typeof t.config.required&&"false"!==t.config.required?t.config.requiredstate=Qa(t.config.required,o):!0!==t.config.required&&"true"!==t.config.required||(t.config.requiredstate=!0),t.config.disabledstate=!1,"string"==typeof t.config.disabled&&"false"!==t.config.disabled?t.config.disabledstate=Qa(t.config.disabled,o):!0!==t.config.disabled&&"true"!==t.config.disabled||(t.config.disabledstate=!0),t.config.disabledstate&&(t.config.requiredstate=!1,t.config.readonlystate=!1),t.type){case"Decimal":case"TextInput":return di(t.config,e,"field-textinput",pi(t.config,e));case"Phone":return di(t.config,e,"field-phoneinput",gi(t.config,e));case"Email":return di(t.config,e,"field-emailinput",bi(t.config,e));case"Integer":return di(t.config,e,"field-numberinput",fi(t.config,e));case"Percentage":return di(t.config,e,"field-percentage",mi(t.config,e));case"Currency":return di(t.config,e,"field-currencyinput",yi(t.config,e));case"RadioButtons":return di(t.config,e,"field-radiogroup",xi(t.config,e));case"TextArea":return di(t.config,e,"field-textarea",vi(t.config,e));case"RichText":return di(t.config,e,"field-richtext",wi(t.config,e));case"Checkbox":return di(t.config,e,"field-checkbox",$i(t.config,e));case"Dropdown":return di(t.config,e,"field-dropdown",_i(t.config,e));case"DateTime":return di(t.config,e,"field-datetime",Ci(t.config,e));case"Date":return di(t.config,e,"field-date",ki(t.config,e));case"Time":return di(t.config,e,"field-time",Si(t.config,e));case"AutoComplete":return di(t.config,e,"field-autocomplete",Di(t.config,e));case"SemanticLink":return di(t.config,e,"field-semanticlink",Ii(t.config));case"Attachment":return di(t.config,e,"field-attachment",Ai(t.config,e,s));case"Location":return di(t.config,e,"field-location",Ti(t.config,e));default:return null}},ui=(t,e,a)=>{let s=t.displayvalue;if(""!==s){if("Phone"===e)return B`<a data-ref="${t.reference}" id="${at(a)}" href="${`tel:${s}`}">${s}</a>`;if("Date"===e){const e={year:"numeric",month:"short",day:"numeric"};s=new Intl.DateTimeFormat([],e).format(new Date(t.displayvalue))}else if("DateTime"===e){s=qa(t.displayvalue);const e={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};s=new Intl.DateTimeFormat([],e).format(new Date(t.displayvalue))}else if("Time"===e){const e={hour:"numeric",minute:"numeric"};s=new Intl.DateTimeFormat([],e).format(new Date(t.displayvalue))}}return B`
  ...
  <input
    ...
    placeholder="${at(li(t))}"
    type="text"
    aria-describedby="${at(ci(t,e))}"
    id="${at(e)}"
    value="${Fa(t.displayvalue)}"
  />
`,gi=(t,e)=>{let a="";for(const e of t.options)0===t.displayvalue.indexOf(e.pyCallingCode)&&(a=e.pyCallingCode);return t.displayvalue=t.displayvalue.substring(a.length),B`
<div> 
<select
...
`,wi=(t,e)=>new ri(Fa(t.displayvalue),t.reference,e),$i=(t,e)=>{const a=t.requiredstate?"icon-required":"";return B`
  <input
  data-ref="${t.reference}"
  ?required="${t.requiredstate}"
  ?readonly="${t.readonlystate}"
...
`},xi=(t,e)=>{let a=[{value:"true"},{value:"false"}];return t.options&&(a=t.options),B`
    ${a.map(((a,s)=>{const i=`rb-${e}-${s}`;return B`
        <div>
          <input
            data-ref="${t.reference}"
  ...
  placeholder="${at(li(t))}"
    ...
    <input
      ...
      value="${a}"
    />
  `},ki=(t,e)=>{let a=t.displayvalue;if(""!==a){let e=qa(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${e.getFullYear()}-${Ha(e.getMonth()+1)}-${Ha(e.getDate())}`):8===t.displayvalue.length&&(a=`${t.displayvalue.substring(0,4)}-${t.displayvalue.substring(4,6)}-${t.displayvalue.substring(6,8)}`)}return B`
    <input
      data-ref="${t.reference}"
      ?required="${t.requiredstate}"
      ?readonly="${t.readonlystate}"
      ...
      value="${a}"
    />
  `},Si=(t,e)=>{let a=t.displayvalue;if(""!==a){let e=qa(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${Ha(e.getHours())}-${Ha(e.getMinutes())}-${Ha(e.getSeconds())}`):8===t.displayvalue.length&&(a=`${t.displayvalue.substring(9,10)}:${t.displayvalue.substring(10,11)}:${t.displayvalue.substring(11,12)}`)}return B`
    <input
      data-ref="${t.reference}"
      ?required="${t.requiredstate}"
      ?readonly="${t.readonlystate}"
  ...
  `},Di=(t,e)=>t.options?B`
    ...
    `:null,Ii=()=>B`
 <a>semantic link</a>
`,Ai=(t,e,a)=>{let s=[];return t.displayvalue&&t.displayvalue.pxResults&&t.displayvalue.pxResults.length>0&&(s=t.displayvalue.pxResults),Os(void 0,s,a.caseID,a)},Ti=(t,e)=>B`<input
 class="location"
 data-ref="${t.reference}"
 ?required="${t.requiredstate}"
 ?readonly="${t.readonlystate}"
...
`,Ri=(t,e)=>{if(!e){const e=[];t.config.children[0].children.map(((t,a)=>(e[a]=t.config.value.replace("@P .",""),null)));const a=t.config.referenceList.replace("@P .","");return B`
      <div class="table-action-area">
    ...
    `}return null},Ei=(t,e,a)=>{const s=t.config.referenceList.replace("@P .",""),i=t.config.children[0].children,n=a.data.data.caseInfo.content[s];return n?B`
  ${n.map(((t,n)=>B`
    <tr>
    ${i.map((t=>{const i=t,o=i18n.t(t.config.label);return B`
    <td data-title="${o}">${hi(i,void 0,e,a,`${s}(${n+1})`)}</td>`}))}${e?null:B`<td><button type="button" class="pzhc pzbutton Simple" 
  aria-label="${i18n.t("Delete item")}" data-ref=${`${s}(${n+1}).pyTemplate`}  
  data-action-click='deleteRow'>${ns()}</button></td>`}
    </tr>`))}
`:null},Mi=(t,e,a,s,i)=>{if(void 0===t)return null;if(!t.config||!t.config.template)return B`${t.map(((t,n)=>{const o=`${e}-${n}`;if("Region"===t.type)return Mi(t.children,`${e}-0`,!0,s,i);if("reference"===t.type&&"view"===t.config.type){let e="";if(t.config.context&&(e=t.config.context),t.config.inheritedProps&&1===t.config.inheritedProps.length&&"label"===t.config.inheritedProps[0].prop){const n=i18n.t(t.config.inheritedProps[0].value),r=s.data.uiResources.resources.views[t.config.name];if(r){const t="SimpleTable"===r.config.template||"ListView"===r.config.template?"field-table":"field-subview";return B`<div class='flex content-item field-item ${t}'><h4>${n}</h4>${Mi(r,o,a,s,""===i?e.substring(1):i+e)}</div>`}}return Mi(s.data.uiResources.resources.views[t.config.name],o,a,s,i&&""!==i?i+e:e.substring(1))}return hi(t,o,a,s,i)}))}`;if("SimpleTable"===t.config.template)return((t,e,a)=>{const s=e||"Editable"!==t.config.renderMode;return B`
  <table class='responsive'>
    <thead>
      <tr>
        ${zi(t.config.children[0].children,s)}
      </tr>
    </thead>
    <tbody>
      ${Ei(t,s,a)}
  ...
  ${Ri(t,s)}`})(t,a,s);if("ListView"===t.config.template)return((t,e,a)=>(a.sendData("dataviews",{id:t.config.referenceList,content:{paging:{pageNumber:1,pageSize:41}}}),B`
  <table class='responsive'>
    <thead>
      <tr>
        ${zi(t.config.presets[0].children[0].children,e)}
      </tr>
    </thead>
    <tbody>${Ns()}
    </tbody>
          ...
          <div class="flex layout-content-inline_grid_double">
            <div class="flex layout-content-stacked">${Mi(t.children[0].children,`${e}-0`,a,s,i)}</div>
            <div class="flex layout-content-stacked">${Mi(t.children[1].children,`${e}-1`,a,s,i)}</div>
          </div>
        `;case"DefaultForm":return B`
          <div class="${`flex layout-content-default-form layout-content-default-form-${t.config.NumCols}`}">
            ${Mi(t.children[0].children,`${e}-0`,a,s,i)}
          </div>
        `;case"DataReference":return B`
          <div class="flex layout-content-stacked">
            ${Mi(t.children,`${e}-0`,a,s,i)}
          </div>
        ...
        `;case"Details":return B`
          <div class="flex layout-content-stacked_with_labels_left">
            ${Mi(t.children[0].children,`${e}-0`,!0,s,i)}
          </div>
        `;default:return null}},Ni=(t,e,a,s,i,n,o,r,c)=>{const l=B`${os()}<span class='count-badge'>${i}</span>`;if(void 0===e.caseID&&a.content){const t=a.content.pyID.split(" ")[1];return B`
    <div class="flex layout-content-inline_middle main-header">
...
`,Bi=(t,e)=>{const{urlparam:a,verifier:s}=(()=>{const t=`${Oa.lib.WordArray.random(16)}`;return{urlparam:`&response_type=code&scope=openid&code_challenge=${Oa.SHA256(t)}&code_challenge_method=S256&response_mode=query&authentication_service=pega`,verifier:t}})(),i=`${t}/PRRestService/oauth2/v1/authorize?client_id=${e}&redirect_uri=${encodeURIComponent(window.location.origin)}/auth.html&${a}&state=${s}`,n=B`<Button class="pzhc pzbutton" onclick="window.location='${i}'; return false;">${i18n.t("Pega with full page redirect")}</Button>`,o=B`<Button class="pzhc pzbutton" onclick="n=window.open('${i}', 'foo', 'width=600,height=600');n.focus(); return false;">
  ...
  <div class='flex layout-content-inline_middle'>${o}${n}</div></div>`};class Oi extends ni{displayContent(){if(""!==this.errorMsg){if(-1===this.errorMsg.indexOf("The provided authorization code is expired"))return ei(this.errorMsg,"true"===this.bShowCancel?this.resetError:null);window.history.replaceState({},"",window.location.pathname.substring(1))}if(window.history.state&&window.history.state.token&&(this.token=window.history.state.token),("oauth2password"===this.authentication||"oauth2clientcredentials"===this.authentication)&&""===this.token)return this.sendData("authenticate",{}),null;if("authorizationcode"===this.authentication&&""===this.token)return window.history.state&&window.history.state.code?(this.sendData("authenticate",{}),null):Bi(this.url,this.clientid);if(this.casetypes||"createNewWork"!==this.action&&"workList"!==this.action?"createNewWork"===this.action&&""===this.caseID&&this.casetypes&&this.casetypes[this.casetype]?this.sendData("newwork",{id:this.casetype}):""===this.name&&("openAssignment"===this.action&&""===this.assignmentID&&(this.assignmentID=this.caseID),""!==this.assignmentID?this.fetchData("assignment",{id:this.assignmentID}):""!==this.caseID&&this.fetchData("view",{id:this.caseID,actionid:"pyReview"})):(this.fetchData("portal"),"createNewWork"===this.action?this.bShowNew=!0:"workList"===this.action&&(this.bShowCancel="true")),this.bShowConfirm){const t=this.data.ID.split(" ")[1];return ti(this.casedata.name,t,this.casepyStatusWork,"true"===this.bShowAttachments?this.displayAttachments:null)}return""!==this.caseID||""!==this.assignmentID||this.bShowNew?B`
        ...
        <div class="validation" role="alert" aria-live="assertive">${this.validationMsg}</div>
        <form id="case-data">${Ns()}</form>
      `:"workList"===this.action?ai(this.title,this.cases,this.displayCasesTypes,this.reloadWorkList,"true"===this.bShowCreate?this.createCase:null,this.openCase):null}renderMainLayout=(t,e)=>Li(t,e,"true"===this.bShowCancel?this.actionAreaCancel:null,"true"===this.bShowSave?this.actionAreaSave:null,this);renderReviewLayout=(t,e)=>Pi(t,e,"true"===this.bShowCancel?this.actionAreaCancel:null,this);genPageValidationErrors=t=>(t=>t.errorDetails?B`
    <ul>
  ...
  `})(t,e);displayCasesTypes=()=>(t=>{const e=[],a=Object.entries(t);for(const t of a)e.push(B`
      ...
      `);return B`
    ${e}
  `})(this.casetypes);genLoadingIndicator=()=>Ns();clickHandler=t=>{let e=t.target;"path"===e.tagName&&(e=e.parentNode),"svg"===e.tagName&&(e=e.parentNode);const a=e.getAttribute("data-action-click");e.classList.contains("combobox")&&!e.classList.contains("loaded")&&this.getData(e.getAttribute("data-pageid"),e),Ka(e,"click")?(this.refreshAssignment(e,Ya(e,"click")),t.preventDefault()):"BUTTON"===e.tagName&&(t.preventDefault(),null!==e.getAttribute("data-submit")&&"save"!==e.getAttribute("data-submit")?this.submitForm(t,e.getAttribute("data-submit")):("addRow"===a||"deleteRow"===a)&&this.refreshAssignment(e))};changeHandler=t=>{let e=t.target;if(t.path&&t.path.length>0?e=t.path[0]:t.originalTarget&&(e=t.originalTarget),e.setCustomValidity(""),e.classList.remove("error-field"),Ka(e,"change")||this.isDeclarativeTarget)this.refreshAssignment(e,Ya(e,"change"));else if(this.refreshOnChange){const t=this.getRenderRoot().querySelector("#case-data");ts(t,this.content,this.pageInstructions,this.data.data.caseInfo.content),L(Li(this.data.uiResources.resources.views[this.casedata.content.pyViewName],"Obj","true"===this.bShowCancel?this.actionAreaCancel:null,"true"===this.bShowSave?this.actionAreaSave:null,this),t)}};keyupHandler=t=>{const e=t.target;"TEXTAREA"===e.tagName&&(e.style.cssText="height:auto; padding:0;",e.style.cssText=`height:${e.scrollHeight}px`)};focusHandler=t=>{const e=t.target;e.classList.contains("combobox")&&!e.classList.contains("loaded")?this.getData(e.getAttribute("data-pageid"),e):"INPUT"===e.tagName&&e.classList.contains("location")&&!e.classList.contains("pac-target-input")&&window.google&&window.google.maps&&window.google.maps.places&&new window.google.maps.places.Autocomplete(e)};async firstUpdated(){const t=this.getRenderRoot();t&&(t.addEventListener("click",this.clickHandler),t.addEventListener("focusin",this.focusHandler),t.addEventListener("change",this.changeHandler),t.addEventListener("keyup",this.keyupHandler))}}customElements.define("pega-mashup-v2",class extends Oi{createRenderRoot(){return this.attachShadow({mode:"open"})}getRenderRoot(){return this.shadowRoot}render(){return B`
      ${ii()} ${this.displayContent()}
    `}});customElements.define("pega-mashup-light-v2",class extends Oi{createRenderRoot(){return this}getRenderRoot(){return this}render(){return B`
      ${this.displayContent()}
    `}})}();
