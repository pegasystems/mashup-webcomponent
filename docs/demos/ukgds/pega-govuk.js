...
<path d="M14.353125,6.353125 C13.9703125,6.7359375 13.4914062,6.928125 12.9640625,6.928125 C12.4367188,6.928125 11.9585938,6.73671875 11.575,6.353125 C11.1921875,5.9703125 11,5.49140625 11,4.9640625 C11,4.43671875 11.1914062,3.95859375 11.575,3.575 C11.9578125,3.1921875 12.4367188,3 12.9640625,3 C13.4914063,3 13.9695312,3.19140625 14.353125,3.575 C14.7359375,3.9578125 14.928125,4.43671875 14.928125,4.9640625 C14.928125,5.49140625 14.7367187,5.96953125 14.353125,6.353125 Z M14.353125,13.7289063 C13.9703125,14.1117188 13.4914062,14.3039063 12.9640625,14.3039063 C12.4367188,14.3039063 11.9585938,14.1125 11.575,13.7289063 C11.1921875,13.3460938 11,12.8671875 11,12.3398438 C11,11.8125 11.1914062,11.334375 11.575,10.9507813 C11.9578125,10.5679688 12.4367188,10.3757813 12.9640625,10.3757813 C13.4914063,10.3757813 13.9695312,10.5671875 14.353125,10.9507813 C14.7359375,11.3335938 14.928125,11.8125 14.928125,12.3398438 C14.928125,12.8671875 14.7367187,13.3453125 14.353125,13.7289063 Z M14.353125,21.1039062 C13.9703125,21.4867187 13.4914062,21.6789062 12.9640625,21.6789062 C12.4367188,21.6789062 11.9585938,21.4875 11.575,21.1039062 C11.1921875,20.7210938 11,20.2421875 11,19.7148438 C11,19.1875 11.1914062,18.709375 11.575,18.3257813 C11.9578125,17.9429688 12.4367188,17.7507813 12.9640625,17.7507813 C13.4914063,17.7507813 13.9695312,17.9421875 14.353125,18.3257813 C14.7359375,18.7085937 14.928125,19.1875 14.928125,19.7148438 C14.928125,20.2421875 14.7367187,20.7203125 14.353125,21.1039062 Z"></path>
  ...
  </div>`,C=(t,e)=>e.loading?U`${$(t,e)}${ot()}`:e.editing?"URL"===e.type?U`
    ...
    `))}
      ...
      aria-label=${i18n.t("Delete")}>${rt()}</button>`:U`${$(t,e)}
    <button type='button' data-id="${t}" @click="${l}" class='pzhc pzbutton Simple'
    aria-label=${i18n.t("Delete")}>${rt()}</button>`,_=t=>{if(!a)return ot();const e=[];if(void 0!==t){const a=Object.entries(t);for(const t of a){let a=t[1].extension;void 0===a&&(a=t[1].type),a||(a=""),a.length>5&&(a=a.substring(0,5)),"URL"===t[1].type&&t[1].editing?e.push(U`<div class='flex layout-content-stacked content-items-maxwidth'>
              ${C(t[0],t[1])}
            </div>`):e.push(U`<div class='row-item'>
              <span class='doc-icon'>${ct()}<span>${a}</span></span>
              ${C(t[0],t[1])}
            </div>`)}}return e&&e.length>0?e:U`<div class='empty'>${i18n.t("no attachments found")}</div>`};if(!t){if(e&&e.length>0&&e[0].pyAttachName){n=0,e[0].extension="";const t=e[0].pyAttachName.split(".");return t.length>1&&(e[0].extension=t[t.length-1]),b(e[0])}return U`<div @dragenter="${u}" @dragover="${u}" @dragleave="${u}"
    ...
    </div>`}if(t&&t.classList.contains("attach-files")){if(i&&i.length>0)return s.sendData.call(s,"uploadattachment",{actionid:i[0],target:t}),k=i[0],w=!0,U`<div class='row-item'>
    <span class='doc-icon'>${ct()}<span>${k.extension}</span></span>
    <div class='list-item-title'><span>${k.displayName}</span>${w?U`<span class="list-item-meta"><span>
    ${i18n.t("Uploading...")}</span></span>`:""}</div>
  </div>`;if(e&&e.length>0)return b(e[0])}var k,w;let A="Attachments";return void 0!==i&&i.length>0&&(A="URL"===i[0].type?"Attach a link":"Attach files"),U`
...
/**
  ...
  />
`,Lt=(t,e)=>{let a="";for(const e of t.options)0===t.displayvalue.indexOf(e.pyCallingCode)&&(a=e.pyCallingCode);return t.displayvalue=t.displayvalue.substring(a.length),U`
...
`,Ht=(t,e)=>{const a=t.requiredstate?"icon-required":"";return U`<div class="govuk-checkboxes__item">
  <input
...
`},jt=(t,e)=>{let a=[{value:"true"},{value:"false"}];return t.options&&(a=t.options),U`<div class="govuk-radios">
  ...
  placeholder="${It(Et(t))}"
    ...
    <input
      ...
      value="${a}"
    />
  `},Bt=(t,e)=>{let a=t.displayvalue,s="",i="",n="";if(""!==a){const e=ht(a);e instanceof Date&&e.getTime()==e.getTime()?(n=e.getUTCFullYear(),s=e.getUTCMonth()+1,i=e.getUTCDate()):8===t.displayvalue.length&&(n=t.displayvalue.substring(0,4),s=t.displayvalue.substring(4,6),i=t.displayvalue.substring(6,8)),a=e}return U`
...
</div>`},Ft=(t,e)=>{let a=t.displayvalue;if(""!==a){const e=ht(a);e instanceof Date&&e.getTime()==e.getTime()?a=`${dt(e.getUTCHours())}-${dt(e.getUTCMinutes())}-${dt(e.getUTCSeconds())}`:8===t.displayvalue.length&&(a=`${t.displayvalue.substring(9,10)}:${t.displayvalue.substring(10,11)}:${t.displayvalue.substring(11,12)}`)}return U`
    <input
      class="govuk-input"
      data-ref="${t.reference}"
      ?required="${t.requiredstate}"
...
`,Xt=(t,e)=>{if(!e){const e=[];t.config.children[0].children.map(((t,a)=>(e[a]=t.config.value.replace("@P .",""),null)));const a=t.config.referenceList.replace("@P .","");return U`
    ...
    `}return null},Yt=(t,e,a,s)=>{const i=t.config.referenceList.replace("@P .",""),n=t.config.children[0].children,o=vt(a.data.data.caseInfo.content,i);return o?U`
  ${o.map(((t,o)=>U`
    <tr class="govuk-table__row">
    ${n.map(((t,n)=>U`
    <td class="govuk-table__cell">${Tt(t,e?void 0:`${s}-${o}-${n}`,e,a,`${i}(${o+1})`)}</td>`))}${e?null:U`<td class="govuk-table__cell"><button type="button" class="govuk-button govuk-button--secondary" data-module="govuk-button"
  aria-label="${i18n.t("Delete item")}" data-ref=${`${i}(${o+1}).pyTemplate`}
  data-action-click='deleteRow'>Delete</button></td>`}
    </tr>`))}
`:null},Qt=(t,e,a,s,i)=>{if(void 0===t)return null;if(Array.isArray(t)&&1===t.length&&"View"===t[0].type&&(t=t[0]),!t.config||!t.config.template)return U`${t.map(((t,n)=>{const o=`${e}-${n}`;if("Region"===t.type)return Qt(t.children,`${e}-0`,!0,s,i);if("reference"===t.type&&"view"===t.config.type){let e="";if(t.config.context&&(e=t.config.context),t.config.inheritedProps&&1===t.config.inheritedProps.length&&"label"===t.config.inheritedProps[0].prop){const n=i18n.t(t.config.inheritedProps[0].value);let r=s.data.uiResources.resources.views[t.config.name];if(r){Array.isArray(r)&&1===r.length&&"View"===r[0].type&&(r=r[0]);const t="SimpleTable"===r.config.template||"ListView"===r.config.template?"field-table":"field-subview";return U`<div class='${t}'><h3 class='govuk-heading-s'>${n}</h3>${Qt(r,o,a,s,""===i?e.substring(1):i+e)}</div>`}}return Qt(s.data.uiResources.resources.views[t.config.name],o,a,s,i&&""!==i?i+e:e.substring(1))}return Tt(t,o,a,s,i)}))}`;if("SimpleTable"===t.config.template)return((t,e,a,s)=>{const i=e||"Editable"!==t.config.renderMode;return U`
  ...
  ${Xt(t,i)}`})(t,a,s,`${e}-table`);if("ListView"===t.config.template)return((t,e,a)=>(a.sendData("dataviews",{id:t.config.referenceList,content:{paging:{pageNumber:1,pageSize:41}}}),U`
  <table class='govuk-table'>
    <caption class="sr-only govuk-table__caption govuk-table__caption--m">${t.config.name}</caption>
    <thead class="govuk-table__head">
      <tr class="govuk-table__row">
    ...
    <tbody>${Jt()}
        ...
        `;case"DefaultForm":case"OneColumn":return U`
          <div>
        ...
        `;default:return null}},te=(t,e,a,s)=>void 0===e.caseID&&a.content?U`
    <div>
  ...
  </table> `:null)(a.assignments,s)}`:""===t||void 0===e.caseID?"":U`
  <div>
    <h2 class='govuk-heading-m'>${i18n.t(t)}</h2>
  </div>`,ee=(t,e,a,s,i)=>U`
  <div>${Qt(t,e,!1,i,"")}</div>
...
`;class se extends Dt{displayContent(){if(this.bShowSave="false",""!==this.errorMsg)return t=this.errorMsg,"true"===this.bShowCancel&&this.resetError,U`
...
<h2 class="govuk-error-summary__title" id="error-summary-title">${t}</h2>
  ...
  <div id="case-data"></div>`}return""!==this.caseID||""!==this.assignmentID||this.bShowNew?U`
        ${te(this.name,this.data,this.casedata,this.openCase)}
        <div class="validation" role="alert" aria-live="assertive">${this.validationMsg}</div>
        <form id="case-data" novalidate></form>
      `:"workList"===this.action?(a=this.cases,s=this.openCase,U`
<section>
