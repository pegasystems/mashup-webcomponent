...
<path d="M14.353125,6.353125 C13.9703125,6.7359375 13.4914062,6.928125 12.9640625,6.928125 C12.4367188,6.928125 11.9585938,6.73671875 11.575,6.353125 C11.1921875,5.9703125 11,5.49140625 11,4.9640625 C11,4.43671875 11.1914062,3.95859375 11.575,3.575 C11.9578125,3.1921875 12.4367188,3 12.9640625,3 C13.4914063,3 13.9695312,3.19140625 14.353125,3.575 C14.7359375,3.9578125 14.928125,4.43671875 14.928125,4.9640625 C14.928125,5.49140625 14.7367187,5.96953125 14.353125,6.353125 Z M14.353125,13.7289063 C13.9703125,14.1117188 13.4914062,14.3039063 12.9640625,14.3039063 C12.4367188,14.3039063 11.9585938,14.1125 11.575,13.7289063 C11.1921875,13.3460938 11,12.8671875 11,12.3398438 C11,11.8125 11.1914062,11.334375 11.575,10.9507813 C11.9578125,10.5679688 12.4367188,10.3757813 12.9640625,10.3757813 C13.4914063,10.3757813 13.9695312,10.5671875 14.353125,10.9507813 C14.7359375,11.3335938 14.928125,11.8125 14.928125,12.3398438 C14.928125,12.8671875 14.7367187,13.3453125 14.353125,13.7289063 Z M14.353125,21.1039062 C13.9703125,21.4867187 13.4914062,21.6789062 12.9640625,21.6789062 C12.4367188,21.6789062 11.9585938,21.4875 11.575,21.1039062 C11.1921875,20.7210938 11,20.2421875 11,19.7148438 C11,19.1875 11.1914062,18.709375 11.575,18.3257813 C11.9578125,17.9429688 12.4367188,17.7507813 12.9640625,17.7507813 C13.4914063,17.7507813 13.9695312,17.9421875 14.353125,18.3257813 C14.7359375,18.7085937 14.928125,19.1875 14.928125,19.7148438 C14.928125,20.2421875 14.7367187,20.7203125 14.353125,21.1039062 Z"></path>
    ...
    ${s.attachmentcategories.map((t=>P`
    ...
    aria-label=${i18n.t("Delete")}>${rt()}</button>`,_=t=>{if(!a)return ot();const e=[];if(void 0!==t){const a=Object.entries(t);for(const t of a){let a=t[1].extension;void 0===a&&(a=t[1].type),a||(a=""),a.length>5&&(a=a.substring(0,5)),"URL"===t[1].type&&t[1].editing?e.push(P`<div class='flex layout-content-stacked content-items-maxwidth'>
              ${C(t[0],t[1])}
            </div>`):e.push(P`<div class='row-item'>
              <span class='doc-icon'>${ct()}<span>${a}</span></span>
              ${C(t[0],t[1])}
            </div>`)}}return e&&e.length>0?e:P`<div class='empty'>${i18n.t("no attachments found")}</div>`};if(!t){if(e&&e.length>0&&e[0].pyAttachName){n=0,e[0].extension="";const t=e[0].pyAttachName.split(".");return t.length>1&&(e[0].extension=t[t.length-1]),b(e[0])}return P`<div @dragenter="${u}" @dragover="${u}" @dragleave="${u}"
    ...
    </div>`}if(t&&t.classList.contains("attach-files")){if(i&&i.length>0)return s.sendData.call(s,"uploadattachment",{actionid:i[0],target:t}),k=i[0],w=!0,P`<div class='row-item'>
    <span class='doc-icon'>${ct()}<span>${k.extension}</span></span>
    <div class='list-item-title'><span>${k.displayName}</span>${w?P`<span class="list-item-meta"><span>
    ${i18n.t("Uploading...")}</span></span>`:""}</div>
  </div>`;if(e&&e.length>0)return b(e[0])}var k,w;let A="Attachments";return void 0!==i&&i.length>0&&(A="URL"===i[0].type?"Attach a link":"Attach files"),P`
    <div class="flex layout-content-inline_middle main-header">
      <h2>${i18n.t(A)}</h2>
      <div class="flex layout-content-inline_middle margin-l-auto">
        <button type='button' data-action-id='close'
        class="pzhc pzbutton Simple" aria-label="${i18n.t("Close modal")}">${P`
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" width="20px" height="20px" fill="currentColor">
...
/**
  ...
  />
`,Lt=(t,e)=>{let a="";for(const e of t.options)0===t.displayvalue.indexOf(e.pyCallingCode)&&(a=e.pyCallingCode);return t.displayvalue=t.displayvalue.substring(a.length),P`
...
`,Ht=(t,e)=>{const a=t.requiredstate?"icon-required":"";return P`<div class="govuk-checkboxes__item">
  <input
...
`},jt=(t,e)=>{let a=[{value:"true"},{value:"false"}];return t.options&&(a=t.options),P`<div class="govuk-radios">
    ${a.map(((a,s)=>{const i=`rb-${e}-${s}`;return P`
  ...
  placeholder="${It(Et(t))}"
    ...
    <input
      ...
      value="${a}"
    />
  `},Bt=(t,e)=>{let a=t.displayvalue,s="",i="",n="";if(""!==a){const e=ht(a);e instanceof Date&&e.getTime()==e.getTime()?(n=e.getUTCFullYear(),s=e.getUTCMonth()+1,i=e.getUTCDate()):8===t.displayvalue.length&&(n=t.displayvalue.substring(0,4),s=t.displayvalue.substring(4,6),i=t.displayvalue.substring(6,8)),a=e}return P`
...
</div>`},Wt=(t,e)=>{let a=t.displayvalue;if(""!==a){const e=ht(a);e instanceof Date&&e.getTime()==e.getTime()?a=`${dt(e.getUTCHours())}-${dt(e.getUTCMinutes())}-${dt(e.getUTCSeconds())}`:8===t.displayvalue.length&&(a=`${t.displayvalue.substring(9,10)}:${t.displayvalue.substring(10,11)}:${t.displayvalue.substring(11,12)}`)}return P`
    <input
      class="govuk-input"
      data-ref="${t.reference}"
      ?required="${t.requiredstate}"
...
`,Gt=(t,e)=>P`
  ${t.map((t=>P`
    <th scope='col' class="govuk-table__header">${i18n.t(t.config.label)}</th>`))}${e?null:P`<th></th>`}
`,Xt=(t,e)=>{if(!e){const e=[];t.config.children[0].children.map(((t,a)=>(e[a]=t.config.value.replace("@P .",""),null)));const a=t.config.referenceList.replace("@P .","");return P`
    ...
    `}return null},Yt=(t,e,a,s)=>{const i=t.config.referenceList.replace("@P .",""),n=t.config.children[0].children,o=vt(a.data.data.caseInfo.content,i);return o?P`
  ${o.map(((t,o)=>P`
    <tr class="govuk-table__row">
    ${n.map(((t,n)=>P`
    <td class="govuk-table__cell">${Tt(t,e?void 0:`${s}-${o}-${n}`,e,a,`${i}(${o+1})`)}</td>`))}${e?null:P`<td class="govuk-table__cell"><button type="button" class="govuk-button govuk-button--secondary" data-module="govuk-button"
  aria-label="${i18n.t("Delete item")}" data-ref=${`${i}(${o+1}).pyTemplate`}
  data-action-click='deleteRow'>Delete</button></td>`}
    </tr>`))}
`:null},Qt=(t,e,a,s,i)=>{if(void 0===t)return null;if(Array.isArray(t)&&1===t.length&&"View"===t[0].type&&(t=t[0]),!t.config||!t.config.template)return P`${t.map(((t,n)=>{const o=`${e}-${n}`;if("Region"===t.type)return Qt(t.children,`${e}-0`,!0,s,i);if("reference"===t.type&&"view"===t.config.type){let e="";if(t.config.context&&(e=t.config.context),t.config.inheritedProps&&1===t.config.inheritedProps.length&&"label"===t.config.inheritedProps[0].prop){const n=i18n.t(t.config.inheritedProps[0].value);let r=s.data.uiResources.resources.views[t.config.name];if(r){Array.isArray(r)&&1===r.length&&"View"===r[0].type&&(r=r[0]);const t="SimpleTable"===r.config.template||"ListView"===r.config.template?"field-table":"field-subview";return P`<div class='${t}'><h3 class='govuk-heading-s'>${n}</h3>${Qt(r,o,a,s,""===i?e.substring(1):i+e)}</div>`}}return Qt(s.data.uiResources.resources.views[t.config.name],o,a,s,i&&""!==i?i+e:e.substring(1))}return Tt(t,o,a,s,i)}))}`;if("SimpleTable"===t.config.template)return((t,e,a,s)=>{const i=e||"Editable"!==t.config.renderMode;return P`
  ...
  ${Xt(t,i)}`})(t,a,s,`${e}-table`);if("ListView"===t.config.template)return((t,e,a)=>(a.sendData("dataviews",{id:t.config.referenceList,content:{paging:{pageNumber:1,pageSize:41}}}),P`
  <table class='govuk-table'>
    <caption class="sr-only govuk-table__caption govuk-table__caption--m">${t.config.name}</caption>
    <thead class="govuk-table__head">
      <tr class="govuk-table__row">
    ...
    <tbody>${Jt()}
  ...
  </table>`))(t,a,s);switch("DataReference"===t.config.template&&(s.isDeclarativeTarget=!0),"TwoColumn"===t.config.template&&1===t.children.length&&(t.config.template="OneColumn"),t.config.template){case"TwoColumn":return P`
          <div>
            <div>${Qt(t.children[0].children,`${e}-0`,a,s,i)}</div>
            <div>${Qt(t.children[1].children,`${e}-1`,a,s,i)}</div>
          </div>
        `;case"DefaultForm":case"OneColumn":return P`
          <div>
        ...
        `;default:return null}},te=(t,e,a,s)=>void 0===e.caseID&&a.content?P`
    <div>
  ...
  </table> `:null)(a.assignments,s)}`:""===t||void 0===e.caseID?"":P`
  <div>
    <h2 class='govuk-heading-m'>${i18n.t(t)}</h2>
  </div>`,ee=(t,e,a,s,i)=>P`
  <div>${Qt(t,e,!1,i,"")}</div>
  ${((t,e)=>P`
  <div class="action-button-area">
    ${null!==t?P`<button type="button" class="govuk-button govuk-button--secondary"
    data-module="govuk-button" @click="${t}">${i18n.t("Cancel")}</button>`:""}
    ${null!==e?P`<button type="button" class="govuk-button govuk-button--secondary"
...
<h2 class="govuk-error-summary__title" id="error-summary-title">${t}</h2>
  ...
  <div id="case-data"></div>`}return""!==this.caseID||""!==this.assignmentID||this.bShowNew?P`
      ...
      `:"workList"===this.action?(a=this.cases,s=this.openCase,P`
<section>
