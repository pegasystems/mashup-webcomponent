...
`},Nt=(t,e)=>{let a=[{value:"true"},{value:"false"}];return t.options&&(a=t.options),k`<fieldset class="usa-fieldset">
  ...
  placeholder="${vt(wt(t))}"
    ...
    <input
      ...
      value="${a}"
    />
  `},Ot=(t,e)=>{let a=t.displayvalue,s="",i="",n="";if(""!==a){const e=nt(a);e instanceof Date&&e.getTime()==e.getTime()?(n=e.getUTCFullYear(),s=e.getUTCMonth()+1,i=e.getUTCDate()):8===t.displayvalue.length&&(n=t.displayvalue.substring(0,4),s=t.displayvalue.substring(4,6),i=t.displayvalue.substring(6,8)),a=e}return k`
...
</div>`},Mt=(t,e)=>{let a=t.displayvalue;if(""!==a){const e=nt(a);e instanceof Date&&e.getTime()==e.getTime()?a=`${st(e.getUTCHours())}-${st(e.getUTCMinutes())}-${st(e.getUTCSeconds())}`:8===t.displayvalue.length&&(a=`${t.displayvalue.substring(9,10)}:${t.displayvalue.substring(10,11)}:${t.displayvalue.substring(11,12)}`)}return k`
    <input
      data-ref="${t.reference}"
      ?required="${t.requiredstate}"
      ?readonly="${t.readonlystate}"
