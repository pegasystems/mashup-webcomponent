...
<path d="M14.353125,6.353125 C13.9703125,6.7359375 13.4914062,6.928125 12.9640625,6.928125 C12.4367188,6.928125 11.9585938,6.73671875 11.575,6.353125 C11.1921875,5.9703125 11,5.49140625 11,4.9640625 C11,4.43671875 11.1914062,3.95859375 11.575,3.575 C11.9578125,3.1921875 12.4367188,3 12.9640625,3 C13.4914063,3 13.9695312,3.19140625 14.353125,3.575 C14.7359375,3.9578125 14.928125,4.43671875 14.928125,4.9640625 C14.928125,5.49140625 14.7367187,5.96953125 14.353125,6.353125 Z M14.353125,13.7289063 C13.9703125,14.1117188 13.4914062,14.3039063 12.9640625,14.3039063 C12.4367188,14.3039063 11.9585938,14.1125 11.575,13.7289063 C11.1921875,13.3460938 11,12.8671875 11,12.3398438 C11,11.8125 11.1914062,11.334375 11.575,10.9507813 C11.9578125,10.5679688 12.4367188,10.3757813 12.9640625,10.3757813 C13.4914063,10.3757813 13.9695312,10.5671875 14.353125,10.9507813 C14.7359375,11.3335938 14.928125,11.8125 14.928125,12.3398438 C14.928125,12.8671875 14.7367187,13.3453125 14.353125,13.7289063 Z M14.353125,21.1039062 C13.9703125,21.4867187 13.4914062,21.6789062 12.9640625,21.6789062 C12.4367188,21.6789062 11.9585938,21.4875 11.575,21.1039062 C11.1921875,20.7210938 11,20.2421875 11,19.7148438 C11,19.1875 11.1914062,18.709375 11.575,18.3257813 C11.9578125,17.9429688 12.4367188,17.7507813 12.9640625,17.7507813 C13.4914063,17.7507813 13.9695312,17.9421875 14.353125,18.3257813 C14.7359375,18.7085937 14.928125,19.1875 14.928125,19.7148438 C14.928125,20.2421875 14.7367187,20.7203125 14.353125,21.1039062 Z"></path>
  ...
  </div>`,C=(t,e)=>e.loading?k`${m(t,e)}${Q()}`:e.editing?"URL"===e.type?k`
    ...
    ${s.attachmentcategories.map((t=>k`
    ...
    `))}
      ...
      aria-label=${i18n.t("Delete")}>${tt()}</button>`:k`${m(t,e)}
    <button type='button' data-id="${t}" @click="${l}" class='pzhc pzbutton Simple'
    aria-label=${i18n.t("Delete")}>${tt()}</button>`,w=t=>{if(!a)return Q();const e=[];if(void 0!==t){const a=Object.entries(t);for(const t of a){let a=t[1].extension;void 0===a&&(a=t[1].type),a||(a=""),a.length>5&&(a=a.substring(0,5)),"URL"===t[1].type&&t[1].editing?e.push(k`<div class='flex layout-content-stacked content-items-maxwidth'>
              ${C(t[0],t[1])}
            </div>`):e.push(k`<div class='row-item'>
              <span class='doc-icon'>${at()}<span>${a}</span></span>
              ${C(t[0],t[1])}
            </div>`)}}return e&&e.length>0?e:k`<div class='empty'>${i18n.t("no attachments found")}</div>`};if(!t){if(e&&e.length>0&&e[0].pyAttachName){n=0,e[0].extension="";const t=e[0].pyAttachName.split(".");return t.length>1&&(e[0].extension=t[t.length-1]),v(e[0])}return k`<div @dragenter="${u}" @dragover="${u}" @dragleave="${u}"
    ...
    </div>`}if(t&&t.classList.contains("attach-files")){if(i&&i.length>0)return s.sendData.call(s,"uploadattachment",{actionid:i[0],target:t}),_=i[0],A=!0,k`<div class='row-item'>
    <span class='doc-icon'>${at()}<span>${_.extension}</span></span>
    <div class='list-item-title'><span>${_.displayName}</span>${A?k`<span class="list-item-meta"><span>
    ${i18n.t("Uploading...")}</span></span>`:""}</div>
  </div>`;if(e&&e.length>0)return v(e[0])}var _,A;let D="Attachments";return void 0!==i&&i.length>0&&(D="URL"===i[0].type?"Attach a link":"Attach files"),k`
    <div class="flex layout-content-inline_middle main-header">
      <h2>${i18n.t(D)}</h2>
      <div class="flex layout-content-inline_middle margin-l-auto">
        <button type='button' data-action-id='close'
        class="pzhc pzbutton Simple" aria-label="${i18n.t("Close modal")}">${k`
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" width="20px" height="20px" fill="currentColor">
...
/**
  ...
  />
`,xt=(t,e)=>{let a="";for(const e of t.options)0===t.displayvalue.indexOf(e.pyCallingCode)&&(a=e.pyCallingCode);return t.displayvalue=t.displayvalue.substring(a.length),k`
...
<select
  ...
  ${t.options.map((t=>k`<option ?selected=${t.pyCallingCode===a}
...
`,Lt=(t,e)=>{const a=t.requiredstate?" icon-required":"";return k`<input
...
`},Nt=(t,e)=>{let a=[{value:"true"},{value:"false"}];return t.options&&(a=t.options),k`<fieldset class="usa-fieldset">
    ${a.map(((a,s)=>{const i=`rb-${e}-${s}`;return k`
        <div class="usa-radio">
          <input
...
</div>`},Mt=(t,e)=>{let a=t.displayvalue;if(""!==a){let e=nt(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${st(e.getHours())}-${st(e.getMinutes())}-${st(e.getSeconds())}`):8===t.displayvalue.length&&(a=`${t.displayvalue.substring(9,10)}:${t.displayvalue.substring(10,11)}:${t.displayvalue.substring(11,12)}`)}return k`
    <input
      data-ref="${t.reference}"
      ?required="${t.requiredstate}"
      ?readonly="${t.readonlystate}"
...
`,Vt=(t,e)=>k`
  ${t.map((t=>k`
    <th scope='col'>${i18n.t(t.config.label)}</th>`))}${e?null:k`<th></th>`}
`,Bt=(t,e)=>{if(!e){const e=[];t.config.children[0].children.map(((t,a)=>(e[a]=t.config.value.replace("@P .",""),null)));const a=t.config.referenceList.replace("@P .","");return k`
    ...
    `}return null},Ft=(t,e,a)=>{const s=t.config.referenceList.replace("@P .",""),i=t.config.children[0].children,n=ct(a.data.data.caseInfo.content,s);return n?k`
  ${n.map(((t,n)=>k`
    <tr>
    ${i.map((t=>k`
    <td>${At(t,void 0,e,a,`${s}(${n+1})`)}</td>`))}${e?null:k`<td><button type="button" class="usa-button"
  aria-label="${i18n.t("Delete item")}" data-ref=${`${s}(${n+1}).pyTemplate`}
  data-action-click='deleteRow'>Delete</button></td>`}
    </tr>`))}
`:null},Wt=(t,e,a,s,i)=>{if(void 0===t)return null;if(Array.isArray(t)&&1===t.length&&"View"===t[0].type&&(t=t[0]),!t.config||!t.config.template)return k`${t.map(((t,n)=>{const r=`${e}-${n}`;if("Region"===t.type)return Wt(t.children,`${e}-0`,!0,s,i);if("reference"===t.type&&"view"===t.config.type){let e="";if(t.config.context&&(e=t.config.context),t.config.inheritedProps&&1===t.config.inheritedProps.length&&"label"===t.config.inheritedProps[0].prop){const n=i18n.t(t.config.inheritedProps[0].value);let o=s.data.uiResources.resources.views[t.config.name];if(o){Array.isArray(o)&&1===o.length&&"View"===o[0].type&&(o=o[0]);const t="SimpleTable"===o.config.template||"ListView"===o.config.template?"field-table":"field-subview";return k`<div class='${t}'><h4>${n}</h4>${Wt(o,r,a,s,""===i?e.substring(1):i+e)}</div>`}}return Wt(s.data.uiResources.resources.views[t.config.name],r,a,s,i&&""!==i?i+e:e.substring(1))}return At(t,r,a,s,i)}))}`;if("SimpleTable"===t.config.template)return((t,e,a)=>{const s=e||"Editable"!==t.config.renderMode;return k`
  ...
  ${Bt(t,s)}`})(t,a,s);if("ListView"===t.config.template)return((t,e,a)=>(a.sendData("dataviews",{id:t.config.referenceList,content:{paging:{pageNumber:1,pageSize:41}}}),k`
  <table class="usa-table usa-table--borderless">
    <caption class="sr-only">${t.config.name}</caption>
    <thead>
      <tr>
    ...
    <tbody>${jt()}
  ...
  </table>`))(t,a,s);switch("DataReference"===t.config.template&&(s.isDeclarativeTarget=!0),"TwoColumn"===t.config.template&&1===t.children.length&&(t.config.template="OneColumn"),t.config.template){case"TwoColumn":return k`
        ...
        `;case"DefaultForm":case"OneColumn":return k`
          <div>
            ${Wt(t.children[0].children,`${e}-0`,a,s,i)}
          </div>
        `;case"DataReference":return k`
          <div>
            ${Wt(t.children,`${e}-0`,a,s,i)}
          </div>
        `;case"Details":return k`
          <div>
            ${Wt(t.children[0].children,`${e}-0`,!0,s,i)}
          </div>
        `;default:return null}},Zt=(t,e,a,s)=>{return void 0===e.caseID&&a.content?k`
    <div>
      <h2>${i18n.t(e.data.caseInfo.name)}</h2>
    </div>
    ${((t,e)=>t&&0!==t.length?k`<p>You have a pending request - click 'continue' to re-open the request</p>
  <button type='button' @click="${e}" class="usa-button" data-type="assignment" data-id="${t[0].ID}">${i18n.t("Continue")}</button>`:null)(a.assignments,s)}`:e.uiResources&&e.uiResources.navigation&&e.uiResources.navigation.steps?(i=e.uiResources.navigation.steps)&&i.length>1?k`<div class="usa-step-indicator" aria-label="progress">
    <ol class="usa-step-indicator__segments">
    ${i.map((t=>{let e,a="";return"success"===t.visited_status?a="usa-step-indicator__segment--complete":"current"===t.visited_status&&(a="usa-step-indicator__segment--current",e="current"),k`<li
    ...
    </ol></div>`:null:"";var i},Kt=(t,e,a,s,i)=>{let n=i.data.name;return i.data&&i.data.data&&(n&&""!==n||(n=i.data.data.caseInfo.name),""!==i.data.data.caseInfo.assignments[0].instructions&&(n=i.data.data.caseInfo.assignments[0].instructions)),k`
  <fieldset class='usa-fieldset'><legend class="usa-legend usa-legend--large">${i18n.t(n)}</legend>
  ${Wt(t,e,!1,i,"")}</fieldset>
  ${((t,e)=>k`
<ul class="usa-button-group">
    ${null!==t?k`<li class="usa-button-group__item">
    <button type="button" class="usa-button" @click="${t}">${i18n.t("Cancel")}</button></li>`:""}
    ${null!==e?k`<li class="usa-button-group__item">
...
`},Jt=(t,e,a,s)=>k`
  ...
  ${(t=>null===t?null:k`
  <ul class="usa-button-group">
  ${null!==t?k`<li class="usa-button-group__item"><button type="button" class="usa-button"
  @click="${t}">${i18n.t("Close")}</button></li>`:""}
  </ul>`)(a)}
`;class Gt extends bt{displayContent(){if(this.bShowSave="false",""!==this.errorMsg)return t=this.errorMsg,e="true"===this.bShowCancel?this.resetError:null,k`
