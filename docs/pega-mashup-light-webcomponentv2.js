...
/**
     ...
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */const Lt=(t,e)=>{var a,i;const s=t._$AN;if(void 0===s)return!1;for(const t of s)null===(i=(a=t)._$AO)||void 0===i||i.call(a,e,!1),Lt(t,e);return!0},Nt=t=>{let e,a;do{if(void 0===(e=t._$AM))break;a=e._$AN,a.delete(t),t=e}while(0===(null==a?void 0:a.size))},zt=t=>{for(let e;e=t._$AM;t=e){let a=e._$AN;if(void 0===a)e._$AN=a=new Set;else if(a.has(t))break;a.add(t),Ut(e)}};function Mt(t){void 0!==this._$AN?(Nt(this),this._$AM=t,zt(this)):this._$AM=t}function Pt(t,e=!1,a=0){const i=this._$AH,s=this._$AN;if(void 0!==s&&0!==s.size)if(e)if(Array.isArray(i))for(let t=a;t<i.length;t++)Lt(i[t],!1),Nt(i[t]);else null!=i&&(Lt(i,!1),Nt(i));else Lt(this,t)}const Ut=t=>{var e,a,i,s;t.type==Tt&&(null!==(e=(i=t)._$AP)&&void 0!==e||(i._$AP=Pt),null!==(a=(s=t)._$AQ)&&void 0!==a||(s._$AQ=Mt))};let Ot=class extends Rt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,a){super._$AT(t,e,a),zt(this),this.isConnected=t._$AU}_$AO(t,e=!0){var a,i;t!==this.isConnected&&(this.isConnected=t,t?null===(a=this.reconnected)||void 0===a||a.call(this):null===(i=this.disconnected)||void 0===i||i.call(this)),e&&(Lt(this,t),Nt(this))}setValue(t){if((t=>void 0===t.strings)(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}};
/**
     * @license
...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */const Zt=t=>null!=t?t:O,Kt=t=>`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="20px" height="20px" fill="currentColor">${t}</svg>`;class Gt extends st{static get properties(){return{content:{},root:{}}}createRenderRoot(){return this}constructor(t,e,a){super(),this.content=t,this.root="";const i=(new DOMParser).parseFromString(this.content,"text/html");document.execCommand("defaultParagraphSeparator",!1,"br");const s=document.createElement("div"),n=i.querySelector("body");s.setAttribute("contenteditable","true"),s.setAttribute("data-ref",e),s.setAttribute("id",a),s.innerHTML=n.innerHTML,this.root=s}render(){return P`<div class='rich-text-main'>
    ...
    ${e.values.map((t=>P` <option value=${t.value}>${t.name}</option>`))}
        ...
        `))}
    `}}customElements.define("rich-text-editor",Gt);const Jt=(t,e)=>{if(t.helperText&&""!==t.helperText)return`${e}-info`},Yt=t=>{if(t.placeholder&&""!==t.placeholder)return t.displayplaceholder},Qt=(t,e,a,i)=>void 0===e||""===e?P`
      ${i}
    `:P`
...
`,le=(t,e)=>new Gt(gt(t.displayvalue),t.reference,e),ce=(t,e)=>{const a=t.requiredstate?"icon-required":"";return P`
  <input
  data-ref="${t.reference}"
  ?required="${t.requiredstate}"
  ?readonly="${t.readonlystate}"
