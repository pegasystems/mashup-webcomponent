...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
const Dt=(t,e)=>{var a,i;const s=t._$AN;if(void 0===s)return!1;for(const t of s)null===(i=(a=t)._$AO)||void 0===i||i.call(a,e,!1),Dt(t,e);return!0},xt=t=>{let e,a;do{if(void 0===(e=t._$AM))break;a=e._$AN,a.delete(t),t=e}while(0===(null==a?void 0:a.size))},It=t=>{for(let e;e=t._$AM;t=e){let a=e._$AN;if(void 0===a)e._$AN=a=new Set;else if(a.has(t))break;a.add(t),Et(e)}};
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */function St(t){void 0!==this._$AN?(xt(this),this._$AM=t,It(this)):this._$AM=t}function kt(t,e=!1,a=0){const i=this._$AH,s=this._$AN;if(void 0!==s&&0!==s.size)if(e)if(Array.isArray(i))for(let t=a;t<i.length;t++)Dt(i[t],!1),xt(i[t]);else null!=i&&(Dt(i,!1),xt(i));else Dt(this,t)}const Et=t=>{var e,a,i,s;t.type==_t&&(null!==(e=(i=t)._$AP)&&void 0!==e||(i._$AP=kt),null!==(a=(s=t)._$AQ)&&void 0!==a||(s._$AQ=St))};
/**
     * @license
...
`,Gt=(t,e)=>new Ot(rt(t.displayvalue),t.reference,e),Qt=(t,e)=>{const a=t.requiredstate?"icon-required":"";return T`
  ...
  ?required="${t.requiredstate}"
  ?readonly="${t.readonlystate}"
  onclick="${Mt(t.readonlystate?"return false;":void 0)}"
  ?disabled="${t.disabledstate}"
  aria-describedby="${Mt(Ht(t,e))}"
  id=${Mt(e)}
  type="checkbox" ?checked=${"true"===t.displayvalue||!0===t.displayvalue}
  />
  <label class=${a} for=${Mt(e)}>
  ${t.displaycaption}
    </label>
...
`;class me extends Ut{displayContent(){if(this.bShowSave="false",""!==this.errorMsg){if(-1===this.errorMsg.indexOf("The provided authorization code is expired"))return t=this.errorMsg,e="true"===this.bShowCancel?this.resetError:null,T`
  <div class="error">${t}
  ${null!=e?T`
