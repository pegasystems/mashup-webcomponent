...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.0");const M=(t,...e)=>new C(t,e,"html",L)
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
(window.litElementVersions||(window.litElementVersions=[])).push("2.5.0");const et={};class at extends Y{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,a)=>t.reduceRight(((t,a)=>Array.isArray(a)?e(a,t):(t.add(a),t)),a),a=e(t,new Set),i=[];a.forEach((t=>i.unshift(t))),this._styles=i}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map((t=>{if(t instanceof CSSStyleSheet&&!K){const e=Array.prototype.slice.call(t.cssRules).reduce(((t,e)=>t+e.cssText),"");return new tt(String(e),Q)}return t}))}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow(this.constructor.shadowRootOptions)}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?K?this.renderRoot.adoptedStyleSheets=t.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map((t=>t.cssText)),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==et&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach((t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)})))}render(){return et}}at.finalized=!0,at.render=(t,a,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const s=i.scopeName,n=z.has(a),r=q&&11===a.nodeType&&!!a.host,o=r&&!j.has(s),l=o?document.createDocumentFragment():a;if(O(t,l,Object.assign({templateFactory:V(s)},i)),o){const t=z.get(l);z.delete(l);const i=t.value instanceof y?t.value.template:void 0;B(s,l,i),e(a,a.firstChild),a.appendChild(l),z.set(a,t)}!n&&r&&window.ShadyCSS.styleElement(a.host)},at.shadowRootOptions={mode:"open"};
/**
     * @license
...
</svg>`,kt=(t,e,a)=>{if(void 0===t||void 0===t.control||void 0===t.control.type)return null;if(t.customAttributes&&"none"===t.customAttributes.display)return null;if(!0===a||!0===t.readOnly||"pxHidden"===t.control.type)return Ct(t,e,"field-text",_t(t,e));switch(t.control.type){case"pxPhone":case"pxTextInput":return Ct(t,e,"field-textinput",Dt(t,e));case"pxInteger":case"pxNumber":return Ct(t,e,"field-numberinput",It(t,e));case"pxCurrency":return Ct(t,e,"field-currencyinput",Tt(t,e));case"pxEmail":return Ct(t,e,"field-emailinput",Et(t,e));case"pxTextArea":return Ct(t,e,"field-textarea",Nt(t,e));case"pxRadioButtons":return Ct(t,e,"field-radiogroup",qt(t,e));case"pxCheckbox":return Ct(t,e,"field-checkbox",Vt(t,e));case"pxDropdown":return Ct(t,e,"field-dropdown",Ft(t,e));case"pxDisplayText":return Ct(t,e,"field-text",_t(t,e));case"pxIcon":return Ct(t,e,"field-icon",Pt(t,e));case"pxLink":case"pxURL":return Ct(t,e,"field-url",Rt(t,e));case"pxIconDeleteItem":return Ct(t,e,"field-button",Ot(t,e));case"pxButton":return Ct(t,e,"field-button",zt(t,e));case"pxDateTime":return"TimeOfDay"===t.type?Ct(t,e,"field-time",Ut(t,e)):"Date"===t.type?Ct(t,e,"field-date",Mt(t,e)):Ct(t,e,"field-datetime",Lt(t,e));case"pxAutoComplete":return Ct(t,e,"field-combobox",jt(t,e));case"pxSlider":return Ct(t,e,"field-slider",At(t,e));default:return null}},_t=(t,e)=>{if("pxDate"===t.control.type){let a=ot(t.value);if(a)if(t.control&&2===t.control.modes.length){let e={};switch(t.control.modes[1].dateFormat){case"DateTime-Short-YYYY":case"Date-DayMonthYear-Custom":case"Date-Mediun":e={year:"numeric",month:"short",day:"numeric"};break;case"Date-Short":e={year:"numeric",month:"numeric",day:"numeric"};break;case"Date-Long":e={year:"numeric",month:"long",day:"numeric"};break;case"Date-Full":e={weekday:"long",year:"numeric",month:"long",day:"numeric"};break;default:e={}}a=new Intl.DateTimeFormat([],e).format(a)}else a=(new Intl.DateTimeFormat).format(a);else a=t.value;return M`
...
`,zt=(t,e)=>{const a=yt(t,"click");return"deleteRow"===a?Ot(t,e):M`
  <button
  type='button' 
  ...
  >${St()}</button>
`,Lt=(t,e)=>{let a=t.value;if(""!==a){let e=ot(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${e.getFullYear()}-${rt(e.getMonth()+1)}-${rt(e.getDate())}T${rt(e.getHours())}:${rt(e.getMinutes())}`):8===t.value.length&&(a=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}T00:00`)}return M`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="datetime-local"
    ...
    data-action-click="${st(yt(t,"click"))}"
    />
  `},Mt=(t,e)=>{let a=t.value;if(""!==a){let e=ot(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${e.getFullYear()}-${rt(e.getMonth()+1)}-${rt(e.getDate())}`):8===t.value.length&&(a=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}`)}return M`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="date"
    ...
    data-action-click="${st(yt(t,"click"))}"
    />
  `},Ut=(t,e)=>{let a=t.value;if(""!==a){let e=ot(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${rt(e.getHours())}-${rt(e.getMinutes())}-${rt(e.getSeconds())}`):8===t.value.length&&(a=`${t.value.substring(9,10)}:${t.value.substring(10,11)}:${t.value.substring(11,12)}`)}return M`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="time"
      ...
      data-action-click="${st(yt(t,"click"))}"
    />
  `},qt=(t,e)=>{let a;return t.control&&t.control.modes&&t.control.modes[0].options?a=t.control.modes[0].options:"True-False"===t.type&&(a=[{value:"true"},{value:"false"}]),void 0===a?null:M`
...
`,Ft=(t,e)=>t.control&&t.control.modes[0]&&t.control.modes[0].options?M`<select
      data-ref="${t.reference}"
      id=${st(e)}
      ?required="${!0===t.required}"
      data-action-change="${st(yt(t,"change"))}"
      ...
      data-action-change="${st(yt(t,"change"))}"
      data-action-click="${st(yt(t,"click"))}">
      </input>`,jt=(t,e)=>{if(t.control.modes&&t.control.modes[0]&&t.control.modes[0].options)return M`
      <input
        data-ref="${t.reference}"
        list="${t.reference}"
        ?required="${!0===t.required}"
...
`,Yt=(t,e,a,i,s)=>{const n=document.createElement("div");n.setAttribute("role","alertdialog"),n.setAttribute("aria-modal","true"),n.setAttribute("aria-labelledby",t),n.setAttribute("aria-describedby",""),n.setAttribute("class","mashup-modal");const r=document.createElement("div");n.appendChild(r);const o=()=>{document.body.removeEventListener("click",l),n&&(n.previousElementSibling&&(n.previousElementSibling.removeAttribute("aria-hidden"),n.previousElementSibling.focus()),n.remove()),s&&s()},l=t=>{if(t){let e=t.target;if(e.download)return;if(t.path&&t.path.length>0?e=t.path[0]:t.originalTarget&&(e=t.originalTarget),e){const t=e.closest("button");if((null===t||"close"!==t.getAttribute("data-action-id"))&&!e.classList.contains("mashup-modal")&&null!==e.closest(".mashup-modal"))return}o()}};return M`
  <div class='modalcontent'>
    ...
    </div>`},y=(t,e)=>e.loading?M`${b(t,e)}${Jt()}`:e.editing?"URL"===e.type?M`
...
`,Qt=(t,e,a,i)=>M`
  ${t.map(((t,s)=>{const n=`${e}-${s}`;if(t.layout){""!==t.layout.groupFormat.trim()&&"CENTER"!==t.layout.groupFormat||(t.layout.groupFormat="default");const e=t.layout.groupFormat.replace(/ /g,"_").toLowerCase(),s=`flex content layout-content-${e} content-${e}`;if(t.layout.view&&t.layout.view.groups)return M`
          <div class="${s}">${Qt(t.layout.view.groups,n,a,i)}</div>
        ...
        ${e}<div class="${s}">${Qt(t.layout.groups,n,a,i)}</div>
  ...
  ${Wt(t.layout,a)}
`)(t,0,a):te(t,n,a):null}if(t.field){if(t.field.control&&"pxAttachContent"===t.field.control.type)return Xt("Upload file","Upload file","",i.displayAttachments);if(t.field.control.actionSets[0]&&t.field.control.actionSets[0].actions[0]&&"localAction"===t.field.control.actionSets[0].actions[0].action){const e=i.actionID;return((t,e,a)=>{const i=t.control.actionSets[0].actions[0].actionProcess.localAction,s=t.control.actionSets[0].actions[0].actionProcess.target,n=t.control.modes[1].controlFormat?t.control.modes[1].controlFormat:"";if("modalDialog"===s){const s=a=>{O(Kt(t.control.label,Jt()),a),e(i,a)};return Yt(i,t.control.label,n,s,a)}return M`<div><button type="button" @click="${()=>{e(i)}}" class="pzhc pzbutton ${n}">${t.control.label}</button></<div>`})(t.field,i.displayLocalAction,(()=>{i.reloadAssignment(e)}))}return kt(t.field,n,a)}return t.view&&t.view.groups?"pyAttachFieldOptional"===t.view.viewID&&"Embed-Attach-File"===t.view.appliesTo?Xt("Upload file","Upload file","",i.displayAttachments):Qt(t.view.groups,n,a,i):null}))}
`,te=(t,e,a)=>M`
  ${Bt(t.layout)}
  <div class="rdl">
    ${ee(t.layout.rows,e,a)}
  </div>
  ${Wt(t.layout,a)}
`,ee=(t,e,a)=>M`
...
`,ae=(t,e,a,i)=>{if(null==i)return null;let s;const n=`${Math.random().toString(36).substr(2,9)}`,r=document.createElement("ul");r.setAttribute("id",`menu-overlay-${n}`),r.setAttribute("role","menu"),r.setAttribute("aria-labelledby",`menubutton-${n}`),r.setAttribute("tabindex","-1");const o=()=>{document.body.removeEventListener("click",c),document.body.removeEventListener("keydown",l),r&&(r.previousElementSibling&&(r.previousElementSibling.setAttribute("aria-expanded","false"),r.previousElementSibling.focus()),r.remove())},l=t=>{38===t.keyCode?(s=s.previousElementSibling,null===s&&(s=r.lastElementChild),s.focus()):40===t.keyCode?(s=s.nextElementSibling,null===s&&(s=r.firstElementChild),s.focus()):27===t.keyCode||9===t.keyCode?o():13===t.keyCode&&(i(t),o())},c=t=>{if(t){let e=t.target;if(t.path&&t.path.length>0?e=t.path[0]:t.originalTarget&&(e=t.originalTarget),e&&e.nextElementSibling===r)return;e.parentNode===r&&i(t),o()}},d=t=>{if("keydown"===t.type&&40!==t.keyCode)return;if(t.preventDefault(),"blur"===t.type)return void c(t);const e=t.target;"BUTTON"!==e.tagName?(i(t),o()):null===e.nextElementSibling?(t.target.parentNode.appendChild(r),e.setAttribute("aria-expanded","true"),O(a(),r),s=e.nextElementSibling.firstElementChild,s.focus(),document.body.addEventListener("click",c),document.body.addEventListener("keydown",l)):o()};return M`
  ...
  `},ie=(t,e,a,i,s,n,r,o,l)=>{const c=M`${xt()}<span class='count-badge'>${s}</span>`;if(void 0===e.caseID&&a.content)return M`
    <div class="flex layout-content-inline_middle main-header">
      ...
      <div class="flex layout-content-inline_middle margin-l-auto">
        ...
        ${a.actions&&a.actions.length>0?M`
          ${ae("Actions","Start a new action",n,r)}`:""}
      </div>
    </div>
    ${((t,e)=>t&&0!==t.length?M`
  <h3>
 ...
 <h3>${t}</h3>`},se=(t,e,a,i,s)=>M`
  <div class="flex layout-content-stacked">${Qt(t,e,!1,s)}</div>
  ${((t,e)=>M`
  <div class="action-button-area">
...
`)(a,i)}
`,ne=(t,e,a,i)=>M`
  <div class="flex layout-content-stacked">${Qt(t,e,!0,i)}</div>
  ${(t=>null===t?null:M`
  <div class="action-button-area">
...
`)(a,i)}
`,oe=(t,e,a,i)=>M`
  <div class="flex layout-content-stacked">${Qt(t,e,!1,i)}</div>
  ${(t=>M`
  <div class="action-button-area">
    ${null!==t?M`<button type="button" class="pzhc pzbutton" @click="${t}">Cancel</button>`:""}
...
`,le=t=>t.errorDetails?M`
  ...
  `))}
  </ul>`,ce=(t,e)=>{const a=[],i=Object.entries(e.actions);for(const e of i)e[1].name!==t&&a.push(M`
...
${t.pxResults.map((t=>M`
  ...
  <div id="case-data">${Jt()}</div>`):""!==this.caseID||""!==this.assignmentID||this.bShowNew?M`
  ...
  <div class="flex layout-content-inline_middle main-header">
    ...
    <div class="flex layout-content-inline_middle margin-l-auto">
      ...
      ${ae("Create","Create a new case",l,d)}
    </div>
  </div>
  ${o.length>0?M`
        <table>
