...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
var g;p.finalized=!0,p.elementProperties=new Map,p.elementStyles=[],p.shadowRootOptions={mode:"open"},null==c||c({ReactiveElement:p}),(null!==(o=globalThis.reactiveElementVersions)&&void 0!==o?o:globalThis.reactiveElementVersions=[]).push("1.3.4");const m=globalThis.trustedTypes,$=m?m.createPolicy("lit-html",{createHTML:t=>t}):void 0,f=`lit$${(Math.random()+"").slice(9)}$`,v="?"+f,b=`<${v}>`,y=document,C=(t="")=>y.createComment(t),w=t=>null===t||"object"!=typeof t&&"function"!=typeof t,A=Array.isArray,D=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,k=/-->/g,x=/>/g,S=RegExp(">|[ \t\n\f\r](?:([^\\s\"'>=/]+)([ \t\n\f\r]*=[ \t\n\f\r]*(?:[^ \t\n\f\r\"'`<>=]|(\"|')|))|$)","g"),_=/'/g,I=/"/g,E=/^(?:script|style|textarea|title)$/i,T=(t=>(e,...a)=>({_$litType$:t,strings:e,values:a}))(1),L=Symbol.for("lit-noChange"),U=Symbol.for("lit-nothing"),N=new WeakMap,M=(t,e,a)=>{var i,s;const n=null!==(i=null==a?void 0:a.renderBefore)&&void 0!==i?i:e;let o=n._$litPart$;if(void 0===o){const t=null!==(s=null==a?void 0:a.renderBefore)&&void 0!==s?s:null;n._$litPart$=o=new F(e.insertBefore(C(),t),t,void 0,null!=a?a:{})}return o._$AI(t),o},R=y.createTreeWalker(y,129,null,!1),P=(t,e)=>{const a=t.length-1,i=[];let s,n=2===e?"<svg>":"",o=D;for(let e=0;e<a;e++){const a=t[e];let r,l,c=-1,d=0;for(;d<a.length&&(o.lastIndex=d,l=o.exec(a),null!==l);)d=o.lastIndex,o===D?"!--"===l[1]?o=k:void 0!==l[1]?o=x:void 0!==l[2]?(E.test(l[2])&&(s=RegExp("</"+l[2],"g")),o=S):void 0!==l[3]&&(o=S):o===S?">"===l[0]?(o=null!=s?s:D,c=-1):void 0===l[1]?c=-2:(c=o.lastIndex-l[2].length,r=l[1],o=void 0===l[3]?S:'"'===l[3]?I:_):o===I||o===_?o=S:o===k||o===x?o=D:(o=S,s=void 0);const h=o===S&&t[e+1].startsWith("/>")?" ":"";n+=o===D?a+b:c>=0?(i.push(r),a.slice(0,c)+"$lit$"+a.slice(c)+f+h):a+f+(-2===c?(i.push(void 0),e):h)}const r=n+(t[a]||"<?>")+(2===e?"</svg>":"");if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==$?$.createHTML(r):r,i]};class O{constructor({strings:t,_$litType$:e},a){let i;this.parts=[];let s=0,n=0;const o=t.length-1,r=this.parts,[l,c]=P(t,e);if(this.el=O.createElement(l,a),R.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(i=R.nextNode())&&r.length<o;){if(1===i.nodeType){if(i.hasAttributes()){const t=[];for(const e of i.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith(f)){const a=c[n++];if(t.push(e),void 0!==a){const t=i.getAttribute(a.toLowerCase()+"$lit$").split(f),e=/([.?@])?(.*)/.exec(a);r.push({type:1,index:s,name:e[2],strings:t,ctor:"."===e[1]?j:"?"===e[1]?B:"@"===e[1]?W:H})}else r.push({type:6,index:s})}for(const e of t)i.removeAttribute(e)}if(E.test(i.tagName)){const t=i.textContent.split(f),e=t.length-1;if(e>0){i.textContent=m?m.emptyScript:"";for(let a=0;a<e;a++)i.append(t[a],C()),R.nextNode(),r.push({type:2,index:++s});i.append(t[e],C())}}}else if(8===i.nodeType)if(i.data===v)r.push({type:2,index:s});else{let t=-1;for(;-1!==(t=i.data.indexOf(f,t+1));)r.push({type:7,index:s}),t+=f.length-1}s++}}static createElement(t,e){const a=y.createElement("template");return a.innerHTML=t,a}}function z(t,e,a=t,i){var s,n,o,r;if(e===L)return e;let l=void 0!==i?null===(s=a._$Cl)||void 0===s?void 0:s[i]:a._$Cu;const c=w(e)?void 0:e._$litDirective$;return(null==l?void 0:l.constructor)!==c&&(null===(n=null==l?void 0:l._$AO)||void 0===n||n.call(l,!1),void 0===c?l=void 0:(l=new c(t),l._$AT(t,a,i)),void 0!==i?(null!==(o=(r=a)._$Cl)&&void 0!==o?o:r._$Cl=[])[i]=l:a._$Cu=l),void 0!==l&&(e=z(t,l._$AS(t,e.values),l,i)),e}class q{constructor(t,e){this.v=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(t){var e;const{el:{content:a},parts:i}=this._$AD,s=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:y).importNode(a,!0);R.currentNode=s;let n=R.nextNode(),o=0,r=0,l=i[0];for(;void 0!==l;){if(o===l.index){let e;2===l.type?e=new F(n,n.nextSibling,this,t):1===l.type?e=new l.ctor(n,l.name,l.strings,this,t):6===l.type&&(e=new Z(n,this,t)),this.v.push(e),l=i[++r]}o!==(null==l?void 0:l.index)&&(n=R.nextNode(),o++)}return s}m(t){let e=0;for(const a of this.v)void 0!==a&&(void 0!==a.strings?(a._$AI(t,a,e),e+=a.strings.length-2):a._$AI(t[e])),e++}}class F{constructor(t,e,a,i){var s;this.type=2,this._$AH=U,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=a,this.options=i,this._$C_=null===(s=null==i?void 0:i.isConnected)||void 0===s||s}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$C_}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=z(this,t,e),w(t)?t===U||null==t||""===t?(this._$AH!==U&&this._$AR(),this._$AH=U):t!==this._$AH&&t!==L&&this.T(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.k(t):(t=>A(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]))(t)?this.S(t):this.T(t)}j(t,e=this._$AB){return this._$AA.parentNode.insertBefore(t,e)}k(t){this._$AH!==t&&(this._$AR(),this._$AH=this.j(t))}T(t){this._$AH!==U&&w(this._$AH)?this._$AA.nextSibling.data=t:this.k(y.createTextNode(t)),this._$AH=t}$(t){var e;const{values:a,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=O.createElement(i.h,this.options)),i);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===s)this._$AH.m(a);else{const t=new q(s,this),e=t.p(this.options);t.m(a),this.k(e),this._$AH=t}}_$AC(t){let e=N.get(t.strings);return void 0===e&&N.set(t.strings,e=new O(t)),e}S(t){A(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let a,i=0;for(const s of t)i===e.length?e.push(a=new F(this.j(C()),this.j(C()),this,this.options)):a=e[i],a._$AI(s),i++;i<e.length&&(this._$AR(a&&a._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){var a;for(null===(a=this._$AP)||void 0===a||a.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$C_=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class H{constructor(t,e,a,i,s){this.type=1,this._$AH=U,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=s,a.length>2||""!==a[0]||""!==a[1]?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=U}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,a,i){const s=this.strings;let n=!1;if(void 0===s)t=z(this,t,e,0),n=!w(t)||t!==this._$AH&&t!==L,n&&(this._$AH=t);else{const i=t;let o,r;for(t=s[0],o=0;o<s.length-1;o++)r=z(this,i[a+o],e,o),r===L&&(r=this._$AH[o]),n||(n=!w(r)||r!==this._$AH[o]),r===U?t=U:t!==U&&(t+=(null!=r?r:"")+s[o+1]),this._$AH[o]=r}n&&!i&&this.P(t)}P(t){t===U?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class j extends H{constructor(){super(...arguments),this.type=3}P(t){this.element[this.name]=t===U?void 0:t}}const V=m?m.emptyScript:"";class B extends H{constructor(){super(...arguments),this.type=4}P(t){t&&t!==U?this.element.setAttribute(this.name,V):this.element.removeAttribute(this.name)}}class W extends H{constructor(t,e,a,i,s){super(t,e,a,i,s),this.type=5}_$AI(t,e=this){var a;if((t=null!==(a=z(this,t,e,0))&&void 0!==a?a:U)===L)return;const i=this._$AH,s=t===U&&i!==U||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==U&&(i===U||s);s&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,a;"function"==typeof this._$AH?this._$AH.call(null!==(a=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==a?a:this.element,t):this._$AH.handleEvent(t)}}class Z{constructor(t,e,a){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(t){z(this,t)}}const Y=window.litHtmlPolyfillSupport;
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
...
class Dt extends class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,a){this._$Ct=t,this._$AM=e,this._$Ci=a}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}{constructor(t){if(super(t),this.it=U,t.type!==At)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===U||null==t)return this._t=void 0,this.it=t;if(t===L)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}Dt.directiveName="unsafeHTML",Dt.resultType=1;const kt=(t=>(...e)=>({_$litDirective$:t,values:e}))(Dt),xt=t=>null!=t?t:U,St=(t,e)=>{if(t.control&&t.control.actionSets&&t.control.actionSets.length>0)for(const a of t.control.actionSets)if(a.events.length>0&&a.actions.length>0&&a.events[0].event===e){let t=a.actions[0].action;return"refresh"===t&&""!==a.actions[0].refreshFor&&(t+=`-${a.actions[0].refreshFor}`),t}},_t=t=>"pyTemplateButton"!==t.reference?t.reference:t.control&&t.control.modes?t.control.modes[1].tooltip:null,It=(t,e,a)=>{if(void 0===e)return null;const i=t.required&&!0!==t.readOnly?"icon-required":"";return"field-checkbox"===a?""!==t.label||!0===t.showLabel?T`<div class="field-caption dataLabelForWrite ${i}">${lt(t.label)}</div>`:null:"field-text"===a&&!0===t.readOnly&&"pxCheckbox"===t.control.type&&t.control.label?T`<label class="field-caption dataLabelForWrite">${lt(t.control.label)}</label>`:""!==t.label||!0===t.showLabel||!0===t.labelReserveSpace?T`<label class="field-caption dataLabelForWrite ${i}" for="${xt(e)}">${lt(t.label)}</label>`:null},Et=(t,e,a,i)=>{if(void 0===e||-1!==e.indexOf("-table-"))return"field-checkbox"===a?T`<div class="flex">${i}</div>`:T`
  ...
  `},Tt=(t,e,a,i)=>{if(void 0===t||void 0===t.control||void 0===t.control.type)return null;if(t.customAttributes&&"none"===t.customAttributes.display)return null;if(!0===a||!0===t.readOnly||"pxHidden"===t.control.type)return Et(t,e,"field-text",Lt(t,e));if(i.casedata&&i.casedata.content){ht(i.casedata.content,t.reference)||("pxCheckbox"===t.control.type?dt(i.casedata.content,t.reference,"true"==t.value):dt(i.casedata.content,t.reference,t.value))}switch(t.control.type){case"pxPhone":case"pxTextInput":return Et(t,e,"field-textinput",Ut(t,e));case"pxInteger":case"pxNumber":return Et(t,e,"field-numberinput",Mt(t,e));case"pxCurrency":return Et(t,e,"field-currencyinput",Rt(t,e));case"pxEmail":return Et(t,e,"field-emailinput",Pt(t,e));case"pxTextArea":return Et(t,e,"field-textarea",Ot(t,e));case"pxRadioButtons":return Et(t,e,"field-radiogroup",Wt(t,e));case"pxCheckbox":return Et(t,e,"field-checkbox",Zt(t,e));case"pxDropdown":return Et(t,e,"field-dropdown",Yt(t,e));case"pxDisplayText":return Et(t,e,"field-text",Lt(t,e));case"pxIcon":return Et(t,e,"field-icon",zt(t,e));case"pxLink":case"pxURL":return Et(t,e,"field-url",qt(t,e));case"pxIconDeleteItem":return Et(t,e,"field-button",Ht(t,e));case"pxButton":return Et(t,e,"field-button",Ft(t,e));case"pxDateTime":return"TimeOfDay"===t.type?Et(t,e,"field-time",Bt(t,e)):"Date"===t.type?Et(t,e,"field-date",Vt(t,e)):Et(t,e,"field-datetime",jt(t,e));case"pxAutoComplete":return Et(t,e,"field-combobox",Jt(t,e));case"pxSlider":return Et(t,e,"field-slider",Nt(t,e));default:return null}},Lt=(t,e)=>{if("pxDate"===t.control.type){let a=rt(t.value);if(a)if(t.control&&2===t.control.modes.length){let e={};switch(t.control.modes[1].dateFormat){case"DateTime-Short-YYYY":case"Date-DayMonthYear-Custom":case"Date-Medium":e={year:"numeric",month:"short",day:"numeric"};break;case"Date-Short":e={year:"numeric",month:"numeric",day:"numeric"};break;case"Date-Long":e={year:"numeric",month:"long",day:"numeric"};break;case"Date-Full":e={weekday:"long",year:"numeric",month:"long",day:"numeric"};break;default:e={}}a=new Intl.DateTimeFormat([],e).format(a)}else a=(new Intl.DateTimeFormat).format(a);else a=t.value;return T`
...
`,Qt=(t,e,a,i)=>T`
  ${t.map(((t,s)=>{const n=`${e}-table-${s}`;return T`
    <tr>
      ${t.groups.map(((t,e)=>T`
      <td>${Tt(t.field,`${n}-${e}`,a,i)}</td>`))}
    </tr>`}))}
`,te=(t,e,a,i)=>T`
  ...
  <caption class="sr-only">${t.layout.title}</caption>
    ...
    <tbody>
      ${Qt(t.layout.rows,e,a,i)}
    </tbody>
  </table>
  </div>
  ${Xt(t.layout,a)}</div>
`)(t,n,a,i):ee(t,n,a,i):null}if(t.paragraph)return T`<div class='flex content-item field-item flex-paragraph'>${kt(t.paragraph.value)}</div>`;if(t.caption&&t.caption.visible)return T`<div class='flex content-item field-item flex-paragraph'>${kt(t.caption.value)}</div>`;if(t.field){if(t.field.control&&"pxAttachContent"===t.field.control.type){let e="Upload file";return t.field.customAttributes&&t.field.customAttributes.Label&&(e=t.field.customAttributes.Label),bt(e,e,"",i.displayAttachments)}if(t.field.control&&t.field.control.actionSets&&t.field.control.actionSets.length>0&&t.field.control.actionSets[0]&&t.field.control.actionSets[0].actions[0]&&"localAction"===t.field.control.actionSets[0].actions[0].action){const e=i.actionID;return((t,e,a)=>{const i=t.control.actionSets[0].actions[0].actionProcess.localAction,s=t.control.actionSets[0].actions[0].actionProcess.target,n=t.control.modes[1].controlFormat?t.control.modes[1].controlFormat:"";if("modalDialog"===s){const s=a=>{M(Ct(t.control.label,Q()),a),e(i,a)};return st(i,t.control.label,n,s,a)}return T`<div><button type="button" @click="${()=>{e(i)}}" class="pzhc pzbutton ${n}">${i18n.t(t.control.label)}</button></<div>`})(t.field,i.displayLocalAction,(()=>{i.reloadAssignment(e)}))}return Tt(t.field,n,a,i)}return t.view&&t.view.groups?"pyAttachFieldOptional"===t.view.viewID&&"Embed-Attach-File"===t.view.appliesTo?bt("Upload file","Upload file","",i.displayAttachments):te(t.view.groups,n,a,i):null}))}
`,ee=(t,e,a,i)=>T`
  ${Kt(t.layout)}
  <div class="rdl">
