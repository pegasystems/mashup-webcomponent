...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
class{handleAttributeExpressions(t,e,a,i){const s=e[0];if("."===s){return new A(t,e.slice(1),a).parts}if("@"===s)return[new E(t,e.slice(1),i.eventContext)];if("?"===s)return[new D(t,e.slice(1),a)];return new x(t,e,a).parts}handleTextExpression(t){return new k(t)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const U=(t,...e)=>new C(t,e,"html",O)
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
const it=new WeakMap,st=(nt=t=>e=>{const a=it.get(e);if(void 0===t&&e instanceof _){if(void 0!==a||!it.has(e)){const t=e.committer.name;e.committer.element.removeAttribute(t)}}else t!==a&&e.setValue(t);it.set(e,t)},(...t)=>{const e=nt(...t);return g.set(e,!0),e});var nt;const rt=t=>`0${t}`.slice(-2),ot=t=>t.replace(/&amp;|&lt;|&gt;|&#39;|&#40;|&#41;|&quot;/g,(t=>({"&amp;":"&","&lt;":"<","&gt;":">","&#39;":"'","&#40;":"(","&#41;":")","&quot;":'"'}[t]||t))),lt=(t,e,a)=>{if("string"!=typeof e)return;const i=e.split(".");let s=t;for(const t in i){let e=i[t];const n=e.indexOf("(");if(-1===n)t<i.length-1?void 0===s[e]&&(s[e]={}):s[e]=a,s=s[e];else{const t=e.substring(n+1,e.length-1);e=e.substring(0,n),void 0===s[e]&&(s[e]=[]);for(let a=s[e].length;a<t;a++)s[e].push({});s=s[e][t-1]}}},ct=(t,e)=>{if("string"!=typeof e)return null;let a=t;const i=e.split(".");for(const t in i){const e=i[t],s=e.indexOf("(");if(-1===s){if(!a[e])return null;a=a[e]}else{const t=e.substring(s+1,e.length-1),i=a[e.substring(0,s)];if(!(i&&Array.isArray(i)&&i.length>=t))return null;a=i[t-1]}}return a},dt=t=>{for(const e in t)"object"==typeof t[e]?dt(t[e]):"string"==typeof t[e]&&(t[e]="")},ht=(t,e)=>{for(const a in t)if("fieldID"===a)e.push(t.fieldID);else{const i=t[a];i.fieldID?e.push(i.fieldID):"object"==typeof i&&ht(i,e)}},ut=(t,e)=>{const a=t.getAttribute(`data-action-${e}`);return!(!a||"postValue"!==a&&0!==a.indexOf("refresh"))},pt=(t,e)=>{const a=t.getAttribute(`data-action-${e}`);return a&&0===a.indexOf("refresh")?a.replace("refresh-",""):""},gt=(t,e)=>{for(const a in t.elements){const i=t.elements[a];if("INPUT"===i.tagName||"TEXTAREA"===i.tagName||"SELECT"===i.tagName){const t=i.getAttribute("data-ref");if(null!==t&&"pyID"!==t)if("INPUT"===i.tagName){const a=i.getAttribute("type");if("checkbox"===a)lt(e,t,i.checked);else if("radio"===a)i.checked&&lt(e,t,i.value);else if("date"===a){let a;i.valueAsDate&&(a=new Date(i.valueAsDate)),a&&a instanceof Date&&a.getTime()==a.getTime()||(a=new Date(i.value)),a&&a instanceof Date&&a.getTime()==a.getTime()?(a=new Date(a.getTime()+6e4*a.getTimezoneOffset()),lt(e,t,`${rt(a.getMonth()+1)}/${rt(a.getDate())}/${a.getFullYear()}`)):lt(e,t,i.value)}else lt(e,t,i.value)}else lt(e,t,i.value)}}},mt=t=>{if(void 0===t.content)return{};const e={};for(const a in t.content){const i=t.content[a];"object"!=typeof i||0===a.indexOf("px")||Array.isArray(i)||"pyWorkParty"===a||(e[a]=i)}return e},ft=(t,e)=>{if(t.control&&t.control.actionSets&&t.control.actionSets.length>0)for(const a in t.control.actionSets){const i=t.control.actionSets[a];if(i.events.length>0&&i.actions.length>0&&i.events[0].event===e){let t=i.actions[0].action;return"refresh"===t&&""!==i.actions[0].refreshFor&&(t+=`-${i.actions[0].refreshFor}`),t}}},bt=t=>"pyTemplateButton"!==t.reference?t.reference:t.control&&t.control.modes?t.control.modes[1].tooltip:null,yt=(t,e,a)=>{if(void 0===e)return null;const i=t.required&&!0!==t.readOnly?"icon-required":"";return"field-checkbox"===a?""!==t.label||!0===t.showLabel?U`<div class="field-caption dataLabelForWrite ${i}">${ot(t.label)}</div>`:null:"field-text"===a&&!0===t.readOnly&&"pxCheckbox"===t.control.type&&t.control.label?U`<label>${ot(t.control.label)}</label>`:""!==t.label||!0===t.showLabel||!0===t.labelReserveSpace?U`<label class="field-caption dataLabelForWrite ${i}" for="${st(e)}">${ot(t.label)}</label>`:null},vt=(t,e,a,i)=>void 0===e?U`
      ${i}
    `:"field-button"!==a||(t=>!!(t.control&&t.control.actionSets&&t.control.actionSets.length>0))(t)?"field-radiogroup"===a?U`
    <div class="flex content-item field-item ${a}"><fieldset><legend>${yt(t,e,a)}</legend>${i}</fielset></div>
  `:U`
    <div class="flex content-item field-item ${a}">${yt(t,e,a)}${i}</div>
  `:null,$t=()=>U`
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" width="20px" height="20px" fill="currentColor">
  <path d="M20.5226562,11.6265625 C20.6664062,11.6265625 20.7617188,11.6742188 20.8578125,11.7703125 C20.9539062,11.8664063 21.0015625,11.9617188 21.0015625,12.1054688 C21.0015625,12.2492188 20.9539062,12.3445313 20.8578125,12.440625 C20.8578125,12.440625 20.8578125,12.440625 20.8578125,12.440625 C20.8578125,12.440625 13.2429687,20.0554687 13.2429687,20.0554687 C12.1414062,21.109375 10.8484375,21.6359375 9.41171875,21.6359375 C7.975,21.6359375 6.68203125,21.109375 5.58046875,20.0554687 C5.58046875,20.0554687 5.58046875,20.0554687 5.58046875,20.0554687 C4.5265625,19.0015625 4,17.75625 4,16.271875 C4,16.271875 4,16.271875 4,16.271875 C4,14.8351563 4.5265625,13.5421875 5.58046875,12.440625 C5.58046875,12.440625 5.58046875,12.440625 5.58046875,12.440625 C5.58046875,12.440625 14.9671875,3.14921875 14.9671875,3.14921875 C15.7335937,2.3828125 16.64375,2 17.7453125,2 C18.846875,2 19.7570312,2.3828125 20.5234375,3.14921875 C20.5234375,3.14921875 20.5234375,3.14921875 20.5234375,3.14921875 C21.2898437,3.86796875 21.6726562,4.77734375 21.6726562,5.87890625 C21.6726562,5.87890625 21.6726562,5.87890625 21.6726562,5.87890625 C21.6726562,6.98046875 21.2898437,7.890625 20.5234375,8.65703125 C20.5234375,8.65703125 20.5234375,8.65703125 20.5234375,8.65703125 C20.5234375,8.65703125 11.8546875,17.2773438 11.8546875,17.2773438 C11.3757813,17.75625 10.8007812,17.9960938 10.1304687,17.9960938 C10.1304687,17.9960938 10.1304687,17.9960938 10.1304687,17.9960938 C9.5078125,17.9960938 8.88515625,17.7570313 8.35859375,17.2773438 C8.35859375,17.2773438 8.35859375,17.2773438 8.35859375,17.2773438 C7.8796875,16.7984375 7.63984375,16.2234375 7.63984375,15.553125 C7.63984375,14.8828125 7.87890625,14.3078125 8.35859375,13.8289062 C8.35859375,13.8289062 8.35859375,13.8289062 8.35859375,13.8289062 C8.35859375,13.8289062 16.6921875,5.54375 16.6921875,5.54375 C16.7882812,5.44765625 16.93125,5.4 17.075,5.4 C17.075,5.4 17.075,5.4 17.075,5.4 C17.21875,5.4 17.3140625,5.44765625 17.4101562,5.54375 C17.50625,5.63984375 17.5539062,5.73515625 17.5539062,5.87890625 C17.5539062,5.87890625 17.5539062,5.87890625 17.5539062,5.87890625 C17.5539062,6.02265625 17.50625,6.16640625 17.4101562,6.26171875 C17.4101562,6.26171875 17.4101562,6.26171875 17.4101562,6.26171875 C17.4101562,6.26171875 9.0765625,14.4992187 9.0765625,14.4992187 C8.7890625,14.7867187 8.6453125,15.121875 8.6453125,15.553125 C8.6453125,15.984375 8.7890625,16.3195313 9.0765625,16.6070312 C9.3640625,16.8945312 9.69921875,17.0382813 10.1304687,17.0382813 C10.1304687,17.0382813 10.1304687,17.0382813 10.1304687,17.0382813 C10.5132812,17.0382813 10.8492187,16.8945312 11.1359375,16.6070312 C11.1359375,16.6070312 11.1359375,16.6070312 11.1359375,16.6070312 C11.1359375,16.6070312 19.8523437,7.98671875 19.8523437,7.98671875 C20.4273437,7.41171875 20.7140625,6.69375 20.7140625,5.8796875 C20.7140625,5.8796875 20.7140625,5.8796875 20.7140625,5.8796875 C20.7140625,5.065625 20.4265625,4.3953125 19.8523437,3.8203125 C19.8523437,3.8203125 19.8523437,3.8203125 19.8523437,3.8203125 C19.2296875,3.2453125 18.5117187,2.95859375 17.7453125,2.95859375 C17.7453125,2.95859375 17.7453125,2.95859375 17.7453125,2.95859375 C16.93125,2.95859375 16.2609375,3.24609375 15.6859375,3.8203125 C15.6859375,3.8203125 15.6859375,3.8203125 15.6859375,3.8203125 C15.6859375,3.8203125 6.29921875,13.159375 6.29921875,13.159375 C5.4375,13.9734375 5.00625,14.9789062 5.00625,16.2726562 C5.00625,16.2726562 5.00625,16.2726562 5.00625,16.2726562 C5.00625,17.5179688 5.4375,18.5234375 6.29921875,19.3375 C6.29921875,19.3375 6.29921875,19.3375 6.29921875,19.3375 C7.1609375,20.1992188 8.21484375,20.6304688 9.4125,20.6304688 C9.4125,20.6304688 9.4125,20.6304688 9.4125,20.6304688 C10.7054687,20.6304688 11.7117187,20.1992188 12.5257812,19.3375 C12.5257812,19.3375 12.5257812,19.3375 12.5257812,19.3375 C12.5257812,19.3375 20.1882812,11.7703125 20.1882812,11.7703125 C20.284375,11.6742188 20.3796875,11.6265625 20.5234375,11.6265625 L20.5226562,11.6265625 Z"/>
</svg>`,St=(t,e,a)=>{if(void 0===t||void 0===t.control||void 0===t.control.type)return null;if(t.customAttributes&&"none"===t.customAttributes.display)return null;if(!0===a||!0===t.readOnly||"pxHidden"===t.control.type)return vt(t,e,"field-text",xt(t,e));switch(t.control.type){case"pxPhone":case"pxTextInput":return vt(t,e,"field-textinput",_t(t,e));case"pxInteger":case"pxNumber":return vt(t,e,"field-numberinput",Dt(t,e));case"pxCurrency":return vt(t,e,"field-currencyinput",At(t,e));case"pxEmail":return vt(t,e,"field-emailinput",It(t,e));case"pxTextArea":return vt(t,e,"field-textarea",Tt(t,e));case"pxRadioButtons":return vt(t,e,"field-radiogroup",Lt(t,e));case"pxCheckbox":return vt(t,e,"field-checkbox",Ot(t,e));case"pxDropdown":return vt(t,e,"field-dropdown",Ut(t,e));case"pxDisplayText":return vt(t,e,"field-text",xt(t,e));case"pxIcon":return vt(t,e,"field-icon",Et(t,e));case"pxLink":case"pxURL":return vt(t,e,"field-url",Nt(t,e));case"pxIconDeleteItem":return vt(t,e,"field-button",Rt(t,e));case"pxButton":return vt(t,e,"field-button",Pt(t,e));case"pxDate":case"pxDateTime":return vt(t,e,"field-datetime",zt(t,e));case"pxAutoComplete":return vt(t,e,"field-combobox",Mt(t,e));case"pxSlider":return vt(t,e,"field-slider",kt(t,e));default:return null}},xt=(t,e)=>{if("pxDate"===t.control.type||"pxDateTime"===t.control.type){let a=(t=>{if(t.endsWith(" GMT")&&23===t.length)return new Date(`${t.substring(0,4)}-${t.substring(4,6)}-${t.substring(6,8)}T${t.substring(9,11)}:${t.substring(11,13)}:${t.substring(13,19)}Z`);if(8===t.length){let e=new Date(`${t.substring(0,4)}-${t.substring(4,6)}-${t.substring(6,8)}T00:00:00.000Z`);return e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),e}if(10===t.length){let e=new Date(`${t.substring(6,10)}-${t.substring(0,2)}-${t.substring(3,5)}T00:00:00.000Z`);return e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),e}return null})(t.value);if(a)if(t.control&&2===t.control.modes.length){let e={};switch(t.control.modes[1].dateFormat){case"DateTime-Short-YYYY":case"Date-DayMonthYear-Custom":case"Date-Mediun":e={year:"numeric",month:"short",day:"numeric"};break;case"Date-Short":e={year:"numeric",month:"numeric",day:"numeric"};break;case"Date-Long":e={year:"numeric",month:"long",day:"numeric"};break;case"Date-Full":e={weekday:"long",year:"numeric",month:"long",day:"numeric"};break;default:e={}}a=a.toLocaleDateString(void 0,e)}else a=a.toLocaleDateString();else a=t.value;return U`
    ...
    `;let a=t.value;if(t.control&&2===t.control.modes.length&&"locallist"===t.control.modes[0].listSource)for(const e in t.control.modes[0].options){const i=t.control.modes[0].options[e];i.key===a&&(a=i.value)}return"pxCurrency"===t.control.type&&(a=`$${a}`),U`
  ...
  <input
    ...
    id="${st(e)}"
    value="${ot(t.value)}"
    data-action-change="${st(ft(t,"change"))}"
    data-action-click="${st(ft(t,"click"))}"
  />
`,kt=(t,e)=>U`
  <input
    data-ref="${t.reference}"
...
`,Pt=(t,e)=>{const a=ft(t,"click");return"deleteRow"===a?Rt(t,e):U`
  <button
  type='button' 
  ...
  >${t.control.label}</button>`},Rt=(t,e)=>U`
  <button
    type='button' 
  ...
  >${Ct()}</button>
`,zt=(t,e)=>{let a=t.value;if(""!==a){let e=new Date(a);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),a=`${e.getFullYear()}-${rt(e.getMonth()+1)}-${rt(e.getDate())}`):8===t.value.length&&(a=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}`)}return U`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      pattern="\\d{4}-\\d{2}-\\d{2}"
    ...
    data-action-click="${st(ft(t,"click"))}"
    />
  `},Lt=(t,e)=>{let a;return t.control&&t.control.modes&&t.control.modes[0].options?a=t.control.modes[0].options:"True-False"===t.type&&(a=[{value:"true"},{value:"false"}]),void 0===a?null:U`
...
`,Ut=(t,e)=>t.control&&t.control.modes[0]&&t.control.modes[0].options?U`<select
      data-ref="${t.reference}"
      id=${st(e)}
      ?required="${!0===t.required}"
      data-action-change="${st(ft(t,"change"))}"
      ...
      data-action-change="${st(ft(t,"change"))}"
      data-action-click="${st(ft(t,"click"))}">
      </input>`,Mt=(t,e)=>{if(t.control.modes&&t.control.modes[0]&&t.control.modes[0].options)return U`
      <input
        data-ref="${t.reference}"
        list="${t.reference}"
        ?required="${!0===t.required}"
  ...
  `},qt=t=>""!==t.title?U`
    ...
    `:null,Vt=(t,e)=>{let a=t.fieldListID;if(void 0!==t.reference&&(a=t.reference),"."===a.charAt(0)&&(a=a.substring(1)),t.newRow&&!0!==e){const e=[];return ht(t.newRow,e),U`
      <div class="table-action-area">
        ${"add-row"===t.testID?U`<button type="button" class="pzhc pzbutton Simple" data-newrow="${st(e.join())}"
        data-ref=${a} data-action-click="addRow">${U`
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" width="20px" height="20px" fill="currentColor">
<path d="M11.290625,2 C11.290625,2 13.2539062,2 13.2539062,2 C13.2539062,2 13.2539062,22.59375 13.2539062,22.59375 C13.2539062,22.59375 11.290625,22.59375 11.290625,22.59375 C11.290625,22.59375 11.290625,2 11.290625,2 Z M22.59375,11.3390625 C22.59375,11.3390625 22.59375,13.2546875 22.59375,13.2546875 C22.59375,13.2546875 2,13.2546875 2,13.2546875 C2,13.2546875 2,11.3390625 2,11.3390625 C2,11.3390625 22.59375,11.3390625 22.59375,11.3390625 L22.59375,11.3390625 Z"/>
    ...
    `}return null},Ft=t=>U`
  ${t.map((t=>U`
    <th>${t.caption?U`${t.caption.value}`:""}</th>`))}
`,jt=t=>U`
  ${t.map((t=>U`
    <tr>
      ${t.groups.map((t=>U`
...
`,Wt=(t,e,a,i)=>((t,e,a,i)=>{const s=document.createElement("div");s.setAttribute("role","alertdialog"),s.setAttribute("aria-modal","true"),s.setAttribute("aria-labelledby",t),s.setAttribute("aria-describedby",""),s.setAttribute("class","mashup-modal");const n=document.createElement("div");s.appendChild(n);const r=()=>{document.body.removeEventListener("click",o),s&&(s.previousElementSibling&&(s.previousElementSibling.removeAttribute("aria-hidden"),s.previousElementSibling.focus()),s.remove())},o=t=>{if(t){let e=t.target;if(e.download)return;if(t.path&&t.path.length>0?e=t.path[0]:t.originalTarget&&(e=t.originalTarget),e){const t=e.closest("button");if((null===t||"close"!==t.getAttribute("data-action-id"))&&!e.classList.contains("mashup-modal")&&null!==e.closest(".mashup-modal"))return}r()}};return U`
  <div class='modalcontent'>
    ...
    </div>`},y=(t,e)=>e.loading?U`${b(t,e)}${Bt()}`:e.editing?"URL"===e.type?U`
    ...
    `))}
      ...
      <button type='button' data-id="${t}" @click="${c}" class='pzhc pzbutton Simple' title='Delete'>${Ct()}</button>`:U`${b(t,e)}
    <button type='button' data-id="${t}" @click="${l}" class='pzhc pzbutton Simple' title='Delete'>${Ct()}</button>`,v=t=>{if(!a)return Bt();const e=[];if(void 0!==t){const a=Object.entries(t);for(const t of a){let a=t[1].extension;void 0===a&&(a=t[1].type),"URL"===t[1].type&&t[1].editing?e.push(U`<div class='flex layout-content-stacked content-items-maxwidth'>
              ${y(t[0],t[1])}
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" width="20px" height="20px" fill="currentColor">
  <path d="M22.1632813,6.753125 C22.1632813,6.753125 22.1632813,6.753125 22.1632813,6.753125 C22.1632813,6.753125 15.8414062,0.43125 15.8414062,0.43125 C15.6023437,0.14375 15.21875,0 14.7875,0 C14.7875,0 14.7875,0 14.7875,0 C14.7875,0 3.48515625,0 3.48515625,0 C3.05390625,0 2.71875,0.14375 2.43125,0.43125 C2.14375,0.71875 2,1.05390625 2,1.48515625 C2,1.48515625 2,1.48515625 2,1.48515625 C2,1.48515625 2,23.0367188 2,23.0367188 C2,23.4679688 2.14375,23.803125 2.43125,24.090625 C2.71875,24.378125 3.05390625,24.521875 3.48515625,24.521875 C3.48515625,24.521875 3.48515625,24.521875 3.48515625,24.521875 C3.48515625,24.521875 21.109375,24.521875 21.109375,24.521875 C21.540625,24.521875 21.8757812,24.378125 22.1632813,24.090625 C22.4507812,23.803125 22.5945312,23.4679688 22.5945312,23.0367188 C22.5945312,23.0367188 22.5945312,23.0367188 22.5945312,23.0367188 C22.5945312,23.0367188 22.5945312,7.80703125 22.5945312,7.80703125 C22.5945312,7.37578125 22.4507812,7.040625 22.1632813,6.753125 Z M15.6976563,1.6765625 C15.6976563,1.6765625 20.8703125,6.84921875 20.8703125,6.84921875 C20.8703125,6.84921875 16.225,6.84921875 16.225,6.84921875 C15.8898438,6.84921875 15.7460938,6.70546875 15.7460938,6.3703125 C15.7460938,6.3703125 15.7460938,6.3703125 15.7460938,6.3703125 C15.7460938,6.3703125 15.6984375,1.6765625 15.6984375,1.6765625 L15.6976563,1.6765625 Z M21.6367188,7.8546875 C21.6367188,7.8546875 21.6367188,23.0367188 21.6367188,23.0367188 C21.6367188,23.371875 21.4453125,23.515625 21.1101563,23.515625 C21.1101563,23.515625 21.1101563,23.515625 21.1101563,23.515625 C21.1101563,23.515625 3.4859375,23.515625 3.4859375,23.515625 C3.15078125,23.515625 2.959375,23.371875 2.959375,23.0367188 C2.959375,23.0367188 2.959375,23.0367188 2.959375,23.0367188 C2.959375,23.0367188 2.959375,1.48515625 2.959375,1.48515625 C2.959375,1.15 3.15078125,0.95859375 3.4859375,0.95859375 C3.4859375,0.95859375 3.4859375,0.95859375 3.4859375,0.95859375 C3.4859375,0.95859375 14.740625,0.95859375 14.740625,0.95859375 C14.740625,0.95859375 14.740625,6.3703125 14.740625,6.3703125 C14.740625,6.8015625 14.884375,7.13671875 15.171875,7.42421875 C15.459375,7.71171875 15.7945313,7.85546875 16.2257813,7.85546875 C16.2257813,7.85546875 16.2257813,7.85546875 16.2257813,7.85546875 C16.2257813,7.85546875 21.6375,7.85546875 21.6375,7.85546875 L21.6367188,7.8546875 Z"/>
              ...
              ${y(t[0],t[1])}
            </div>`)}}return e&&e.length>0?e:U`<div class='empty'>no attachments found</div>`};let $="Attachments";return void 0!==s&&s.length>0&&($="URL"===s[0].type?"Attach a link":"Attach files"),U`
    <div class="flex layout-content-inline_middle main-header">
      <h2>${$}</h2>
      <div class="flex layout-content-inline_middle margin-l-auto">
        <button type='button' data-action-id='close'
        class="pzhc pzbutton Simple" title="Close">${$t()}</button>
      </div>
    </div>
    ${void 0!==s&&s.length>0?U`
      ...
      @drop="${h}" class='attach-files list-items'>
        <div class="file-upload">
          ...
          ${wt()}<span> Drag and drop files, attach 
  ...
  ${t.map(((t,s)=>{const n=`${e}-${s}`;if(t.layout){""!==t.layout.groupFormat.trim()&&"CENTER"!==t.layout.groupFormat||(t.layout.groupFormat="default");const e=t.layout.groupFormat.replace(/ /g,"_").toLowerCase(),s=`flex content layout-content-${e} content-${e}`;if(t.layout.view&&t.layout.view.groups)return U`
          <div class="${s}">${Zt(t.layout.view.groups,n,a,i)}</div>
        `;if(t.layout.groups){let e="";if("string"==typeof t.layout.title&&""!==t.layout.title&&(t.layout.titleFormat,1))switch(t.layout.titleFormat){case"h2":e=U`<h2>${t.layout.title}</h2>`;break;case"h3":e=U`<h3>${t.layout.title}</h3>`;break;case"h4":e=U`<h4>${t.layout.title}</h4>`;break;default:e=U`<h2>${t.layout.title}</h2>`}return U`
        ${e}<div class="${s}">${Zt(t.layout.groups,n,a,i)}</div>
        `}return t.layout.rows?t.layout.header?((t,e,a)=>U`
  ${qt(t.layout)}
  <table>
    <thead>
      <tr>
        ${Ft(t.layout.header.groups)}
      </tr>
    </thead>
    <tbody>
      ${jt(t.layout.rows)}
...
`,Xt=(t,e,a,i)=>{if(null==i)return null;let s;const n=`${Math.random().toString(36).substr(2,9)}`,r=document.createElement("ul");r.setAttribute("id",`menu-overlay-${n}`),r.setAttribute("role","menu"),r.setAttribute("aria-labelledby",`menubutton-${n}`),r.setAttribute("tabindex","-1");const o=()=>{document.body.removeEventListener("click",c),document.body.removeEventListener("keydown",l),r&&(r.previousElementSibling&&(r.previousElementSibling.setAttribute("aria-expanded","false"),r.previousElementSibling.focus()),r.remove())},l=t=>{38===t.keyCode?(s=s.previousElementSibling,null===s&&(s=r.lastElementChild),s.focus()):40===t.keyCode?(s=s.nextElementSibling,null===s&&(s=r.firstElementChild),s.focus()):27===t.keyCode||9===t.keyCode?o():13===t.keyCode&&(i(t),o())},c=t=>{if(t){let e=t.target;if(t.path&&t.path.length>0?e=t.path[0]:t.originalTarget&&(e=t.originalTarget),e&&e.nextElementSibling===r)return;e.parentNode===r&&i(t),o()}},d=t=>{if("keydown"===t.type&&40!==t.keyCode)return;if(t.preventDefault(),"blur"===t.type)return void c(t);const e=t.target;"BUTTON"!==e.tagName?(i(t),o()):null===e.nextElementSibling?(t.target.parentNode.appendChild(r),e.setAttribute("aria-expanded","true"),L(a(),r),s=e.nextElementSibling.firstElementChild,s.focus(),document.body.addEventListener("click",c),document.body.addEventListener("keydown",l)):o()};return U`
  ...
  `},Gt=(t,e,a,i,s,n,r,o,l)=>{const c=U`${wt()}<span class='count-badge'>${s}</span>`;if(void 0===e.caseID&&a.content)return U`
    <div class="flex layout-content-inline_middle main-header">
      <h2>${a.content.pyLabel} (${a.content.pyID})</h2>
      ${""!==i?U`<span class='badge-bg-info centered'><span class='badge_text'>${i}</span></span>`:""}
      <div class="flex layout-content-inline_middle margin-l-auto">
        ${l?Wt("Attachments",c,"Simple",l):""}
        ${a.actions&&a.actions.length>0?U`
 ...
 <h3>${t}</h3>`},Kt=(t,e,a,i,s)=>U`
  <div class="flex layout-content-stacked">${Zt(t,e,!1,s)}</div>
  ${((t,e)=>U`
  <div class="action-button-area">
...
`)(a,i)}
`,Qt=(t,e,a,i)=>U`
  <div class="flex layout-content-stacked">${Zt(t,e,!0,i)}</div>
  ${(t=>null===t?null:U`
  <div class="action-button-area">
...
`)(a,i)}
`,ee=(t,e,a,i)=>U`
  <div class="flex layout-content-stacked">${Zt(t,e,!1,i)}</div>
  ${(t=>U`
  <div class="action-button-area">
    ${null!==t?U`<button type="button" class="pzhc pzbutton" @click="${t}">Cancel</button>`:""}
...
${t.pxResults.map((t=>U`
  ...
  <div id="case-data">${Bt()}</div>`):""!==this.caseID||""!==this.assignmentID||this.bShowNew?U`
        ${Gt(this.name,this.data,this.casedata,this.casepyStatusWork,this.numAttachments,this.displayActions,this.runAction,this.openCase,"true"===this.bShowAttachments?this.displayAttachments:null)}
        <div class="validation" role="alert" aria-live="assertive">${this.validationMsg}</div>
        <form id="case-data">${Bt()}</form>
      `:"workList"===this.action?(r=this.title,o=this.cases,l=this.displayCasesTypes,c=this.reloadWorkList,d="true"===this.bShowCreate?this.createCase:null,h=this.openCase,U`
  <div class="flex layout-content-inline_middle main-header">
    <h2>
      ${r}
      ${o.length>0?U`
