...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
class St extends class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,a){this._$Ct=t,this._$AM=e,this._$Ci=a}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}{constructor(t){if(super(t),this.it=R,t.type!==xt)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===R||null==t)return this._t=void 0,this.it=t;if(t===M)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}St.directiveName="unsafeHTML",St.resultType=1;const It=(t=>(...e)=>({_$litDirective$:t,values:e}))(St),_t=t=>null!=t?t:R,Et=(t,e)=>{if(t.control&&t.control.actionSets&&t.control.actionSets.length>0)for(const a of t.control.actionSets)if(a.events.length>0&&a.actions.length>0&&a.events[0].event===e){let t=a.actions[0].action;return"refresh"===t&&""!==a.actions[0].refreshFor&&(t+=`-${a.actions[0].refreshFor}`),t}},Tt=t=>"pyTemplateButton"!==t.reference?t.reference:t.control&&t.control.modes?t.control.modes[1].tooltip:null,Lt=(t,e,a)=>{if(void 0===e)return null;const i=t.required&&!0!==t.readOnly?"icon-required":"";return"field-checkbox"===a?""!==t.label||!0===t.showLabel?N`<div class="field-caption dataLabelForWrite ${i}">${ht(t.label)}</div>`:null:"field-text"===a&&!0===t.readOnly&&"pxCheckbox"===t.control.type&&t.control.label?N`<label class="field-caption dataLabelForWrite">${ht(t.control.label)}</label>`:""!==t.label||!0===t.showLabel||!0===t.labelReserveSpace?N`<label class="field-caption dataLabelForWrite ${i}" for="${_t(e)}">${ht(t.label)}</label>`:null},Ut=(t,e,a,i)=>{if(void 0===e||-1!==e.indexOf("-table-"))return"field-checkbox"===a?N`<div class="flex">${i}</div>`:N`
      ${i}
...
`,Ht=(t,e)=>N`
  ...
  />
`,jt=(t,e)=>N`
  <a id="${_t(e)}" data-ref="${t.reference}" href="${t.value}">${t.control.label}</a>
`,Vt=(t,e)=>{const a=Et(t,"click");return"deleteRow"===a?Bt(t,e):N`
  <button
  type='button'
    class="${_t(t.control.modes[1].controlFormat)} pzhc pzbutton"
    id="${_t(e)}"
    data-ref="${_t(Tt(t))}"
    data-action-click="${_t(a)}"
  >${t.control.label}</button>`},Bt=(t,e)=>N`
  <button
    type='button'
...
`,Wt=(t,e)=>{let a=t.value;if(""!==a){const e=dt(a);e instanceof Date&&e.getTime()==e.getTime()?a=`${e.getUTCFullYear()}-${lt(e.getUTCMonth()+1)}-${lt(e.getUTCDate())}T${lt(e.getUTCHours())}:${lt(e.getUTCMinutes())}`:8===t.value.length&&(a=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}T00:00`)}return N`
    ...
    data-action-click="${_t(Et(t,"click"))}"
    />
  `},Zt=(t,e)=>{let a=t.value;if(""!==a){const e=dt(a);e instanceof Date&&e.getTime()==e.getTime()?a=`${e.getUTCFullYear()}-${lt(e.getUTCMonth()+1)}-${lt(e.getUTCDate())}`:8===t.value.length&&(a=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}`)}return N`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="date"
    ...
    data-action-click="${_t(Et(t,"click"))}"
    />
  `},Yt=(t,e)=>{let a=t.value;if(""!==a){const e=dt(a);e instanceof Date&&e.getTime()==e.getTime()?a=`${lt(e.getUTCHours())}-${lt(e.getUTCMinutes())}-${lt(e.getUTCSeconds())}`:8===t.value.length&&(a=`${t.value.substring(9,10)}:${t.value.substring(10,11)}:${t.value.substring(11,12)}`)}return N`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="time"
      ...
      data-action-click="${_t(Et(t,"click"))}"
    />
  `},Jt=(t,e)=>{let a;return t.control&&t.control.modes&&t.control.modes[0].options?a=t.control.modes[0].options:"True-False"===t.type&&(a=[{value:"true"},{value:"false"}]),void 0===a?null:N`
  ...
  data-action-click="${_t(Et(t,"click"))}"
  />
  <label for="${_t(e)}">${t.control.label}</label>
`,Xt=(t,e)=>t.control&&t.control.modes[0]&&t.control.modes[0].options?N`<select
      data-ref="${t.reference}"
      id=${_t(e)}
      ?required="${!0===t.required}"
      data-action-change="${_t(Et(t,"change"))}"
...
`,ie=(t,e,a,i)=>N`
  ${t.map(((t,s)=>{const n=`${e}-${s}`;if(t.layout){""!==t.layout.groupFormat.trim()&&"CENTER"!==t.layout.groupFormat||(t.layout.groupFormat="default");const e=t.layout.groupFormat.replace(/ /g,"_").toLowerCase(),s=`flex content layout-content-${e} content-${e}`;if(t.layout.view&&t.layout.view.groups)return N`
          <div class="${s}">${ie(t.layout.view.groups,n,a,i)}</div>
        ...
        ${e}<div class="${s}">${ie(t.layout.groups,n,a,i)}</div>
  ...
  ${te(t.layout,a)}</div>
`)(t,n,a,i):se(t,n,a,i):null}if(t.paragraph)return N`<div class='flex content-item field-item flex-paragraph'>${It(t.paragraph.value)}</div>`;if(t.caption&&t.caption.visible)return N`<div class='flex content-item field-item flex-paragraph'>${It(t.caption.value)}</div>`;if(t.field){if(t.field.control&&"pxAttachContent"===t.field.control.type){let e="Upload file";return t.field.customAttributes&&t.field.customAttributes.Label&&(e=t.field.customAttributes.Label),wt(e,e,"",i.displayAttachments)}if(t.field.control&&t.field.control.actionSets&&t.field.control.actionSets.length>0&&t.field.control.actionSets[0]&&t.field.control.actionSets[0].actions[0]&&"localAction"===t.field.control.actionSets[0].actions[0].action){const e=i.actionID;return((t,e,a)=>{const i=t.control.actionSets[0].actions[0].actionProcess.localAction,s=t.control.actionSets[0].actions[0].actionProcess.target,n=t.control.modes[1].controlFormat?t.control.modes[1].controlFormat:"";if("modalDialog"===s){const s=a=>{O(Dt(t.control.label,at()),a),e(i,a)};return ot(i,t.control.label,n,s,a)}return N`<div><button type="button" @click="${()=>{e(i)}}" class="pzhc pzbutton ${n}">${i18n.t(t.control.label)}</button></<div>`})(t.field,i.displayLocalAction,(()=>{i.reloadAssignment(e)}))}return Nt(t.field,n,a,i)}return t.view&&t.view.groups?"pyAttachFieldOptional"===t.view.viewID&&"Embed-Attach-File"===t.view.appliesTo?wt("Upload file","Upload file","",i.displayAttachments):ie(t.view.groups,n,a,i):null}))}
`,se=(t,e,a,i)=>N`
  ${Qt(t.layout)}
  <div class="rdl">
    ${ne(t.layout.rows,e,a,i)}
  </div>
  ${te(t.layout,a)}
`,ne=(t,e,a,i)=>N`
  ${t.map(((t,s)=>{const n=`${e}-row${s}`;return t.groups?N`
      ...
      `:null}))}
`,re=(t,e,a,i,s,n,r,o,l,c)=>{const d=N`${nt()}<span class='count-badge'>${s}</span>`;if(void 0===e.caseID&&a.content)return N`
    <div class="flex layout-content-inline_middle main-header">
...
`)(a,i)}
`,le=(t,e,a,i)=>N`
  <div class="flex layout-content-stacked">${ie(t,e,!0,i)}</div>
  ${(t=>null===t?null:N`
  <div class="action-button-area">
...
`)(a)}
`,he=(t,e)=>{const a=[],i=Object.entries(e.actions);for(const e of i)e[1].name!==t&&a.push(N`
...
/**
  ...
  <div id="case-data"></div>`):""!==this.caseID||""!==this.assignmentID||this.bShowNew?N`
      ...
      `:"workList"===this.action?(r=this.title,o=this.cases,l=this.displayCasesTypes,c=this.reloadWorkList,d="true"===this.bShowCreate?this.createCase:null,h=this.openCase,N`
  <div class="flex layout-content-inline_middle main-header">
    <h2>
    ${i18n.t(r)}
      ${o.length>0?N`<span>(${o.length})</span>`:""}
    </h2>
    <div class="flex layout-content-inline_middle margin-l-auto">
      <button type='button' class="pzhc pzbutton Simple"
      title='${i18n.t("Click to refresh the worklist")}' @click="${c}">${i18n.t("Refresh")}</button>
      ${Ct("Create","Create a new case",l,d)}
    </div>
  </div>
  ${o.length>0?N`
...
`)(this.title,this.cases,this.displayCasesTypes,this.reloadWorkList,"true"===this.bShowCreate?this.createCase:null,this.openCase):"dataView"===this.action?((t,e,a,i,s)=>N`
  ...
  ${a.length>0?N`
      ...
      `}
`)(this.title,this.dataviewParams,this.cases,this.reloadWorkList,this.openCase):null):(this.sendData("authenticate",{}),null);var t,e,a,i,s,n,r,o,l,c,d,h}renderMainLayout=(t,e)=>oe(t,e,"true"===this.bShowCancel?this.actionAreaCancel:null,"true"===this.bShowSave?this.actionAreaSave:null,this);renderSaveCaseLayout=(t,e)=>ce(t,e,"true"===this.bShowCancel?this.actionAreaCancel:null,"true"===this.bShowSave?this.actionAreaSave:null,this);renderReviewLayout=(t,e)=>le(t,e,"true"===this.bShowCancel?this.actionAreaCancel:null,this);renderCreateCaseLayout=(t,e)=>de(t,e,"true"===this.bShowCancel?this.actionAreaCancel:null);genPageValidationErrors=t=>(t=>t.errorDetails?N`
    <ul>
