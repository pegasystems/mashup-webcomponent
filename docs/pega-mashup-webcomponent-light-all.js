...
`,Ia=(t,e)=>{const s=ga(t,"click");return"deleteRow"===s?Sa(t,e):E`
  <button
  type='button'
  ...
  >${t.control.label}</button>`},Sa=(t,e)=>E`
  <button
    type='button'
...
`},wi=(t,e)=>{let s=[{value:"true"},{value:"false"}];return t.options&&(s=t.options),E`
  ...
  `},xi=(t,e)=>t.options?E`
    ...
    `:null,Ai=()=>E`
 <a>semantic link</a>
`,Ii=(t,e,s)=>{let a=[];return t.displayvalue&&t.displayvalue.pxResults&&t.displayvalue.pxResults.length>0&&(a=t.displayvalue.pxResults),oa(void 0,a,s.caseID,s)},Si=(t,e)=>E`<input
 class="location"
 data-ref="${t.reference}"
 ?required="${t.requiredstate}"
 ?readonly="${t.readonlystate}"
...
`,Ti=(t,e)=>{if(!e){const e=[];t.config.children[0].children.map(((t,s)=>(e[s]=t.config.value.replace("@P .",""),null)));const s=t.config.referenceList.replace("@P .","");return E`
      <div class="table-action-area">
    ...
    `}return null},Ri=(t,e,s)=>{const a=t.config.referenceList.replace("@P .",""),i=t.config.children[0].children,n=Ks(s.data.data.caseInfo.content,a);return n?E`
  ${n.map(((t,n)=>E`
    <tr>
