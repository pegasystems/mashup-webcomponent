...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" width="20px" height="20px" fill="currentColor">
  ...
  `:null,na=(t,e,s)=>{if(void 0===t||void 0===t.control||void 0===t.control.type)return null;if(t.customAttributes&&"none"===t.customAttributes.display)return null;if(!0===s||!0===t.readOnly||"pxHidden"===t.control.type)return ia(t,e,"field-text",oa(t,e));switch(t.control.type){case"pxPhone":case"pxTextInput":return ia(t,e,"field-textinput",ra(t,e));case"pxInteger":case"pxNumber":return ia(t,e,"field-numberinput",la(t,e));case"pxCurrency":return ia(t,e,"field-currencyinput",da(t,e));case"pxEmail":return ia(t,e,"field-emailinput",ha(t,e));case"pxTextArea":return ia(t,e,"field-textarea",ua(t,e));case"pxRadioButtons":return ia(t,e,"field-radiogroup",ba(t,e));case"pxCheckbox":return ia(t,e,"field-checkbox",wa(t,e));case"pxDropdown":return ia(t,e,"field-dropdown",_a(t,e));case"pxDisplayText":return ia(t,e,"field-text",oa(t,e));case"pxIcon":return ia(t,e,"field-icon",pa(t,e));case"pxLink":case"pxURL":return ia(t,e,"field-url",ga(t,e));case"pxIconDeleteItem":return ia(t,e,"field-button",ma(t,e));case"pxButton":return ia(t,e,"field-button",fa(t,e));case"pxDateTime":return"TimeOfDay"===t.type?ia(t,e,"field-time",va(t,e)):"Date"===t.type?ia(t,e,"field-date",$a(t,e)):ia(t,e,"field-datetime",ya(t,e));case"pxAutoComplete":return ia(t,e,"field-combobox",Ca(t,e));case"pxSlider":return ia(t,e,"field-slider",ca(t,e));default:return null}},oa=(t,e)=>{if("pxDate"===t.control.type){let s=Ms(t.value);if(s)if(t.control&&2===t.control.modes.length){let e={};switch(t.control.modes[1].dateFormat){case"DateTime-Short-YYYY":case"Date-DayMonthYear-Custom":case"Date-Mediun":e={year:"numeric",month:"short",day:"numeric"};break;case"Date-Short":e={year:"numeric",month:"numeric",day:"numeric"};break;case"Date-Long":e={year:"numeric",month:"long",day:"numeric"};break;case"Date-Full":e={weekday:"long",year:"numeric",month:"long",day:"numeric"};break;default:e={}}s=new Intl.DateTimeFormat([],e).format(s)}else s=(new Intl.DateTimeFormat).format(s);else s=t.value;return S`
      <span class="dataValueRead" data-ref="${t.reference}" id="${X(e)}">${s}</span>
    `}if("pxDateTime"===t.control.type){let s=Ms(t.value);if(s)if(t.control&&2===t.control.modes.length){let e={};if("DateTime-Short-YYYY"===t.control.modes[1].dateTimeFormat)e={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};else e={};s=new Intl.DateTimeFormat([],e).format(s)}else s=(new Intl.DateTimeFormat).format(s);else s=t.value;return S`
      <span class="dataValueRead" data-ref="${t.reference}" id="${X(e)}">${s}</span>
    `}if("pxTime"===t.control.type){let s=Ms(t.value);if(s)if(t.control&&2===t.control.modes.length){const t={hour:"numeric",minute:"numeric"};s=new Intl.DateTimeFormat([],t).format(s)}else s=(new Intl.DateTimeFormat).format(s);else s=t.value;return S`
      <span class="dataValueRead" data-ref="${t.reference}" id="${X(e)}">${s}</span>
    `}if("pxHidden"===t.control.type)return S`
    <input type="text" style="display:none" data-ref="${t.reference}" id="${X(e)}" value="${Ls(t.value)}"/>
    `;let s=t.value;if(t.control&&2===t.control.modes.length&&"locallist"===t.control.modes[0].listSource)for(const e of t.control.modes[0].options)e.key===s&&(s=e.value);return"pxCurrency"===t.control.type&&(s=`$${s}`),S`
...
`,fa=(t,e)=>{const s=ea(t,"click");return"deleteRow"===s?ma(t,e):S`
  <button
  type='button'
  ...
  >${t.control.label}</button>`},ma=(t,e)=>S`
  <button
    type='button'
  ...
  >${Gs()}</button>
`,ya=(t,e)=>{let s=t.value;if(""!==s){let e=Ms(s);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),s=`${e.getFullYear()}-${Rs(e.getMonth()+1)}-${Rs(e.getDate())}T${Rs(e.getHours())}:${Rs(e.getMinutes())}`):8===t.value.length&&(s=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}T00:00`)}return S`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="datetime-local"
    ...
    data-action-click="${X(ea(t,"click"))}"
    />
  `},$a=(t,e)=>{let s=t.value;if(""!==s){let e=Ms(s);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),s=`${e.getFullYear()}-${Rs(e.getMonth()+1)}-${Rs(e.getDate())}`):8===t.value.length&&(s=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}`)}return S`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="date"
    ...
    data-action-click="${X(ea(t,"click"))}"
    />
  `},va=(t,e)=>{let s=t.value;if(""!==s){let e=Ms(s);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),s=`${Rs(e.getHours())}-${Rs(e.getMinutes())}-${Rs(e.getSeconds())}`):8===t.value.length&&(s=`${t.value.substring(9,10)}:${t.value.substring(10,11)}:${t.value.substring(11,12)}`)}return S`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="time"
      ...
      data-action-click="${X(ea(t,"click"))}"
    />
  `},ba=(t,e)=>{let s;return t.control&&t.control.modes&&t.control.modes[0].options?s=t.control.modes[0].options:"True-False"===t.type&&(s=[{value:"true"},{value:"false"}]),void 0===s?null:S`
    ${s.map(((s,a)=>{const i=`rb-${e}-${a}`;return S`
        <div>
          <input
            data-ref="${t.reference}"
            name=${X(e)}
...
`,_a=(t,e)=>t.control&&t.control.modes[0]&&t.control.modes[0].options?S`<select
      data-ref="${t.reference}"
      id=${X(e)}
      ?required="${!0===t.required}"
      data-action-change="${X(ea(t,"change"))}"
      ...
      data-action-change="${X(ea(t,"change"))}"
      data-action-click="${X(ea(t,"click"))}">
      </input>`,Ca=(t,e)=>{if(t.control.modes&&t.control.modes[0]&&t.control.modes[0].options)return S`
      <input
        data-ref="${t.reference}"
        list="${t.reference}"
        ?required="${!0===t.required}"
    ...
    `;let s="";return t.control&&t.control.modes&&t.control.modes[0]&&t.control.modes[0].dataPageID&&(s=t.control.modes[0].dataPageID),S`
    <input
      data-ref="${t.reference}"
      list="${t.reference}"
      data-pageid="${s}"
  ...
  `},Da=t=>""!==t.title?S`
    ...
    `:null,ka=(t,e)=>{let s=t.fieldListID;if(void 0!==t.reference&&(s=t.reference),"."===s.charAt(0)&&(s=s.substring(1)),t.newRow&&!0!==e){const e=[];return Ps(t.newRow,e),S`
...
<path d="M14.353125,6.353125 C13.9703125,6.7359375 13.4914062,6.928125 12.9640625,6.928125 C12.4367188,6.928125 11.9585938,6.73671875 11.575,6.353125 C11.1921875,5.9703125 11,5.49140625 11,4.9640625 C11,4.43671875 11.1914062,3.95859375 11.575,3.575 C11.9578125,3.1921875 12.4367188,3 12.9640625,3 C13.4914063,3 13.9695312,3.19140625 14.353125,3.575 C14.7359375,3.9578125 14.928125,4.43671875 14.928125,4.9640625 C14.928125,5.49140625 14.7367187,5.96953125 14.353125,6.353125 Z M14.353125,13.7289063 C13.9703125,14.1117188 13.4914062,14.3039063 12.9640625,14.3039063 C12.4367188,14.3039063 11.9585938,14.1125 11.575,13.7289063 C11.1921875,13.3460938 11,12.8671875 11,12.3398438 C11,11.8125 11.1914062,11.334375 11.575,10.9507813 C11.9578125,10.5679688 12.4367188,10.3757813 12.9640625,10.3757813 C13.4914063,10.3757813 13.9695312,10.5671875 14.353125,10.9507813 C14.7359375,11.3335938 14.928125,11.8125 14.928125,12.3398438 C14.928125,12.8671875 14.7367187,13.3453125 14.353125,13.7289063 Z M14.353125,21.1039062 C13.9703125,21.4867187 13.4914062,21.6789062 12.9640625,21.6789062 C12.4367188,21.6789062 11.9585938,21.4875 11.575,21.1039062 C11.1921875,20.7210938 11,20.2421875 11,19.7148438 C11,19.1875 11.1914062,18.709375 11.575,18.3257813 C11.9578125,17.9429688 12.4367188,17.7507813 12.9640625,17.7507813 C13.4914063,17.7507813 13.9695312,17.9421875 14.353125,18.3257813 C14.7359375,18.7085937 14.928125,19.1875 14.928125,19.7148438 C14.928125,20.2421875 14.7367187,20.7203125 14.353125,21.1039062 Z"></path>
  ...
  </div>`,w=(t,e)=>e.loading?S`${y(t,e)}${Sa()}`:e.editing?"URL"===e.type?S`
    ...
    ${a.attachmentcategories.map((t=>S`
    ...
    `))}
      ...
      aria-label=${i18n.t("Delete")}>${Gs()}</button>`:S`${y(t,e)}
    <button type='button' data-id="${t}" @click="${c}" class='pzhc pzbutton Simple'
    aria-label=${i18n.t("Delete")}>${Gs()}</button>`,_=t=>{if(!s)return Sa();const e=[];if(void 0!==t){const s=Object.entries(t);for(const t of s){let s=t[1].extension;void 0===s&&(s=t[1].type),s||(s=""),s.length>5&&(s=s.substring(0,5)),"URL"===t[1].type&&t[1].editing?e.push(S`<div class='flex layout-content-stacked content-items-maxwidth'>
              ${w(t[0],t[1])}
            </div>`):e.push(S`<div class='row-item'>
              <span class='doc-icon'>${ta()}<span>${s}</span></span>
              ${w(t[0],t[1])}
            </div>`)}}return e&&e.length>0?e:S`<div class='empty'>${i18n.t("no attachments found")}</div>`};if(!t){if(e&&e.length>0&&e[0].pyAttachName){n=0,e[0].extension="";const t=e[0].pyAttachName.split(".");return t.length>1&&(e[0].extension=t[t.length-1]),b(e[0])}return S`<div @dragenter="${h}" @dragover="${h}" @dragleave="${h}"
    ...
    </div>`}if(t&&t.classList.contains("attach-files")){if(i&&i.length>0)return a.sendData.call(a,"uploadattachment",{actionid:i[0],target:t}),C=i[0],D=!0,S`<div class='row-item'>
    <span class='doc-icon'>${ta()}<span>${C.extension}</span></span>
    <div class='list-item-title'><span>${C.displayName}</span>${D?S`<span class="list-item-meta"><span>
    ${i18n.t("Uploading...")}</span></span>`:""}</div>
  </div>`;if(e&&e.length>0)return b(e[0])}var C,D;let k="Attachments";return void 0!==i&&i.length>0&&(k="URL"===i[0].type?"Attach a link":"Attach files"),S`
...
`,Ma=(t,e,s,a)=>S`
  ${t.map(((t,i)=>{const n=`${e}-${i}`;if(t.layout){""!==t.layout.groupFormat.trim()&&"CENTER"!==t.layout.groupFormat||(t.layout.groupFormat="default");const e=t.layout.groupFormat.replace(/ /g,"_").toLowerCase(),i=`flex content layout-content-${e} content-${e}`;if(t.layout.view&&t.layout.view.groups)return S`
        ...
        `}return t.layout.rows?t.layout.header?((t,e,s)=>S`
  ${Da(t.layout)}
  <table>
...
`,La=(t,e,s)=>S`
  ...
  ${ka(t.layout,s)}
`,Ba=(t,e,s)=>S`
  ${t.map(((t,a)=>{const i=`${e}-row${a}`;return t.groups?S`
        <div>
          ${Ma(t.groups,i,s)}
        </div>
      `:null}))}
`,Oa=(t,e,s,a,i,n,o,r,c)=>{const l=S`${Qs()}<span class='count-badge'>${i}</span>`;if(void 0===e.caseID&&s.content)return S`
    <div class="flex layout-content-inline_middle main-header">
      <h2>${s.content.pyLabel} <span>(${s.content.pyID})</span></h2>
      ${""!==a?S`<span class='badge-bg-info centered'><span class='badge_text'>${a}</span></span>`:""}
      <div class="flex layout-content-inline_middle margin-l-auto">
        ${c?Ta("Attachments",l,"Simple",c):""}
        ${s.actions&&s.actions.length>0?S`
...
`,Ua=t=>t.errorDetails?S`
  ...
  `))}
  </ul>`,Fa=(t,e)=>{const s=[],a=Object.entries(e.actions);for(const e of a)e[1].name!==t&&s.push(S`
...
`;class Ja extends Wa{displayContent(){return""!==this.errorMsg?Za(this.errorMsg,"true"===this.bShowCancel?this.resetError:null):"oauth2password"!==this.authentication&&"oauth2clientcredentials"!==this.authentication||""!==this.token?(this.casetypes||"createNewWork"!==this.action&&"workList"!==this.action?""===this.name&&("openAssignment"===this.action&&""===this.assignmentID&&(this.assignmentID=this.caseID),""!==this.assignmentID?this.fetchData("assignment",{id:this.assignmentID}):""!==this.caseID&&this.fetchData("case",{id:this.caseID})):(this.fetchData("casetypes"),"createNewWork"===this.action?(this.bShowNew=!0,this.casetypes[this.casetype]&&this.fetchData("newwork",{id:this.casetype})):"workList"===this.action&&(this.bShowCancel="true",this.fetchData("worklist"))),this.bShowConfirm?Ka(this.casedata.content.pyLabel,this.casedata.content.pyID,this.casepyStatusWork,"true"===this.bShowAttachments?this.displayAttachments:null):""!==this.caseID||""!==this.assignmentID||this.bShowNew?S`
  ...
  />
`,ci=(t,e)=>{let s="";for(const e of t.options)0===t.displayvalue.indexOf(e.pyCallingCode)&&(s=e.pyCallingCode);return t.displayvalue=t.displayvalue.substring(s.length),S`
<div>
<select
  ...
  ${t.options.map((t=>S`<option ?selected=${t.pyCallingCode===s}
...
`,gi=(t,e)=>new ei(Ls(t.displayvalue),t.reference,e),fi=(t,e)=>{const s=t.requiredstate?"icon-required":"";return S`
  <input
  data-ref="${t.reference}"
  ?required="${t.requiredstate}"
  ?readonly="${t.readonlystate}"
...
`},mi=(t,e)=>{let s=[{value:"true"},{value:"false"}];return t.options&&(s=t.options),S`
    ${s.map(((s,a)=>{const i=`rb-${e}-${a}`;return S`
        <div>
          <input
            data-ref="${t.reference}"
  ...
  placeholder="${X(ai(t))}"
    ...
    <input
      ...
      value="${s}"
    />
  `},vi=(t,e)=>{let s=t.displayvalue;if(""!==s){let e=Ms(s);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),s=`${e.getFullYear()}-${Rs(e.getMonth()+1)}-${Rs(e.getDate())}`):8===t.displayvalue.length&&(s=`${t.displayvalue.substring(0,4)}-${t.displayvalue.substring(4,6)}-${t.displayvalue.substring(6,8)}`)}return S`
    <input
      data-ref="${t.reference}"
      ?required="${t.requiredstate}"
      ?readonly="${t.readonlystate}"
      ...
      value="${s}"
    />
  `},bi=(t,e)=>{let s=t.displayvalue;if(""!==s){let e=Ms(s);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),s=`${Rs(e.getHours())}-${Rs(e.getMinutes())}-${Rs(e.getSeconds())}`):8===t.displayvalue.length&&(s=`${t.displayvalue.substring(9,10)}:${t.displayvalue.substring(10,11)}:${t.displayvalue.substring(11,12)}`)}return S`
    <input
      data-ref="${t.reference}"
      ?required="${t.requiredstate}"
      ?readonly="${t.readonlystate}"
  ...
  `},wi=(t,e)=>t.options?S`
    ...
    `:null,_i=()=>S`
 <a>semantic link</a>
`,Ci=(t,e,s)=>{let a=[];return t.displayvalue&&t.displayvalue.pxResults&&t.displayvalue.pxResults.length>0&&(a=t.displayvalue.pxResults),Ra(void 0,a,s.caseID,s)},Di=(t,e)=>S`<input
 class="location"
 data-ref="${t.reference}"
 ?required="${t.requiredstate}"
 ?readonly="${t.readonlystate}"
...
`,xi=(t,e)=>{if(!e){const e=[];t.config.children[0].children.map(((t,s)=>(e[s]=t.config.value.replace("@P .",""),null)));const s=t.config.referenceList.replace("@P .","");return S`
      <div class="table-action-area">
    ...
    `}return null},Ai=(t,e,s)=>{const a=t.config.referenceList.replace("@P .",""),i=t.config.children[0].children,n=s.data.data.caseInfo.content[a];return n?S`
  ${n.map(((t,n)=>S`
    <tr>
    ${i.map((t=>{const i=t,o=i18n.t(t.config.label);return S`
    <td data-title="${o}">${ni(i,void 0,e,s,`${a}(${n+1})`)}</td>`}))}${e?null:S`<td><button type="button" class="pzhc pzbutton Simple"
  aria-label="${i18n.t("Delete item")}" data-ref=${`${a}(${n+1}).pyTemplate`}
  data-action-click='deleteRow'>${Gs()}</button></td>`}
    </tr>`))}
`:null},Si=(t,e,s,a,i)=>{if(void 0===t)return null;if(!t.config||!t.config.template)return S`${t.map(((t,n)=>{const o=`${e}-${n}`;if("Region"===t.type)return Si(t.children,`${e}-0`,!0,a,i);if("reference"===t.type&&"view"===t.config.type){let e="";if(t.config.context&&(e=t.config.context),t.config.inheritedProps&&1===t.config.inheritedProps.length&&"label"===t.config.inheritedProps[0].prop){const n=i18n.t(t.config.inheritedProps[0].value),r=a.data.uiResources.resources.views[t.config.name];if(r){const t="SimpleTable"===r.config.template||"ListView"===r.config.template?"field-table":"field-subview";return S`<div class='flex content-item field-item ${t}'><h4>${n}</h4>${Si(r,o,s,a,""===i?e.substring(1):i+e)}</div>`}}return Si(a.data.uiResources.resources.views[t.config.name],o,s,a,i&&""!==i?i+e:e.substring(1))}return ni(t,o,s,a,i)}))}`;if("SimpleTable"===t.config.template)return((t,e,s)=>{const a=e||"Editable"!==t.config.renderMode;return S`
  <table class='responsive'>
    <thead>
      <tr>
  ...
  ${xi(t,a)}`})(t,s,a);if("ListView"===t.config.template)return((t,e,s)=>(s.sendData("dataviews",{id:t.config.referenceList,content:{paging:{pageNumber:1,pageSize:41}}}),S`
  <table class='responsive'>
    <thead>
      <tr>
    ...
    <tbody>${Sa()}
  ...
  </table>`))(t,s,a);switch("DataReference"===t.config.template&&(a.isDeclarativeTarget=!0),"TwoColumn"===t.config.template&&1===t.children.length&&(t.config.template="OneColumn"),t.config.template){case"TwoColumn":return S`
        ...
        `;default:return null}},Ii=(t,e,s,a,i,n,o,r,c)=>{const l=S`${Qs()}<span class='count-badge'>${i}</span>`;if(void 0===e.caseID&&s.content){const t=s.content.pyID.split(" ")[1];return S`
    <div class="flex layout-content-inline_middle main-header">
...
`;class Ri extends Qa{displayContent(){if(this.bShowSave="false",""!==this.errorMsg){if(-1===this.errorMsg.indexOf("The provided authorization code is expired"))return Za(this.errorMsg,"true"===this.bShowCancel?this.resetError:null);window.history.replaceState({},"","")}if(window.history.state&&window.history.state.token&&(this.token=window.history.state.token),("oauth2password"===this.authentication||"oauth2clientcredentials"===this.authentication)&&""===this.token)return this.sendData("authenticate",{}),null;if("authorizationcode"===this.authentication&&""===this.token)return window.history.state&&window.history.state.code?(this.sendData("authenticate",{}),null):Ga(this.url,this.clientid);if(this.casetypes||"createNewWork"!==this.action&&"workList"!==this.action?"createNewWork"===this.action&&""===this.caseID&&this.casetypes&&this.casetypes[this.casetype]?this.sendData("newwork",{id:this.casetype}):""===this.name&&("openAssignment"===this.action&&""===this.assignmentID&&(this.assignmentID=this.caseID),""!==this.assignmentID?this.fetchData("assignment",{id:this.assignmentID}):""!==this.caseID&&this.fetchData("view",{id:this.caseID,actionid:"pyReview"})):(this.fetchData("portal"),"createNewWork"===this.action?this.bShowNew=!0:"workList"===this.action&&(this.bShowCancel="true")),this.bShowConfirm){const t=this.data.ID.split(" ")[1];return Ka(this.casedata.name,t,this.casepyStatusWork,"true"===this.bShowAttachments?this.displayAttachments:null)}return""!==this.caseID||""!==this.assignmentID||this.bShowNew?S`
    ...
    </ul>`:null)(t);showDataList=t=>ja(t);genActionsList=(t,e)=>((t,e)=>{const s=[],a=Object.entries(e.actions);for(const e of a)e[1].name!==t&&s.push(S`
          <li role="menuitem" tabindex="-1" data-value="${e[1].ID}">${i18n.t(e[1].name)}</li>
        `);return S`
    ${s}
  `})(t,e);displayCasesTypes=()=>(t=>{const e=[],s=Object.entries(t);for(const t of s)e.push(S`
        <li role="menuitem" tabindex="-1" data-value="${t[0]}">${i18n.t(t[1].name)}</li>
      `);return S`
    ${e}
  `})(this.casetypes);genLoadingIndicator=()=>Sa();setInlineError=(t,e)=>{t.setCustomValidity(Ls(e)),t.classList.add("error-field"),t.reportValidity()};validateForm=t=>t.checkValidity();reportFormValidity=t=>t.reportValidity();clickHandler=t=>{let e=t.target;"path"===e.tagName&&(e=e.parentNode),"svg"===e.tagName&&(e=e.parentNode);const s=e.getAttribute("data-action-click");e.classList.contains("combobox")&&!e.classList.contains("loaded")&&this.getData(e.getAttribute("data-pageid"),e),Fs(e,"click")?(this.refreshAssignment(e,js(e,"click")),t.preventDefault()):"BUTTON"===e.tagName&&(t.preventDefault(),null!==e.getAttribute("data-submit")&&"save"!==e.getAttribute("data-submit")?this.submitForm(t,e.getAttribute("data-submit")):("addRow"===s||"deleteRow"===s)&&this.refreshAssignment(e))};changeHandler=t=>{let e=t.target;if(t.path&&t.path.length>0?e=t.path[0]:t.originalTarget&&(e=t.originalTarget),e.setCustomValidity(""),e.classList.remove("error-field"),Fs(e,"change")||this.isDeclarativeTarget)this.refreshAssignment(e,js(e,"change"));else if(this.refreshOnChange){const t=this.getRenderRoot().querySelector("#case-data");Ks(t,this.content,this.pageInstructions,this.data.data.caseInfo.content),R(Ei(this.data.uiResources.resources.views[this.casedata.content.pyViewName],"Obj","true"===this.bShowCancel?this.actionAreaCancel:null,"true"===this.bShowSave?this.actionAreaSave:null,this),t)}};keyupHandler=t=>{const e=t.target;"TEXTAREA"===e.tagName&&(e.style.cssText="height:auto; padding:0;",e.style.cssText=`height:${e.scrollHeight}px`)};focusHandler=t=>{const e=t.target;e.classList.contains("combobox")&&!e.classList.contains("loaded")?this.getData(e.getAttribute("data-pageid"),e):"INPUT"===e.tagName&&e.classList.contains("location")&&!e.classList.contains("pac-target-input")&&window.google&&window.google.maps&&window.google.maps.places&&new window.google.maps.places.Autocomplete(e)};async firstUpdated(){const t=this.getRenderRoot();t&&(t.addEventListener("click",this.clickHandler),t.addEventListener("focusin",this.focusHandler),t.addEventListener("change",this.changeHandler),t.addEventListener("keyup",this.keyupHandler))}}customElements.define("pega-mashup-light-v2",class extends Ri{createRenderRoot(){return this}getRenderRoot(){return this}render(){return S`
      ${this.displayContent()}
    `}})}();
