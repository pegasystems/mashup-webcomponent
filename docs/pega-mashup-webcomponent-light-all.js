...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
class{handleAttributeExpressions(t,e,s,a){const i=e[0];if("."===i){return new I(t,e.slice(1),s).parts}if("@"===i)return[new E(t,e.slice(1),a.eventContext)];if("?"===i)return[new x(t,e.slice(1),s)];return new k(t,e,s).parts}handleTextExpression(t){return new D(t)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const L=(t,...e)=>new w(t,e,"html",B)
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" width="20px" height="20px" fill="currentColor">
  ...
  `:null,ua=(t,e,s)=>{if(void 0===t||void 0===t.control||void 0===t.control.type)return null;if(t.customAttributes&&"none"===t.customAttributes.display)return null;if(!0===s||!0===t.readOnly||"pxHidden"===t.control.type)return ha(t,e,"field-text",pa(t,e));switch(t.control.type){case"pxPhone":case"pxTextInput":return ha(t,e,"field-textinput",ga(t,e));case"pxInteger":case"pxNumber":return ha(t,e,"field-numberinput",ma(t,e));case"pxCurrency":return ha(t,e,"field-currencyinput",ya(t,e));case"pxEmail":return ha(t,e,"field-emailinput",ba(t,e));case"pxTextArea":return ha(t,e,"field-textarea",va(t,e));case"pxRadioButtons":return ha(t,e,"field-radiogroup",xa(t,e));case"pxCheckbox":return ha(t,e,"field-checkbox",Ia(t,e));case"pxDropdown":return ha(t,e,"field-dropdown",Aa(t,e));case"pxDisplayText":return ha(t,e,"field-text",pa(t,e));case"pxIcon":return ha(t,e,"field-icon",$a(t,e));case"pxLink":case"pxURL":return ha(t,e,"field-url",wa(t,e));case"pxIconDeleteItem":return ha(t,e,"field-button",Ca(t,e));case"pxButton":return ha(t,e,"field-button",_a(t,e));case"pxDateTime":return"TimeOfDay"===t.type?ha(t,e,"field-time",Da(t,e)):"Date"===t.type?ha(t,e,"field-date",Sa(t,e)):ha(t,e,"field-datetime",ka(t,e));case"pxAutoComplete":return ha(t,e,"field-combobox",Ta(t,e));case"pxSlider":return ha(t,e,"field-slider",fa(t,e));default:return null}},pa=(t,e)=>{if("pxDate"===t.control.type){let s=Hs(t.value);if(s)if(t.control&&2===t.control.modes.length){let e={};switch(t.control.modes[1].dateFormat){case"DateTime-Short-YYYY":case"Date-DayMonthYear-Custom":case"Date-Mediun":e={year:"numeric",month:"short",day:"numeric"};break;case"Date-Short":e={year:"numeric",month:"numeric",day:"numeric"};break;case"Date-Long":e={year:"numeric",month:"long",day:"numeric"};break;case"Date-Full":e={weekday:"long",year:"numeric",month:"long",day:"numeric"};break;default:e={}}s=new Intl.DateTimeFormat([],e).format(s)}else s=(new Intl.DateTimeFormat).format(s);else s=t.value;return L`
    ...
    `}if("pxDateTime"===t.control.type){let s=Hs(t.value);if(s)if(t.control&&2===t.control.modes.length){let e={};switch(t.control.modes[1].dateTimeFormat){case"DateTime-Short-YYYY":e={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};break;default:e={}}s=new Intl.DateTimeFormat([],e).format(s)}else s=(new Intl.DateTimeFormat).format(s);else s=t.value;return L`
      <span class="dataValueRead" data-ref="${t.reference}" id="${st(e)}">${s}</span>
    `}if("pxTime"===t.control.type){let s=Hs(t.value);if(s)if(t.control&&2===t.control.modes.length){const t={hour:"numeric",minute:"numeric"};s=new Intl.DateTimeFormat([],t).format(s)}else s=(new Intl.DateTimeFormat).format(s);else s=t.value;return L`
      <span class="dataValueRead" data-ref="${t.reference}" id="${st(e)}">${s}</span>
...
`,_a=(t,e)=>{const s=ca(t,"click");return"deleteRow"===s?Ca(t,e):L`
  <button
  type='button' 
  ...
  >${t.control.label}</button>`},Ca=(t,e)=>L`
  <button
    type='button' 
  ...
  >${na()}</button>
`,ka=(t,e)=>{let s=t.value;if(""!==s){let e=Hs(s);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),s=`${e.getFullYear()}-${qs(e.getMonth()+1)}-${qs(e.getDate())}T${qs(e.getHours())}:${qs(e.getMinutes())}`):8===t.value.length&&(s=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}T00:00`)}return L`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="datetime-local"
    ...
    data-action-click="${st(ca(t,"click"))}"
    />
  `},Sa=(t,e)=>{let s=t.value;if(""!==s){let e=Hs(s);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),s=`${e.getFullYear()}-${qs(e.getMonth()+1)}-${qs(e.getDate())}`):8===t.value.length&&(s=`${t.value.substring(0,4)}-${t.value.substring(4,6)}-${t.value.substring(6,8)}`)}return L`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="date"
    ...
    data-action-click="${st(ca(t,"click"))}"
    />
  `},Da=(t,e)=>{let s=t.value;if(""!==s){let e=Hs(s);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),s=`${qs(e.getHours())}-${qs(e.getMinutes())}-${qs(e.getSeconds())}`):8===t.value.length&&(s=`${t.value.substring(9,10)}:${t.value.substring(10,11)}:${t.value.substring(11,12)}`)}return L`
    <input
      data-ref="${t.reference}"
      ?required="${!0===t.required}"
      type="time"
      ...
      data-action-click="${st(ca(t,"click"))}"
    />
  `},xa=(t,e)=>{let s;return t.control&&t.control.modes&&t.control.modes[0].options?s=t.control.modes[0].options:"True-False"===t.type&&(s=[{value:"true"},{value:"false"}]),void 0===s?null:L`
    ${s.map(((s,a)=>{const i=`rb-${e}-${a}`;return L`
        <div>
          <input
            data-ref="${t.reference}"
            name=${st(e)}
...
`,Aa=(t,e)=>t.control&&t.control.modes[0]&&t.control.modes[0].options?L`<select
      data-ref="${t.reference}"
      id=${st(e)}
      ?required="${!0===t.required}"
      data-action-change="${st(ca(t,"change"))}"
      ...
      data-action-change="${st(ca(t,"change"))}"
      data-action-click="${st(ca(t,"click"))}">
      </input>`,Ta=(t,e)=>{if(t.control.modes&&t.control.modes[0]&&t.control.modes[0].options)return L`
      <input
        data-ref="${t.reference}"
        list="${t.reference}"
        ?required="${!0===t.required}"
  ...
  `},Ea=t=>""!==t.title?L`
    ...
    `:null,Ra=(t,e)=>{let s=t.fieldListID;if(void 0!==t.reference&&(s=t.reference),"."===s.charAt(0)&&(s=s.substring(1)),t.newRow&&!0!==e){const e=[];return Ks(t.newRow,e),L`
      <div class="table-action-area">
        ${"add-row"===t.testID?L`<button type="button" class="pzhc pzbutton Simple" data-newrow="${st(e.join())}"
...
<path d="M14.353125,6.353125 C13.9703125,6.7359375 13.4914062,6.928125 12.9640625,6.928125 C12.4367188,6.928125 11.9585938,6.73671875 11.575,6.353125 C11.1921875,5.9703125 11,5.49140625 11,4.9640625 C11,4.43671875 11.1914062,3.95859375 11.575,3.575 C11.9578125,3.1921875 12.4367188,3 12.9640625,3 C13.4914063,3 13.9695312,3.19140625 14.353125,3.575 C14.7359375,3.9578125 14.928125,4.43671875 14.928125,4.9640625 C14.928125,5.49140625 14.7367187,5.96953125 14.353125,6.353125 Z M14.353125,13.7289063 C13.9703125,14.1117188 13.4914062,14.3039063 12.9640625,14.3039063 C12.4367188,14.3039063 11.9585938,14.1125 11.575,13.7289063 C11.1921875,13.3460938 11,12.8671875 11,12.3398438 C11,11.8125 11.1914062,11.334375 11.575,10.9507813 C11.9578125,10.5679688 12.4367188,10.3757813 12.9640625,10.3757813 C13.4914063,10.3757813 13.9695312,10.5671875 14.353125,10.9507813 C14.7359375,11.3335938 14.928125,11.8125 14.928125,12.3398438 C14.928125,12.8671875 14.7367187,13.3453125 14.353125,13.7289063 Z M14.353125,21.1039062 C13.9703125,21.4867187 13.4914062,21.6789062 12.9640625,21.6789062 C12.4367188,21.6789062 11.9585938,21.4875 11.575,21.1039062 C11.1921875,20.7210938 11,20.2421875 11,19.7148438 C11,19.1875 11.1914062,18.709375 11.575,18.3257813 C11.9578125,17.9429688 12.4367188,17.7507813 12.9640625,17.7507813 C13.4914063,17.7507813 13.9695312,17.9421875 14.353125,18.3257813 C14.7359375,18.7085937 14.928125,19.1875 14.928125,19.7148438 C14.928125,20.2421875 14.7367187,20.7203125 14.353125,21.1039062 Z"></path>
  ...
  </div>`,w=(t,e)=>e.loading?L`${y(t,e)}${Ma()}`:e.editing?"URL"===e.type?L`
    ...
    ${a.attachmentcategories.map((t=>L`
    ...
    `))}
      ...
      aria-label=${i18n.t("Delete")}>${na()}</button>`:L`${y(t,e)}
    <button type='button' data-id="${t}" @click="${c}" class='pzhc pzbutton Simple' 
    aria-label=${i18n.t("Delete")}>${na()}</button>`,_=t=>{if(!s)return Ma();const e=[];if(void 0!==t){const s=Object.entries(t);for(const t of s){let s=t[1].extension;void 0===s&&(s=t[1].type),s||(s=""),s.length>5&&(s=s.substring(0,5)),"URL"===t[1].type&&t[1].editing?e.push(L`<div class='flex layout-content-stacked content-items-maxwidth'>
              ${w(t[0],t[1])}
            </div>`):e.push(L`<div class='row-item'>
              <span class='doc-icon'>${oa()}<span>${s}</span></span>
              ${w(t[0],t[1])}
            </div>`)}}return e&&e.length>0?e:L`<div class='empty'>${i18n.t("no attachments found")}</div>`};if(!t){if(e&&e.length>0&&e[0].pyAttachName){n=0,e[0].extension="";const t=e[0].pyAttachName.split(".");return t.length>1&&(e[0].extension=t[t.length-1]),$(e[0])}return L`<div @dragenter="${h}" @dragover="${h}" @dragleave="${h}"  
    ...
    </div>`}if(t&&t.classList.contains("attach-files")){if(i&&i.length>0)return a.sendData.call(a,"uploadattachment",{actionid:i[0],target:t}),C=i[0],k=!0,L`<div class='row-item'>
  ...
  </div>`;if(e&&e.length>0)return $(e[0])}var C,k;let S="Attachments";return void 0!==i&&i.length>0&&(S="URL"===i[0].type?"Attach a link":"Attach files"),L`
...
`,Ha=(t,e,s,a)=>L`
  ${t.map(((t,i)=>{const n=`${e}-${i}`;if(t.layout){""!==t.layout.groupFormat.trim()&&"CENTER"!==t.layout.groupFormat||(t.layout.groupFormat="default");const e=t.layout.groupFormat.replace(/ /g,"_").toLowerCase(),i=`flex content layout-content-${e} content-${e}`;if(t.layout.view&&t.layout.view.groups)return L`
  ...
  ${Ra(t.layout,s)}
`)(t,0,s):Ua(t,n,s):null}if(t.field){if(t.field.control&&"pxAttachContent"===t.field.control.type)return La("Upload file","Upload file","",a.displayAttachments);if(t.field.control&&t.field.control.actionSets&&t.field.control.actionSets.length>0&&t.field.control.actionSets[0]&&t.field.control.actionSets[0].actions[0]&&"localAction"===t.field.control.actionSets[0].actions[0].action){const e=a.actionID;return((t,e,s)=>{const a=t.control.actionSets[0].actions[0].actionProcess.localAction,i=t.control.actionSets[0].actions[0].actionProcess.target,n=t.control.modes[1].controlFormat?t.control.modes[1].controlFormat:"";if("modalDialog"===i){const i=s=>{P(qa(t.control.label,Ma()),s),e(a,s)};return Pa(a,t.control.label,n,i,s)}return L`<div><button type="button" @click="${()=>{e(a)}}" class="pzhc pzbutton ${n}">${i18n.t(t.control.label)}</button></<div>`})(t.field,a.displayLocalAction,(()=>{a.reloadAssignment(e)}))}return ua(t.field,n,s)}return t.view&&t.view.groups?"pyAttachFieldOptional"===t.view.viewID&&"Embed-Attach-File"===t.view.appliesTo?La("Upload file","Upload file","",a.displayAttachments):Ha(t.view.groups,n,s,a):null}))}
`,Ua=(t,e,s)=>L`
  ${Ea(t.layout)}
  <div class="rdl">
  ...
  ${Ra(t.layout,s)}
`,Fa=(t,e,s)=>L`
  ${t.map(((t,a)=>{const i=`${e}-row${a}`;return t.groups?L`
        <div>
          ${Ha(t.groups,i,s)}
        </div>
      `:null}))}
`,Va=(t,e,s,a,i,n,r,o,c)=>{const l=L`${ra()}<span class='count-badge'>${i}</span>`;if(void 0===e.caseID&&s.content)return L`
    <div class="flex layout-content-inline_middle main-header">
      <h2>${s.content.pyLabel} (${s.content.pyID})</h2>
      ${""!==a?L`<span class='badge-bg-info centered'><span class='badge_text'>${a}</span></span>`:""}
      <div class="flex layout-content-inline_middle margin-l-auto">
        ${c?La("Attachments",l,"Simple",c):""}
        ${s.actions&&s.actions.length>0?L`
          ${Ba("Actions","Start a new action",n,r)}`:""}
      </div>
    </div>
    ${((t,e)=>t&&0!==t.length?L`
  <h3>
  ...
  <table>
    ...
    <h3>Case information</h3>`;if(""===t||void 0===e.caseID)return"";const d=e.caseID.split(" ")[1];return L`
  <div class="flex layout-content-inline_middle main-header">
    <h2>${e.name} (${d})</h2>
    ${""!==a?L`<span class='badge-bg-info centered'><span class='badge_text'>${a}</span></span>`:""}
    <div class="flex layout-content-inline_middle margin-l-auto">
...
`,Ja=t=>t.errorDetails?L`
  ...
  `))}
  </ul>`,Za=(t,e)=>{const s=[],a=Object.entries(e.actions);for(const e of a)e[1].name!==t&&s.push(L`
...
`;class ai extends Qa{displayContent(){return""!==this.errorMsg?ei(this.errorMsg,"true"===this.bShowCancel?this.resetError:null):"oauth2password"!==this.authentication&&"oauth2clientcredentials"!==this.authentication||""!==this.token?(this.casetypes||"createNewWork"!==this.action&&"workList"!==this.action?""===this.name&&("openAssignment"===this.action&&""===this.assignmentID&&(this.assignmentID=this.caseID),""!==this.assignmentID?this.fetchData("assignment",{id:this.assignmentID}):""!==this.caseID&&this.fetchData("case",{id:this.caseID})):(this.fetchData("casetypes"),"createNewWork"===this.action?(this.bShowNew=!0,this.casetypes[this.casetype]&&this.fetchData("newwork",{id:this.casetype})):"workList"===this.action&&(this.bShowCancel="true",this.fetchData("worklist"))),this.bShowConfirm?ti(this.casedata.content.pyLabel,this.casedata.content.pyID,this.casepyStatusWork,"true"===this.bShowAttachments?this.displayAttachments:null):""!==this.caseID||""!==this.assignmentID||this.bShowNew?L`
  ...
  `})(this.casetypes);displayActions=()=>this.data.actions?Za(this.name,this.data):this.casedata.actions?Za(this.name,this.casedata):null;displayAttachments=t=>{this.fetchData("attachmentcategories",{id:this.caseID}),this.fetchData("attachments",{id:this.caseID,target:t})};displayLocalAction=(t,e)=>{const s=this.getRenderRoot().querySelector("#case-data");if(s&&(ta(s,this.content,this.pageInstructions,this.casedata.content),""!==this.assignmentID)){const s=this;this.sendData("savecase",{id:this.caseID},(()=>{this.actionID=t,s.fetchData("assignmentaction",{id:this.assignmentID,actionid:t,target:e})}))}};reloadAssignment=t=>{this.actionID=t,this.fetchData("assignmentaction",{id:this.assignmentID,actionid:t})};submitForm=(t,e)=>{if(t.preventDefault(),t.target&&null!==t.target.closest(".mashup-modal")){const e=t.target.closest("#modalcontent");ta(e,this.content,this.pageInstructions,this.casedata.content),e.checkValidity()?this.sendData("submitassignment",{id:this.data.ID,actionid:this.actionID,target:e}):e.reportValidity()}else{const t=this.getRenderRoot().querySelector("#case-data");ta(t,this.content,this.pageInstructions,this.casedata.content),t.checkValidity()?"create"!==e?this.sendData("submitassignment",{id:this.data.ID,actionid:this.actionID}):this.sendData("newwork",{id:this.casetype}):t.reportValidity()}return!1};createCase=t=>{if(this.name="New Case",this.bShowNew=!0,t){let e=t.target;t.path&&t.path.length>0?e=t.path[0]:t.originalTarget&&(e=t.originalTarget),e&&(this.casetype=e.getAttribute("data-value"),this.name=`New ${e.textContent} `)}this.content=this.initialContent,this.pageInstructions=[],this.caseID="",this.data={},this.casedata={},this.casetypes[this.casetype]?"true"===this.casetypes[this.casetype].requiresFieldsToCreate?this.fetchData("newwork",{id:this.casetype}):this.sendData("newwork",{id:this.casetype}):(this.errorMsg=`Case '${this.casetype}' is not defined`,console.error(`Case '${this.casetype}' is not defined`)),this.requestUpdate()};runAction=t=>{let e=t.target;t.path&&t.path.length>0?e=t.path[0]:t.originalTarget&&(e=t.originalTarget),e&&null!==e.getAttribute("data-value")&&(this.actionID=e.getAttribute("data-value"),this.actionRefresh());const s=this.getRenderRoot().querySelector("#case-data");null!=s&&P(Ma(),s)};openCase=t=>{t.preventDefault(),this.caseID=t.target.getAttribute("data-id"),this.name="",this.data={},this.casedata={},0===this.caseID.indexOf("ASSIGN-WORKLIST")?(this.assignmentID=this.caseID,this.caseID=""):this.assignmentID="";const e=this.getRenderRoot().querySelector("#case-data");null!=e&&P(Ma(),e),this.requestUpdate()};getData=(t,e)=>{this.dataPages[t]?P(Ya(this.dataPages[t]),e.nextElementSibling):this.fetchData("data",{id:t,element:e})};refreshAssignment=(t,e)=>{const s=this.getRenderRoot().querySelector("#case-data");let a=t;if(s){if(ta(s,this.content,this.pageInstructions,this.casedata.content),a){"path"===a.tagName&&(a=a.parentNode),"svg"===a.tagName&&(a=a.parentNode);const t=a.getAttribute("data-action-click"),e=a.getAttribute("data-ref");if(null!==e&&null!==t)if("addRow"===t){const t=Xs(this.casedata.content,e,a.getAttribute("data-newrow"));null!==t&&this.pageInstructions.push(t)}else if("deleteRow"===t){const t=Js(this.casedata.content,e);null!==t&&this.pageInstructions.push(t)}}!0===this.bShowNew?this.sendData("refreshnew",{id:this.casetype,refreshFor:e}):this.sendData("refreshassignment",{id:this.assignmentID,actionid:this.actionID,refreshFor:e})}};clickHandler=t=>{let e=t.target;"path"===e.tagName&&(e=e.parentNode),"svg"===e.tagName&&(e=e.parentNode);const s=e.getAttribute("data-action-click");e.classList.contains("combobox")&&!e.classList.contains("loaded")&&this.getData(e.getAttribute("data-pageid"),e),Zs(e,"click")?(this.refreshAssignment(e,Ys(e,"click")),t.preventDefault()):"BUTTON"===e.tagName&&(t.preventDefault(),null!==e.getAttribute("data-submit")&&"save"!==e.getAttribute("data-submit")?this.submitForm(t,e.getAttribute("data-submit")):("addRow"===s||"deleteRow"===s)&&this.refreshAssignment(e))};changeHandler=t=>{let e=t.target;t.path&&t.path.length>0?e=t.path[0]:t.originalTarget&&(e=t.originalTarget),e.setCustomValidity(""),e.classList.remove("error-field"),Zs(e,"change")&&this.refreshAssignment(e,Ys(e,"change"))};keyupHandler=t=>{const e=t.target;"TEXTAREA"===e.tagName&&(e.style.cssText="height:auto; padding:0;",e.style.cssText=`height:${e.scrollHeight}px`)};focusHandler=t=>{const e=t.target;e.classList.contains("combobox")&&!e.classList.contains("loaded")&&this.getData(e.getAttribute("data-pageid"),e)};async firstUpdated(){const t=this.getRenderRoot();t&&(t.addEventListener("click",this.clickHandler),t.addEventListener("focusin",this.focusHandler),t.addEventListener("change",this.changeHandler),t.addEventListener("keyup",this.keyupHandler))}}customElements.define("pega-mashup-light",class extends ai{createRenderRoot(){return this}getRenderRoot(){return this}render(){return L`
    ...
    ${e.values.map((t=>L` <option value=${t.value}>${t.name}</option>`))}
        ...
        `))}
    `}}customElements.define("rich-text-editor",ri);const oi=(t,e)=>{if(t.helperText&&""!==t.helperText)return`${e}-info`},ci=t=>{if(t.placeholder&&""!==t.placeholder)return t.displayplaceholder},li=(t,e,s,a)=>void 0===e||""===e?L`
      ${a}
    `:L`
    <div class="flex content-item field-item ${s}" ?disabled="${t.disabledstate}">
      ${((t,e,s)=>{if(void 0===e)return null;const a=t.requiredstate?"icon-required":"";return"field-checkbox"===s?t.label&&""!==t.label?L`<legend class="field-caption">${t.displaylabel}</legend>`:null:L`
    ${""!==t.label?L`<label class="field-caption dataLabelForWrite ${a}" 
    for="${st(e)}">${t.displaylabel}
    </label>`:null}
  `})(t,e,s)}${a}${((t,e)=>t.helperText&&""!==t.helperText?L`<span id=${`${e}-info`} class="helper-text">${t.displayhelperText}</span>`:null)(t,e)}
    </div>
  `,di=(t,e,s,a,i)=>{if(!1===t.config.visibility)return null;let n=!1;if(t.config.displayvalue="",t.config.displaylabel=i18n.t(t.config.label),t.config.displayplaceholder=i18n.t(t.config.placeholder),t.config.displayhelperText=i18n.t(t.config.helperText),t.config.displaycaption=i18n.t(t.config.caption),t.config.value){let e=t.config.value.replace("@P .","");if(t.config.reference=void 0===i||""===i?e:`${i}.${e}`,t.config.displayvalue=js(a.casedata.content,t.config.reference),"string"==typeof t.config.datasource&&0===t.config.datasource.indexOf("@ASSOCIATED")){e=t.config.datasource.replace("@ASSOCIATED .","");let s="";a.data.context_data?s=a.data.context_data.content:a.data.uiResources.context_data&&a.data.uiResources.context_data.caseInfo&&a.data.uiResources.context_data.caseInfo.content&&(s=a.data.uiResources.context_data.caseInfo.content);const n=""===i?s:js(s,i);if(n&&(t.config.options=n.summary_of_associated_lists__[e]),void 0===t.config.options&&(s=a.data.uiResources.resources.fields[e],s&&s.datasource))if(s.datasource.records)t.config.options=s.datasource.records;else if(s.datasource.name&&a.data.data.shared[s.datasource.name]){const e=a.data.data.shared[s.datasource.name];if(Object.keys(e).length>0){const a=Object.keys(e)[0];if(e[a].pxResults){const i=s.datasource.propertyForValue.replace("@P .",""),n=s.datasource.propertyForDisplayText.replace("@P .","");t.config.options=[];for(const s in e[a].pxResults){const r=e[a].pxResults[s];t.config.options[s]={key:r[i],value:r[n]}}}}}}else if("object"==typeof t.config.datasource&&t.config.datasource.source&&0===t.config.datasource.source.indexOf("@DATASOURCE")){const e=t.config.datasource.source.replace("@DATASOURCE ","").replace(".pxResults","");if(a.data.data[e]&&a.data.data[e].pxResults)t.config.options=a.data.data[e].pxResults;else if(a.data.uiResources.context_data&&a.data.uiResources.context_data.caseInfo&&a.data.uiResources.context_data.caseInfo.content){const s=a.data.uiResources.context_data.caseInfo.content;if(s[i]&&s[i].summary_of_lists__[e]&&s[i].summary_of_lists__[e].pxResults){const n=s[i].summary_of_lists__[e].pxResults.replace(".pxResults","");if(a.data.data[n]&&a.data.data[n].pxResults){t.config.options=[];const e=t.config.datasource.fields.key.replace("@P .",""),s=t.config.datasource.fields.text.replace("@P .","");for(const i in a.data.data[n].pxResults){const r=a.data.data[n].pxResults[i];t.config.options[i]={key:r[e],value:r[s]}}}}}}t.config.options||(t.config.options=[]),t.config.displayvalue?"object"!=typeof t.config.displayvalue&&(t.config.displayvalue=`${t.config.displayvalue}`):t.config.displayvalue="",a.data.uiResources&&a.data.uiResources.resources&&a.data.uiResources.resources.fields&&a.data.uiResources.resources.fields[e]&&a.data.uiResources.resources.fields[e].isDeclarativeTarget&&(n=!0,a.isDeclarativeTarget=!0)}if(!0===s)return li(t.config,e,"field-text",hi(t.config,t.type,e));"string"!=typeof t.config.visibility&&"string"!=typeof t.config.readOnly&&"string"!=typeof t.config.disabled&&"string"!=typeof t.config.required||(a.refreshOnChange=!0);const r=a.data.data.caseInfo.content;if("string"==typeof t.config.visibility&&"true"!==t.config.visibility){if(!Qs(t.config.visibility,r))return null}else if(!1===t.config.visibility||"false"===t.config.visibility)return null;switch(t.config.readonlystate=!1,"string"==typeof t.config.readOnly&&"false"!==t.config.readOnly?t.config.readonlystate=Qs(t.config.readOnly,r):(!0===t.config.readOnly||"true"===t.config.readOnly||n)&&(t.config.readonlystate=!0),t.config.requiredstate=!1,"string"==typeof t.config.required&&"false"!==t.config.required?t.config.requiredstate=Qs(t.config.required,r):!0!==t.config.required&&"true"!==t.config.required||(t.config.requiredstate=!0),t.config.disabledstate=!1,"string"==typeof t.config.disabled&&"false"!==t.config.disabled?t.config.disabledstate=Qs(t.config.disabled,r):!0!==t.config.disabled&&"true"!==t.config.disabled||(t.config.disabledstate=!0),t.config.disabledstate&&(t.config.requiredstate=!1,t.config.readonlystate=!1),t.type){case"Decimal":case"TextInput":return li(t.config,e,"field-textinput",ui(t.config,e));case"Phone":return li(t.config,e,"field-phoneinput",pi(t.config,e));case"Email":return li(t.config,e,"field-emailinput",yi(t.config,e));case"Integer":return li(t.config,e,"field-numberinput",gi(t.config,e));case"Percentage":return li(t.config,e,"field-percentage",fi(t.config,e));case"Currency":return li(t.config,e,"field-currencyinput",mi(t.config,e));case"RadioButtons":return li(t.config,e,"field-radiogroup",wi(t.config,e));case"TextArea":return li(t.config,e,"field-textarea",bi(t.config,e));case"RichText":return li(t.config,e,"field-richtext",vi(t.config,e));case"Checkbox":return li(t.config,e,"field-checkbox",$i(t.config,e));case"Dropdown":return li(t.config,e,"field-dropdown",_i(t.config,e));case"DateTime":return li(t.config,e,"field-datetime",Ci(t.config,e));case"Date":return li(t.config,e,"field-date",ki(t.config,e));case"Time":return li(t.config,e,"field-time",Si(t.config,e));case"AutoComplete":return li(t.config,e,"field-autocomplete",Di(t.config,e));case"SemanticLink":return li(t.config,e,"field-semanticlink",xi(t.config));case"Attachment":return li(t.config,e,"field-attachment",Ii(t.config,e,a));case"Location":return li(t.config,e,"field-location",Ai(t.config,e));default:return null}},hi=(t,e,s)=>{let a=t.displayvalue;if(""!==a){if("Phone"===e)return L`<a data-ref="${t.reference}" id="${st(s)}" href="${`tel:${a}`}">${a}</a>`;if("Date"===e){const e={year:"numeric",month:"short",day:"numeric"};a=new Intl.DateTimeFormat([],e).format(new Date(t.displayvalue))}else if("DateTime"===e){a=Hs(t.displayvalue);const e={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};a=new Intl.DateTimeFormat([],e).format(new Date(t.displayvalue))}else if("Time"===e){const e={hour:"numeric",minute:"numeric"};a=new Intl.DateTimeFormat([],e).format(new Date(t.displayvalue))}}return L`
  ...
  <input
    ...
    placeholder="${st(ci(t))}"
    type="text"
    aria-describedby="${st(oi(t,e))}"
    id="${st(e)}"
    value="${Us(t.displayvalue)}"
  />
`,pi=(t,e)=>{let s="";for(const e of t.options)0===t.displayvalue.indexOf(e.pyCallingCode)&&(s=e.pyCallingCode);return t.displayvalue=t.displayvalue.substring(s.length),L`
<div> 
<select
  ...
  ${t.options.map((t=>L`<option ?selected=${t.pyCallingCode===s} 
...
`,vi=(t,e)=>new ri(Us(t.displayvalue),t.reference,e),$i=(t,e)=>{const s=t.requiredstate?"icon-required":"";return L`
  <input
  data-ref="${t.reference}"
  ?required="${t.requiredstate}"
  ?readonly="${t.readonlystate}"
...
`},wi=(t,e)=>{let s=[{value:"true"},{value:"false"}];return t.options&&(s=t.options),L`
    ${s.map(((s,a)=>{const i=`rb-${e}-${a}`;return L`
        <div>
          <input
            data-ref="${t.reference}"
  ...
  placeholder="${st(ci(t))}"
    ...
    <input
      ...
      value="${s}"
    />
  `},ki=(t,e)=>{let s=t.displayvalue;if(""!==s){let e=Hs(s);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),s=`${e.getFullYear()}-${qs(e.getMonth()+1)}-${qs(e.getDate())}`):8===t.displayvalue.length&&(s=`${t.displayvalue.substring(0,4)}-${t.displayvalue.substring(4,6)}-${t.displayvalue.substring(6,8)}`)}return L`
    <input
      data-ref="${t.reference}"
      ?required="${t.requiredstate}"
      ?readonly="${t.readonlystate}"
      ...
      value="${s}"
    />
  `},Si=(t,e)=>{let s=t.displayvalue;if(""!==s){let e=Hs(s);e instanceof Date&&e.getTime()==e.getTime()?(e=new Date(e.getTime()+6e4*e.getTimezoneOffset()),s=`${qs(e.getHours())}-${qs(e.getMinutes())}-${qs(e.getSeconds())}`):8===t.displayvalue.length&&(s=`${t.displayvalue.substring(9,10)}:${t.displayvalue.substring(10,11)}:${t.displayvalue.substring(11,12)}`)}return L`
    <input
      data-ref="${t.reference}"
      ?required="${t.requiredstate}"
      ?readonly="${t.readonlystate}"
  ...
  `},Di=(t,e)=>t.options?L`
    ...
    `:null,xi=()=>L`
 <a>semantic link</a>
`,Ii=(t,e,s)=>{let a=[];return t.displayvalue&&t.displayvalue.pxResults&&t.displayvalue.pxResults.length>0&&(a=t.displayvalue.pxResults),Oa(void 0,a,s.caseID,s)},Ai=(t,e)=>L`<input
 class="location"
 data-ref="${t.reference}"
 ?required="${t.requiredstate}"
 ?readonly="${t.readonlystate}"
...
`,Ei=(t,e)=>{if(!e){const e=[];t.config.children[0].children.map(((t,s)=>(e[s]=t.config.value.replace("@P .",""),null)));const s=t.config.referenceList.replace("@P .","");return L`
      <div class="table-action-area">
    ...
    `}return null},Ri=(t,e,s)=>{const a=t.config.referenceList.replace("@P .",""),i=t.config.children[0].children,n=s.data.data.caseInfo.content[a];return n?L`
  ${n.map(((t,n)=>L`
    <tr>
    ${i.map((t=>{const i=t,r=i18n.t(t.config.label);return L`
    <td data-title="${r}">${di(i,void 0,e,s,`${a}(${n+1})`)}</td>`}))}${e?null:L`<td><button type="button" class="pzhc pzbutton Simple" 
  aria-label="${i18n.t("Delete item")}" data-ref=${`${a}(${n+1}).pyTemplate`}  
  data-action-click='deleteRow'>${na()}</button></td>`}
    </tr>`))}
`:null},zi=(t,e,s,a,i)=>{if(void 0===t)return null;if(!t.config||!t.config.template)return L`${t.map(((t,n)=>{const r=`${e}-${n}`;if("Region"===t.type)return zi(t.children,`${e}-0`,!0,a,i);if("reference"===t.type&&"view"===t.config.type){let e="";if(t.config.context&&(e=t.config.context),t.config.inheritedProps&&1===t.config.inheritedProps.length&&"label"===t.config.inheritedProps[0].prop){const n=i18n.t(t.config.inheritedProps[0].value),o=a.data.uiResources.resources.views[t.config.name];if(o){const t="SimpleTable"===o.config.template||"ListView"===o.config.template?"field-table":"field-subview";return L`<div class='flex content-item field-item ${t}'><h4>${n}</h4>${zi(o,r,s,a,""===i?e.substring(1):i+e)}</div>`}}return zi(a.data.uiResources.resources.views[t.config.name],r,s,a,i&&""!==i?i+e:e.substring(1))}return di(t,r,s,a,i)}))}`;if("SimpleTable"===t.config.template)return((t,e,s)=>{const a=e||"Editable"!==t.config.renderMode;return L`
  <table class='responsive'>
    <thead>
      <tr>
        ${Ti(t.config.children[0].children,a)}
      </tr>
    </thead>
    <tbody>
      ${Ri(t,a,s)}
  ...
  ${Ei(t,a)}`})(t,s,a);if("ListView"===t.config.template)return((t,e,s)=>(s.sendData("dataviews",{id:t.config.referenceList,content:{paging:{pageNumber:1,pageSize:41}}}),L`
  <table class='responsive'>
    <thead>
      <tr>
        ${Ti(t.config.presets[0].children[0].children,e)}
      </tr>
    </thead>
    <tbody>${Ma()}
    </tbody>
  </table>`))(t,s,a);switch("DataReference"===t.config.template&&(a.isDeclarativeTarget=!0),"TwoColumn"===t.config.template&&1===t.children.length&&(t.config.template="OneColumn"),t.config.template){case"TwoColumn":return L`
        ...
        `;default:return null}},Ni=(t,e,s,a,i,n,r,o,c)=>{const l=L`${ra()}<span class='count-badge'>${i}</span>`;if(void 0===e.caseID&&s.content){const t=s.content.pyID.split(" ")[1];return L`
    <div class="flex layout-content-inline_middle main-header">
  ...
  <caption class='sr-only'>List of assignments</caption>
    ...
    <h3>${i18n.t("Case information")}</h3>`}if(""===t||void 0===e.caseID)return"";const d=e.caseID.split(" ")[1];return L`
  <div class="flex layout-content-inline_middle main-header">
 ...
 <h3>${i18n.t(t)}</h3>`},Mi=(t,e,s,a,i)=>L`
  <div>${zi(t,e,!1,i,"")}</div>
  ${((t,e)=>L`
  <div class="action-button-area">
    ${null!==t?L`<button type="button" class="pzhc pzbutton" @click="${t}">${i18n.t("Cancel")}</button>`:""}
    ${null!==e?L`<button type="button" class="pzhc pzbutton" @click="${e}">${i18n.t("Save")}</button>`:""}
...
`,Pi=(t,e,s,a)=>L`
  ...
  ${(t=>null===t?null:L`
  <div class="action-button-area">
  ${null!==t?L`<button type="button" class="pzhc pzbutton Strong" @click="${t}">${i18n.t("Close")}</button>`:""}
  </div>`)(s)}
`,Bi=(t,e)=>{const{urlparam:s,verifier:a}=(()=>{const t=`${Os.lib.WordArray.random(16)}`;return{urlparam:`&response_type=code&scope=openid&code_challenge=${Os.SHA256(t)}&code_challenge_method=S256&response_mode=query&authentication_service=pega`,verifier:t}})(),i=`${t}/PRRestService/oauth2/v1/authorize?client_id=${e}&redirect_uri=${encodeURIComponent(window.location.origin)}/auth.html&${s}&state=${a}`,n=L`<Button class="pzhc pzbutton" onclick="window.location='${i}'; return false;">${i18n.t("Pega with full page redirect")}</Button>`,r=L`<Button class="pzhc pzbutton" onclick="n=window.open('${i}', 'foo', 'width=600,height=600');n.focus(); return false;">
  ${i18n.t("Pega with popup")}</Button>`;return L`<div class='flex flex-col'><h2>${i18n.t("Log in to the application with one of the following:")}</h2>
  <div class='flex layout-content-inline_middle'>${r}${n}</div></div>`};class Li extends ii{displayContent(){if(""!==this.errorMsg){if(-1===this.errorMsg.indexOf("The provided authorization code is expired"))return ei(this.errorMsg,"true"===this.bShowCancel?this.resetError:null);window.history.replaceState({},"",window.location.pathname.substring(1))}if(window.history.state&&window.history.state.token&&(this.token=window.history.state.token),("oauth2password"===this.authentication||"oauth2clientcredentials"===this.authentication)&&""===this.token)return this.sendData("authenticate",{}),null;if("authorizationcode"===this.authentication&&""===this.token)return window.history.state&&window.history.state.code?(this.sendData("authenticate",{}),null):Bi(this.url,this.clientid);if(this.casetypes||"createNewWork"!==this.action&&"workList"!==this.action?"createNewWork"===this.action&&""===this.caseID&&this.casetypes&&this.casetypes[this.casetype]?this.sendData("newwork",{id:this.casetype}):""===this.name&&("openAssignment"===this.action&&""===this.assignmentID&&(this.assignmentID=this.caseID),""!==this.assignmentID?this.fetchData("assignment",{id:this.assignmentID}):""!==this.caseID&&this.fetchData("view",{id:this.caseID,actionid:"pyReview"})):(this.fetchData("portal"),"createNewWork"===this.action?this.bShowNew=!0:"workList"===this.action&&(this.bShowCancel="true")),this.bShowConfirm){const t=this.data.ID.split(" ")[1];return ti(this.casedata.name,t,this.casepyStatusWork,"true"===this.bShowAttachments?this.displayAttachments:null)}return""!==this.caseID||""!==this.assignmentID||this.bShowNew?L`
        ${Ni(this.name,this.data,this.casedata,this.casepyStatusWork,this.numAttachments,this.displayActions,this.runAction,this.openCase,"true"===this.bShowAttachments?this.displayAttachments:null)}
        <div class="validation" role="alert" aria-live="assertive">${this.validationMsg}</div>
        <form id="case-data">${Ma()}</form>
      `:"workList"===this.action?si(this.title,this.cases,this.displayCasesTypes,this.reloadWorkList,"true"===this.bShowCreate?this.createCase:null,this.openCase):null}renderMainLayout=(t,e)=>Mi(t,e,"true"===this.bShowCancel?this.actionAreaCancel:null,"true"===this.bShowSave?this.actionAreaSave:null,this);renderReviewLayout=(t,e)=>Pi(t,e,"true"===this.bShowCancel?this.actionAreaCancel:null,this);genPageValidationErrors=t=>(t=>t.errorDetails?L`
    <ul>
      ${t.errorDetails.map((t=>"Error_Validation_Fail"===t.message||"Validation failed: Errors Detected."===t.message?null:L`<li>${i18n.t(t.localizedValue)}</li>`))}
    </ul>`:null)(t);showDataList=t=>Ya(t);genActionsList=(t,e)=>((t,e)=>{const s=[],a=Object.entries(e.actions);for(const e of a)e[1].name!==t&&s.push(L`
          <li role="menuitem" tabindex="-1" data-value="${e[1].ID}">${i18n.t(e[1].name)}</li>
        `);return L`
    ${s}
  `})(t,e);displayCasesTypes=()=>(t=>{const e=[],s=Object.entries(t);for(const t of s)e.push(L`
        <li role="menuitem" tabindex="-1" data-value="${t[0]}">${i18n.t(t[1].name)}</li>
      `);return L`
    ${e}
  `})(this.casetypes);genLoadingIndicator=()=>Ma();clickHandler=t=>{let e=t.target;"path"===e.tagName&&(e=e.parentNode),"svg"===e.tagName&&(e=e.parentNode);const s=e.getAttribute("data-action-click");e.classList.contains("combobox")&&!e.classList.contains("loaded")&&this.getData(e.getAttribute("data-pageid"),e),Zs(e,"click")?(this.refreshAssignment(e,Ys(e,"click")),t.preventDefault()):"BUTTON"===e.tagName&&(t.preventDefault(),null!==e.getAttribute("data-submit")&&"save"!==e.getAttribute("data-submit")?this.submitForm(t,e.getAttribute("data-submit")):("addRow"===s||"deleteRow"===s)&&this.refreshAssignment(e))};changeHandler=t=>{let e=t.target;if(t.path&&t.path.length>0?e=t.path[0]:t.originalTarget&&(e=t.originalTarget),e.setCustomValidity(""),e.classList.remove("error-field"),Zs(e,"change")||this.isDeclarativeTarget)this.refreshAssignment(e,Ys(e,"change"));else if(this.refreshOnChange){const t=this.getRenderRoot().querySelector("#case-data");ta(t,this.content,this.pageInstructions,this.data.data.caseInfo.content),P(Mi(this.data.uiResources.resources.views[this.casedata.content.pyViewName],"Obj","true"===this.bShowCancel?this.actionAreaCancel:null,"true"===this.bShowSave?this.actionAreaSave:null,this),t)}};keyupHandler=t=>{const e=t.target;"TEXTAREA"===e.tagName&&(e.style.cssText="height:auto; padding:0;",e.style.cssText=`height:${e.scrollHeight}px`)};focusHandler=t=>{const e=t.target;e.classList.contains("combobox")&&!e.classList.contains("loaded")?this.getData(e.getAttribute("data-pageid"),e):"INPUT"===e.tagName&&e.classList.contains("location")&&!e.classList.contains("pac-target-input")&&window.google&&window.google.maps&&window.google.maps.places&&new window.google.maps.places.Autocomplete(e)};async firstUpdated(){const t=this.getRenderRoot();t&&(t.addEventListener("click",this.clickHandler),t.addEventListener("focusin",this.focusHandler),t.addEventListener("change",this.changeHandler),t.addEventListener("keyup",this.keyupHandler))}}customElements.define("pega-mashup-light-v2",class extends Li{createRenderRoot(){return this}getRenderRoot(){return this}render(){return L`
      ${this.displayContent()}
    `}})}();
