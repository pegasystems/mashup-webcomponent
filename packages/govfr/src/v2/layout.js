      ...
      case 'TwoColumn':
        ...
        <div class="fr-container">
          <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--bottom">
            <div class="fr-col-6">${Layout(data.children[0].children, `${path}-0`, isReadOnly, webcomp, context)}</div>
            <div class="fr-col-6">${Layout(data.children[1].children, `${path}-0`, isReadOnly, webcomp, context)}</div>
          </div>
        </div>
        `;
      case 'DefaultForm':
